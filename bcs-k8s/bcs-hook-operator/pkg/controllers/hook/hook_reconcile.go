...
import (
	...
	hooksutil "github.com/Tencent/bk-bcs/bcs-k8s/bcs-hook-operator/pkg/util/hook"
...
func (hc *HookController) runMeasurements(run *v1alpha1.HookRun, tasks []metricTask) {
