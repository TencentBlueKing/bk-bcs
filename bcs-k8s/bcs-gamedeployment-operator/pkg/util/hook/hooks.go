...
import (
	...
	tkexclientset "github.com/Tencent/bk-bcs/bcs-k8s/bcs-gamedeployment-operator/pkg/client/clientset/versioned/typed/tkex/v1alpha1"
...
func StepLabels(index int32, revision string) map[string]string {
	...
	return map[string]string{
		v1alpha1.DefaultGameDeploymentUniqueLabelKey: revision,
		v1alpha1.GameDeploymentTypeLabel:             v1alpha1.GameDeploymentTypeStepLabel,
		v1alpha1.GameDeploymentCanaryStepIndexLabel:  indexStr,
	}
}
