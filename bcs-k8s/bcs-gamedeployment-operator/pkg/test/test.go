...
func NewGameDeployment(replicas int) *v1alpha1.GameDeployment {
	name := "foo"
	...
	return &v1alpha1.GameDeployment{
		...
		Spec: v1alpha1.GameDeploymentSpec{
			...
			Template:       template,
			UpdateStrategy: v1alpha1.GameDeploymentUpdateStrategy{Type: v1alpha1.RecreateGameDeploymentUpdateStrategyType},
