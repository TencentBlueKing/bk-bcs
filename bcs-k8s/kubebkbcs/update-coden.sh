...
./vendor/k8s.io/code-generator/generate-groups.sh \
    ...
    github.com/Tencent/bk-bcs/bcs-k8s/kubebkbcs/generated \
    github.com/Tencent/bk-bcs/bcs-k8s/kubebkbcs/apis \
    "${group_version_pair}" \
...
if [ $GOPATH ]; then
    echo "mv from gopath"
    if [[ ${GOPATH}/src/github.com/Tencent/bk-bcs/bcs-k8s/kubebkbcs/generated == $(pwd)/generated ]]; then
        echo "done"
    else
        echo "mv from ${GOPATH}/src/github.com/Tencent/bk-bcs/bcs-k8s/kubebkbcs/generated"
        mv ${GOPATH}/src/github.com/Tencent/bk-bcs/bcs-k8s/kubebkbcs/generated generated
    fi
else
  echo "cp from current dir"
  cp -r github.com/Tencent/bk-bcs/bcs-k8s/kubebkbcs/generated generated
  rm -rf ./github.com
fi 
