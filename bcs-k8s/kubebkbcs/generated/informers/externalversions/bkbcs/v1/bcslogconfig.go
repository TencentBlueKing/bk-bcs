	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BkbcsV1().BcsLogConfigs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BkbcsV1().BcsLogConfigs(namespace).Watch(context.TODO(), options)
			},
		},
		&bkbcsv1.BcsLogConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bcsLogConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bkbcsv1.BcsLogConfig{}, f.defaultInformer)
}
