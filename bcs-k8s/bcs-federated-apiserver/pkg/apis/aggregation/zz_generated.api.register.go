...
var (
	AggregationPodAggregationStorage = builders.NewApiResource( // Resource status endpoint
		InternalPodAggregation,
		func() runtime.Object { return &PodAggregation{} },     // Register versioned resource
		func() runtime.Object { return &PodAggregationList{} }, // Register versioned resource list
		&PodAggregationStrategy{builders.StorageStrategySingleton},
	)
	...
	InternalPodAggregationStatus = builders.NewInternalResourceStatus(
		"podaggregations",
		"PodAggregationStatus",
		func() runtime.Object { return &PodAggregation{} },
		func() runtime.Object { return &PodAggregationList{} },
	)
...
type PodAggregationRegistry interface {
	ListPodAggregations(ctx context.Context, options *internalversion.ListOptions) (*PodAggregationList, error)
...
func (s *storagePodAggregation) ListPodAggregations(ctx context.Context, options *internalversion.ListOptions) (*PodAggregationList, error) {
...
func (s *storagePodAggregation) GetPodAggregation(ctx context.Context, id string, options *metav1.GetOptions) (*PodAggregation, error) {
	st := s.GetStandardStorage()
...
func (s *storagePodAggregation) CreatePodAggregation(ctx context.Context, object *PodAggregation) (*PodAggregation, error) {
	st := s.GetStandardStorage()
...
func (s *storagePodAggregation) UpdatePodAggregation(ctx context.Context, object *PodAggregation) (*PodAggregation, error) {
	st := s.GetStandardStorage()
