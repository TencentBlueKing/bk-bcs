...
replace github.com/Tencent/bk-bcs/bcs-k8s/kubernetes => ../kubernetes

replace github.com/Tencent/bk-bcs/bcs-k8s/kubernetes/generated/clientset/versioned => ../kubernetes/generated/clientset/versioned
