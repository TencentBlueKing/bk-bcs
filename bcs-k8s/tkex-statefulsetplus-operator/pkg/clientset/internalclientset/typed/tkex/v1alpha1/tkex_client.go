...
import (
	...
	"bk-bcs/bcs-k8s/tkex-statefulsetplus-operator/pkg/clientset/internalclientset/scheme"
...
func (c *TkexV1alpha1Client) StatefulSetPluses(namespace string) StatefulSetPlusInterface {
	return newStatefulSetPluses(c, namespace)
}
