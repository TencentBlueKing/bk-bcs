...
var servicednsrecordsResource = schema.GroupVersionResource{Group: "multiclusterdns.kubefed.io", Version: "v1alpha1", Resource: "servicednsrecords"}

var servicednsrecordsKind = schema.GroupVersionKind{Group: "multiclusterdns.kubefed.io", Version: "v1alpha1", Kind: "ServiceDNSRecord"}
...
func (c *FakeServiceDNSRecords) List(opts v1.ListOptions) (result *v1alpha1.ServiceDNSRecordList, err error) {
	...
	list := &v1alpha1.ServiceDNSRecordList{}
