...
# shellcheck disable=SC2086
cp ${GOPATH}/src/github.com/bk-bcs/bcs-k8s/bcs-cluster-autoscaler/_override/github.com/Azure/azure-sdk-for-go/services/containerservice/mgmt/2018-03-31/containerservice/* "${GOPATH}/src/github.com/Azure/azure-sdk-for-go/services/containerservice/mgmt/2018-03-31/containerservice/"
...
# shellcheck disable=SC2086
cp -r ${GOPATH}/src/github.com/bk-bcs/bcs-k8s/bcs-cluster-autoscaler/_override/github.com/Azure/go-autorest/* "${GOPATH}/src/github.com/Azure/go-autorest/"
