<!-- BKUI-KNOWLEDGE-MANAGED:2e279de905d0 -->
---
...
| 资源 | URI | 说明 |
|-----|-----|------|
| 输入校验详解 | `./references/input-validation.md` | 7 类高危操作场景 |
| 鉴权检查详解 | `./references/auth-check.md` | 8 类鉴权缺失场景 |
| 数据加密详解 | `./references/data-encryption.md` | 8 类加密缺失场景 |


---
## 📦 可用资源

- `./references/auth-check.md`
- `./references/data-encryption.md`
