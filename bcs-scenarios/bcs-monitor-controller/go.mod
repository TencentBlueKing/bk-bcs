module github.com/Tencent/bk-bcs/bcs-runtime/bcs-k8s/bcs-component/bcs-monitor-controller
...
require (
	github.com/Tencent/bk-bcs/bcs-common v0.0.0-20231114032042-90745b766c4b
