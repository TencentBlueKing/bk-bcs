...
type RegisterBkWhitelistRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RegisterBkWhitelistRequest) Reset() {
	*x = RegisterBkWhitelistRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[27]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RegisterBkWhitelistRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterBkWhitelistRequest) ProtoMessage() {}

func (x *RegisterBkWhitelistRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterBkWhitelistRequest.ProtoReflect.Descriptor instead.
func (*RegisterBkWhitelistRequest) Descriptor() ([]byte, []int) {
	return file_proto_bcs_terraform_bkprovider_proto_rawDescGZIP(), []int{27}
}

func (x *RegisterBkWhitelistRequest) GetIpList() []string {
	if x != nil {
		return x.IpList
	}
	return nil
...
func (x *RegisterBkWhitelistRequest) GetBizName() string {
	if x != nil {
		return x.BizName
	}
	return ""
...
type RegisterBkWhitelistResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RegisterBkWhitelistResponse) Reset() {
	*x = RegisterBkWhitelistResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RegisterBkWhitelistResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterBkWhitelistResponse) ProtoMessage() {}

func (x *RegisterBkWhitelistResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterBkWhitelistResponse.ProtoReflect.Descriptor instead.
func (*RegisterBkWhitelistResponse) Descriptor() ([]byte, []int) {
	return file_proto_bcs_terraform_bkprovider_proto_rawDescGZIP(), []int{28}
}

func (x *RegisterBkWhitelistResponse) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *RegisterBkWhitelistResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type GetBkOuterIPRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetBkOuterIPRequest) Reset() {
	*x = GetBkOuterIPRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[29]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetBkOuterIPRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBkOuterIPRequest) ProtoMessage() {}

func (x *GetBkOuterIPRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBkOuterIPRequest.ProtoReflect.Descriptor instead.
func (*GetBkOuterIPRequest) Descriptor() ([]byte, []int) {
	return file_proto_bcs_terraform_bkprovider_proto_rawDescGZIP(), []int{29}
}

type GetBkOuterIPResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetBkOuterIPResponse) Reset() {
	*x = GetBkOuterIPResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[30]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetBkOuterIPResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBkOuterIPResponse) ProtoMessage() {}

func (x *GetBkOuterIPResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBkOuterIPResponse.ProtoReflect.Descriptor instead.
func (*GetBkOuterIPResponse) Descriptor() ([]byte, []int) {
	return file_proto_bcs_terraform_bkprovider_proto_rawDescGZIP(), []int{30}
}

func (x *GetBkOuterIPResponse) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *GetBkOuterIPResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *GetBkOuterIPResponse) GetData() []string {
	if x != nil {
		return x.Data
	}
	return nil
...
type ListBkWhiteListRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ListBkWhiteListRequest) Reset() {
	*x = ListBkWhiteListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[31]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ListBkWhiteListRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListBkWhiteListRequest) ProtoMessage() {}

func (x *ListBkWhiteListRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListBkWhiteListRequest.ProtoReflect.Descriptor instead.
func (*ListBkWhiteListRequest) Descriptor() ([]byte, []int) {
	return file_proto_bcs_terraform_bkprovider_proto_rawDescGZIP(), []int{31}
}

type ListBkWhiteListResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListBkWhiteListResponse) Reset() {
	*x = ListBkWhiteListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[32]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ListBkWhiteListResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListBkWhiteListResponse) ProtoMessage() {}

func (x *ListBkWhiteListResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_bcs_terraform_bkprovider_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListBkWhiteListResponse.ProtoReflect.Descriptor instead.
func (*ListBkWhiteListResponse) Descriptor() ([]byte, []int) {
	return file_proto_bcs_terraform_bkprovider_proto_rawDescGZIP(), []int{32}
}

func (x *ListBkWhiteListResponse) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ListBkWhiteListResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *ListBkWhiteListResponse) GetData() []string {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_proto_bcs_terraform_bkprovider_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x42, 0x16, 0x92, 0x41, 0x13, 0x2a, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x32, 0x0b, 0xe7, 0x99, 0xbd, 0xe5, 0x90, 0x8d, 0xe5, 0x8d, 0x95, 0x49, 0x50, 0x52, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x3a, 0x2f, 0x92, 0x41, 0x2c, 0x0a, 0x2a, 0x2a, 0x17, 0x4c, 0x69, 0x73,
	0x74, 0x42, 0x6b, 0x57, 0x68, 0x69, 0x74, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0x0f, 0xe8, 0x93, 0x9d, 0xe9, 0xb2, 0xb8, 0xe7, 0x99, 0xbd, 0xe5,
	0x90, 0x8d, 0xe5, 0x8d, 0x95, 0x32, 0xba, 0x11, 0x0a, 0x16, 0x42, 0x63, 0x73, 0x54, 0x65, 0x72,
	...
	,
	...
	0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x6a, 0x73, 0x6f, 0x6e, 0x5a, 0x1e,
	0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x62, 0x63, 0x73, 0x74, 0x65, 0x72, 0x72, 0x61,
	0x66, 0x6f, 0x72, 0x6d, 0x62, 0x6b, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x62, 0x06,
...
var file_proto_bcs_terraform_bkprovider_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_proto_bcs_terraform_bkprovider_proto_goTypes = []interface{}{
	...
	(*RegisterBkWhitelistRequest)(nil),  // 27: bcsterraformbkprovider.RegisterBkWhitelistRequest
	(*RegisterBkWhitelistResponse)(nil), // 28: bcsterraformbkprovider.RegisterBkWhitelistResponse
	(*GetBkOuterIPRequest)(nil),         // 29: bcsterraformbkprovider.GetBkOuterIPRequest
	(*GetBkOuterIPResponse)(nil),        // 30: bcsterraformbkprovider.GetBkOuterIPResponse
	(*ListBkWhiteListRequest)(nil),      // 31: bcsterraformbkprovider.ListBkWhiteListRequest
	(*ListBkWhiteListResponse)(nil),     // 32: bcsterraformbkprovider.ListBkWhiteListResponse
}
var file_proto_bcs_terraform_bkprovider_proto_depIdxs = []int32{
	...
	27, // 20: bcsterraformbkprovider.BcsTerraformBkProvider.RegisterBkWhitelist:input_type -> bcsterraformbkprovider.RegisterBkWhitelistRequest
	31, // 21: bcsterraformbkprovider.BcsTerraformBkProvider.ListBkWhitelist:input_type -> bcsterraformbkprovider.ListBkWhiteListRequest
	29, // 22: bcsterraformbkprovider.BcsTerraformBkProvider.GetBkOuterIP:input_type -> bcsterraformbkprovider.GetBkOuterIPRequest
	10, // 23: bcsterraformbkprovider.BcsTerraformBkProvider.InstallJob:output_type -> bcsterraformbkprovider.InstallJobResponse
	5,  // 24: bcsterraformbkprovider.BcsTerraformBkProvider.ListHost:output_type -> bcsterraformbkprovider.ListHostResponse
	8,  // 25: bcsterraformbkprovider.BcsTerraformBkProvider.ListProxyHost:output_type -> bcsterraformbkprovider.ListProxyHostResponse
	14, // 26: bcsterraformbkprovider.BcsTerraformBkProvider.CreateCloud:output_type -> bcsterraformbkprovider.CloudCreateResponse
	20, // 27: bcsterraformbkprovider.BcsTerraformBkProvider.UpdateCloud:output_type -> bcsterraformbkprovider.CloudUpdateResponse
	18, // 28: bcsterraformbkprovider.BcsTerraformBkProvider.ListCloud:output_type -> bcsterraformbkprovider.CloudListResponse
	16, // 29: bcsterraformbkprovider.BcsTerraformBkProvider.DeleteCloud:output_type -> bcsterraformbkprovider.CloudDeleteResponse
	22, // 30: bcsterraformbkprovider.BcsTerraformBkProvider.GetJobDetail:output_type -> bcsterraformbkprovider.GetJobDetailResponse
	28, // 31: bcsterraformbkprovider.BcsTerraformBkProvider.RegisterBkWhitelist:output_type -> bcsterraformbkprovider.RegisterBkWhitelistResponse
	32, // 32: bcsterraformbkprovider.BcsTerraformBkProvider.ListBkWhitelist:output_type -> bcsterraformbkprovider.ListBkWhiteListResponse
	30, // 33: bcsterraformbkprovider.BcsTerraformBkProvider.GetBkOuterIP:output_type -> bcsterraformbkprovider.GetBkOuterIPResponse
...
func file_proto_bcs_terraform_bkprovider_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_bcs_terraform_bkprovider_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterBkWhitelistRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_bcs_terraform_bkprovider_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterBkWhitelistResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_bcs_terraform_bkprovider_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetBkOuterIPRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_bcs_terraform_bkprovider_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetBkOuterIPResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_bcs_terraform_bkprovider_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListBkWhiteListRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_bcs_terraform_bkprovider_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListBkWhiteListResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
