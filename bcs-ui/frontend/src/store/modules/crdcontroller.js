...
export default {
    ...
    actions: {
        ...
        async createLogCollect (ctx, params) {
            const result = await createLogCollect(params).then(() => true).catch(() => false)
            return result
        },
        ...
        async updateLogCollect (ctx, params) {
            const result = await updateLogCollect(params).then(() => true).catch(() => false)
            return result
        },
        async deleteLogCollect (ctx, params) {
            const result = await deleteLogCollect(params).then(() => true).catch(() => false)
            return result
        },
