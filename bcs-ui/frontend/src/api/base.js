...
export const dashbordListWithoutNamespace = request('get', `${crPrefix}/projects/$projectId/clusters/$clusterId/$type/$category`) // PersistentVolume, StorageClass资源暂不支持命名空间
export const retrieveDetail = request('get', `${crPrefix}/projects/$projectId/clusters/$clusterId/namespaces/$namespaceId/$type/$category/$name`)
export const retrieveContainerDetail = request('get', `${crPrefix}/projects/$projectId/clusters/$clusterId/namespaces/$namespaceId/workloads/$category/$name/containers/$containerName`)
export const listWorkloadPods = request('get', `${crPrefix}/projects/$projectId/clusters/$clusterId/namespaces/$namespaceId/workloads/pods`)
export const listStoragePods = request('get', `${crPrefix}/projects/$projectId/clusters/$clusterId/namespaces/$namespaceId/workloads/pods/$podId/$type`)
export const listContainers = request('get', `${crPrefix}/projects/$projectId/clusters/$clusterId/namespaces/$namespaceId/workloads/pods/$podId/containers`)
export const fetchContainerEnvInfo = request('get', `${crPrefix}/projects/$projectId/clusters/$clusterId/namespaces/$namespaceId/workloads/pods/$podId/containers/$containerName/env_info`)
export const resourceCreate = request('post', `${crPrefix}/projects/$projectId/clusters/$clusterId/$type/$category`)
export const resourceUpdate = request('put', `${crPrefix}/projects/$projectId/clusters/$clusterId/namespaces/$namespaceId/$type/$category/$name`)
export const resourceDelete = request('delete', `${crPrefix}/projects/$projectId/clusters/$clusterId/namespaces/$namespaceId/$type/$category/$name`)
export const exampleManifests = request('get', `${crPrefix}/projects/$projectId/clusters/$clusterId/examples/manifests`)
export const crdList = request('get', `${crPrefix}/projects/$projectId/clusters/$clusterId/crds`)// 获取CRD列表
export const customResourceList = request('get', `${crPrefix}/projects/$projectId/clusters/$clusterId/crds/$crd/$category`) // 自定义资源
export const retrieveCustomResourceDetail = request('get', `${crPrefix}/projects/$projectId/clusters/$clusterId/crds/$crd/$category/$name`) // 自定义资源详情
export const customResourceCreate = request('post', `${crPrefix}/projects/$projectId/clusters/$clusterId/crds/$crd/$category`) // 自定义资源创建
export const customResourceUpdate = request('put', `${crPrefix}/projects/$projectId/clusters/$clusterId/crds/$crd/$category/$name`) // 自定义资源更新
export const customResourceDelete = request('delete', `${crPrefix}/projects/$projectId/clusters/$clusterId/crds/$crd/$category/$name`) // 自定义资源删除
export const reschedulePod = request('put', `${crPrefix}/projects/$projectId/clusters/$clusterId/namespaces/$namespaceId/workloads/pods/$podId/reschedule`) // pod重新调度
export const renderManifestPreview = request('post', `${crPrefix}/projects/$projectId/clusters/$clusterId/render_manifest_preview`)
