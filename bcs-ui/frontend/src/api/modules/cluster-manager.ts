...
export const kubeConfig = request('put', '/projects/$projectId/cloud/kubeConfig');
...
export const clusterConnect = request('get', '/projects/$projectId/clouds/$cloudId/clusters/$clusterID/connect');
...
export const cloudConnect = request('get', '/projects/$projectId/clouds/$cloudId/clusters/$clusterID/connect');
...
export const setNodeAnnotations = request('put', '/node/annotations');
