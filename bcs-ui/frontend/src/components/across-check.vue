...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const allChecked = computed(() => [CheckType.HalfAcrossChecked, CheckType.AcrossChecked]
      .includes(localValue.value));
    const indeterminate = computed(() => [CheckType.HalfChecked, CheckType.HalfAcrossChecked]
      .includes(localValue.value));
