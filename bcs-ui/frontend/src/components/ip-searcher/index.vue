...
<template>
  <div class="biz-ip-searcher-wrapper">
    <div
      :class="['biz-searcher', { 'active': isEdit }, { 'disable': disable }]"
      ref="scrollNode" @click="foucusSearcher">
      ...
      <bk-popover :content="$t('清空')" placement="top">
        ...
        <template v-else>
          <a
            ...
            class="btn clear-btn" @click.stop.prevent="clearSearchParams" v-show="searchParams.length">
            <i class="bcs-icon bcs-icon-close"></i>
          </a>
        </template>
      </bk-popover>
