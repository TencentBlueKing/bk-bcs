                        ...
                        <div class="bk-form m20">
                          <div class="bk-form-item">
                            ...
                            <div class="bk-form-content" style="margin-left: 120px">
                              <div class="bk-dropdown-box" style="width: 250px;">
                                <bcs-select
                                  v-model="curContainer.webCache.livenessProbeType"
                                  :clearable="false"
                                  :placeholder="$t('请选择')"
                                  @change="handleLivenessTypeChange">
                                  <bk-option
                                    v-for="option in healthCheckTypes"
                                    :key="option.id"
                                    :id="option.id"
                                    :name="option.name">
                                  </bk-option>
                        ...
                        <div class="bk-form m20">
                          <div class="bk-form-item">
                            ...
                            <div class="bk-form-content" style="margin-left: 120px">
                              <div class="bk-dropdown-box" style="width: 250px;">
                                <bcs-select
                                  v-model="curContainer.webCache.readinessProbeType"
                                  :clearable="false"
                                  :placeholder="$t('请选择')"
  ...
  computed: {
    ...
    portList() {
      ...
      if (ports && ports.length) {
        const results = ports.filter(port => port.name && port.containerPort);
        return results;
      }
      return [];
    },
