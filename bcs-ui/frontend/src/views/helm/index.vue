      ...
      <template v-if="!showLoading">
        ...
        <svg style="display: none;">
          ...
          <symbol id="biz-set-icon" viewBox="0 0 60 60">
            <path
              class="st0" d="M54.8,16.5L34,4.5C33.4,4.2,32.7,4,32,4s-1.4,0.2-2,0.5l-20.8,12c-1.2,0.7-2,2-2,3.5v24c0,1.4,0.8,2.7,2,3.5
...
export default {
  ...
  methods: {
    ...
    sortResource(resources) {
      ...
      sortKey.other.sort((a, b) => a.kind.toLowerCase() < b.kind.toLowerCase());
