          ...
          <div id="systemDesc">
            <i18n path="tke.image.desc.public" tag="div">
              <span
                ...
                @click="openLink('https://cloud.tencent.com/document/product/213/4941')">
                {{ $t('tke.image.link.imageType') }}
              </span>
            </i18n>
            <i18n path="tke.image.desc.market" tag="div">
              <span
                class="text-[12px] text-[#699DF4] cursor-pointer"
                @click="openLink('https://cloud.tencent.com/document/product/457/61448#.E6.93.8D.E4.BD.9C.E6.AD.A5.E9.AA.A4')">
                {{ $t('tke.image.link.qGPU') }}
              </span>
            </i18n>
            <i18n path="tke.image.desc.private" tag="div">
              <span
                class="text-[12px] text-[#699DF4] cursor-pointer"
                @click="openLink('https://cloud.tencent.com/document/product/457/39563')">
                {{ $t('tke.image.link.privateImage') }}
              </span>
            </i18n>
          </div>
        </bk-form-item>
...
import { ICloudProject, INodeManCloud } from './types';
...
import ImageList from '@/views/cluster-manage/add/form/image-list.vue';
