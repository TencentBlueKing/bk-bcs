  ...
  <div class="flex items-start justify-center py-[24px] overflow-auto">
    <div class="shadow bg-[#fff] px-[24px] py-[16px] pb-[32px] min-w-[800px]">
      ...
      <bk-form class="max-w-[640px]" :model="formData" :rules="formRules" ref="formRef">
        <bk-form-item
          :label="$t('importAmazonCloud.label.clusterName')"
        ...
        <bk-form-item
          :label="$t('importAmazonCloud.label.token')"
        ...
        <bk-form-item
          :label="$t('importAmazonCloud.label.region')"
          property="region"
          error-display-type="normal"
          required>
          <bcs-select
        ...
        <bk-form-item
          :label="$t('importAmazonCloud.label.clusterID')"
          property="cloudID"
          error-display-type="normal"
          required>
        ...
        <bk-form-item :label="$t('importAmazonCloud.label.desc')" property="description" error-display-type="normal">
        ...
        <bk-form-item>
          ...
          <bk-button
            ...
            @click="handleImport">
            {{ $t('importAmazonCloud.button.import') }}
          </bk-button>
...
const handleGetAccountsList = async () => {
  ...
  const { data } = await cloudAccounts(cloudId);
...
const levelMap = {
  zones: $i18n.t('importAmazonCloud.clusterRegion.zones'),
  regions: $i18n.t('importAmazonCloud.clusterRegion.regions'),
  other: $i18n.t('importAmazonCloud.clusterRegion.other'),
};
