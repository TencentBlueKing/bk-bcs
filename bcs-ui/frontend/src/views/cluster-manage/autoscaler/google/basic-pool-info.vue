    ...
    <bk-form-item
      ...
      <bk-radio-group v-model="nodePoolInfo.autoScaling.multiZoneSubnetPolicy">
        <span class="inline-block">
          <bk-radio disabled value="PRIORITY">{{$t('cluster.ca.nodePool.create.multiZoneSubnetPolicy.priority')}}</bk-radio>
          <bk-radio disabled value="EQUALITY">{{$t('cluster.ca.nodePool.create.multiZoneSubnetPolicy.equality')}}</bk-radio>
        </span>
      </bk-radio-group>
    </bk-form-item>
    <bk-form-item
      ...
      <bk-radio-group v-model="nodePoolInfo.autoScaling.retryPolicy">
        <span class="inline-block">
          <bk-radio disabled value="IMMEDIATE_RETRY">{{$t('cluster.ca.nodePool.create.retryPolicy.immediate_retry')}}</bk-radio>
          <bk-radio disabled value="INCREMENTAL_INTERVALS">{{$t('cluster.ca.nodePool.create.retryPolicy.incremental_intervals')}}</bk-radio>
          <bk-radio disabled value="NO_RETRY">{{$t('cluster.ca.nodePool.create.retryPolicy.no_retry')}}</bk-radio>
        </span>
      </bk-radio-group>
    </bk-form-item>
    <bk-form-item
      ...
      <bk-radio-group v-model="nodePoolInfo.autoScaling.scalingMode">
        <span class="inline-block">
          <bk-radio disabled value="CLASSIC_SCALING">{{$t('cluster.ca.nodePool.create.scalingMode.classic_scaling')}}</bk-radio>
          <bk-radio disabled value="WAKE_UP_STOPPED_SCALING">{{$t('cluster.ca.nodePool.create.scalingMode.wake_up_stopped_scaling')}}</bk-radio>
        </span>
      </bk-radio-group>
    </bk-form-item>
    <!-- <bk-form-item
