...
export default defineComponent({
  ...
  setup(props) {
    ...
    const diskTypeMap = {
      ...
      Standard_LRS: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.Standard_LRS'),
      StandardSSD_LRS: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.StandardSSD_LRS'),
      StandardSSD_ZRS: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.StandardSSD_ZRS'),
      Premium_LRS: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.Premium_LRS'),
      PremiumV2_LRS: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.PremiumV2_LRS'),
      Premium_ZRS: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.Premium_ZRS'),
    };
