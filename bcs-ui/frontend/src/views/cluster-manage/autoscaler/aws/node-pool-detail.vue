...
export default defineComponent({
  ...
  setup(props) {
    ...
    const scalingModeMap = {
      Delete: $i18n.t('cluster.ca.nodePool.create.scalingMode.classic_scaling'),
    ...
    const diskTypeMap = {
      gp2: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.gp2'),
      gp3: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.gp3'),
      io1: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.io1'),
      io2: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.io2'),
      st1: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.st1'),
      sc1: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.sc1'),
    };
    ...
    const systemDisk = computed(() => {
      if (!diskTypeMap[nodePoolData.value.launchTemplate?.systemDisk?.diskType]) return `${nodePoolData.value.launchTemplate?.systemDisk?.diskSize}G`;
