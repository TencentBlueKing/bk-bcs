...
export default defineComponent({
  ...
  setup(props) {
    ...
    const diskTypeMap = {
      SATA: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.SATA'),
      SAS: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.SAS'),
      GPSSD: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.GPSSD'),
      SSD: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.SSD'),
      ESSD: $i18n.t('cluster.ca.nodePool.create.instanceTypeConfig.diskType.ESSD'),
    };
    const chargeTypeMap = {
