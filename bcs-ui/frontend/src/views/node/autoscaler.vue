                            ...
                            <bcs-popover placement="bottom"
                                ...
                                <div slot="content">
                                    <ul>
                                        ...
                                        <li :class="['dropdown-item', { disabled: !row.unSchedulable }]"
                                            v-bk-tooltips="{
                                                content: $t('请先停止调度'),
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        setup (props, ctx) {
            ...
            const handleChangeScalerDown = async (value) => {
                return new Promise(async (resolve, reject) => {
                    configLoading.value = true
            ...
            // 获取节点池列表
            const renderHeader = (h: CreateElement, data) => {
                return h('span', {
            ...
            // 至少保证一个节点池处于开启状态
            const disabledAutoscaler = computed(() => {
                return autoscalerData.value.enableAutoscale
