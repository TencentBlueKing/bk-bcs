    ...
    <BcsContent>
        ...
        <bk-form :label-width="240" class="config-content" v-bkloading="{ isLoading: configLoading }">
            ...
            <LayoutGroup :title="$t('基本配置')" class="mb10">
                ...
                <bk-form-item :label="$t('允许unready节点')"
                    desc-type="icon"
            ...
            <LayoutGroup :title="$t('自动扩容配置')" class="mb10">
                <bk-form-item :label="$t('扩容算法')" :model="autoscalerData"
                    desc-type="icon"
                    desc-icon="bk-icon icon-info-circle"
                ...
                <bk-form-item :label="$t('等待节点提供最长时间')"
                    desc-type="icon"
                    desc-icon="bk-icon icon-info-circle"
            ...
            <LayoutGroup collapsible :expanded="autoscalerData.isScaleDownEnable">
                ...
                <bk-form-item :label="$t('等待 Pod 退出最长时间')"
                    desc-type="icon"
                    desc-icon="bk-icon icon-info-circle"
                ...
                <bk-form-item :label="$t('扩容后判断缩容时间间隔')"
                    desc-type="icon"
                    desc-icon="bk-icon icon-info-circle"
                ...
                <bk-form-item :label="$t('连续两次缩容时间间隔')"
                    desc-type="icon"
                    desc-icon="bk-icon icon-info-circle"
