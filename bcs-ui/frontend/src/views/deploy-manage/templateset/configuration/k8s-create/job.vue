  ...
  methods: {
    ...
    removeApplication(application, index) {
      ...
      this.$bkInfo({
        ...
        content: this.$createElement('p', { style: { 'text-align': 'left' } }, `${this.$t('deploy.templateset.deleteJob')}：${application.config.metadata.name || this.$t('deploy.templateset.unnamed')}`),
        confirmFn() {
