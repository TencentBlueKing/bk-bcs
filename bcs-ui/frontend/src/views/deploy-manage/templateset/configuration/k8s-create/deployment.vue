      ...
      <div class="biz-tab-box" v-show="!isDataLoading">
        ...
        <div class="biz-tab-content" v-bkloading="{ isLoading: isTabChanging }">
          <bk-alert type="info" class="mb20">
            <div slot="title">
              {{$t('deploy.templateset.deploymentDescription')}}，
              <a class="bk-text-button" :href="PROJECT_CONFIG.k8sDeployment" target="_blank">{{$t('plugin.tools.docs')}}</a>
            </div>
          </bk-alert>
          <template v-if="!deployments.length">
            <div class="biz-guide-box mt0">
              <bk-button icon="plus" type="primary" @click.stop.prevent="addLocalApplication">
                <span style="margin-left: 0;">{{$t('deploy.templateset.addDeployment')}}</span>
              </bk-button>
            </div>
          </template>
            ...
            <div class="biz-configuration-topbar">
              <div class="biz-list-operation">
                ...
                <bcs-popover
                  ...
                  :content="$t('deploy.templateset.addDeployment')"
                  placement="top">
                ...
                <div class="bk-form-item">
                  <div class="bk-form-content" style="margin-left: 140px;">
                    ...
                    <button :class="['bk-text-button f12 mb10 pl0', { 'rotate': isPodPanelShow }]" @click.stop.prevent="togglePod">
                      {{$t('deploy.templateset.podTemplateSettings')}}
                      <i class="bcs-icon bcs-icon-angle-double-down ml5"></i>
                    </button>
                  </div>
                      ...
                      <div class="bk-form m20">
                        ...
                        <div class="bk-form-item" v-show="curApplication.config.spec.strategy.type === 'RollingUpdate'">
                          ...
                          <div class="bk-form-content" style="margin-left: 155px;">
                            ...
                            <p class="biz-tip mt5">{{$t('deploy.templateset.maxUnavailablePods')}}</p>
                          </div>
                        </div>
                        ...
                        <div class="bk-form-item" v-show="curApplication.config.spec.strategy.type === 'RollingUpdate'">
                          ...
                          <div class="bk-form-content" style="margin-left: 155px;">
                            ...
                            <p class="biz-tip mt5">{{$t('deploy.templateset.maxAdditionalPods')}}</p>
                          </div>
                        </div>
                                                    ...
                                                    <div class="bk-form-item">
                                                        <div class="bk-form-content" style="margin-left: 0;">
                                                            <bk-checkbox style="margin-left: 15px;"
                                                                ...
                                                                {{$t('deploy.templateset.enableMetricDataCollection')}}
                                                            </bk-checkbox>
                                                            <router-link class="bk-text-button ml10" style="vertical-align: middle;" :to="{ name: 'metricManage', params: { projectCode, projectId } }">{{$t('deploy.templateset.manageMetric')}}</router-link>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="bk-form-item" style="margin-top: 15px;" v-if="curApplication.config.webCache.isMetric">
                                                            <div class="bk-form-content" style="margin-left: 15px;">
                                                                <div class="bk-dropdown-box" style="width: 310px; display: block;">
                                                                    <bk-selector
                                                                        :placeholder="$t('deploy.templateset.metricListMultiSelect')"
                                                                        field-type="metric"
                                                                        :setting-key="'id'"
                                                                        :display-key="'name'"
                                                                        :multi-select="true"
              ...
              <div class="bk-form biz-configuration-form pb15">
                      ...
                      <tbody>
                        <tr v-for="(port, index) in curContainer.ports" :key="index">
                          ...
                          <td>
                            ...
                            <!-- <bk-selector
                                                                placeholder="deploy.templateset.protocol"
                ...
                <div style="margin-left: 140px;" v-show="isPartBShow">
                  <bk-tab :type="'fill'" :active-name="'tab1'" :size="'small'" :key="curContainer.webCache.containerType">
                    ...
                    <bk-tab-panel name="tab5" :title="$t('deploy.templateset.healthCheck')" v-if="curContainer.webCache.containerType === 'container'">
                      <div class="bk-form m20">
                        <div class="bk-form-item">
                    ...
                    <bk-tab-panel name="tab5-1" :title="$t('deploy.templateset.readinessCheck')" v-if="curContainer.webCache.containerType === 'container'">
                      <div class="bk-form m20">
                        <div class="bk-form-item">
                          <label class="bk-label" style="width: 120px;">{{$t('generic.label.kind')}}：</label>
                          <div class="bk-form-content" style="margin-left: 120px">
                    ...
                    <bk-tab-panel name="tab7" :title="$t('deploy.templateset.lifecycle')" v-if="curContainer.webCache.containerType === 'container'">
                      <div class="bk-form m20">
                        <div class="bk-form-item">
                          <div class="bk-form-content" style="margin-left: 20px">
                            <div class="bk-form-item">
  ...
  methods: {
    ...
    removeApplication(application, index) {
      ...
      this.$bkInfo({
        ...
        content: this.$createElement('p', { style: { 'text-align': 'left' } }, `${this.$t('deploy.templateset.deleteDeployment')}：${application.config.metadata.name || this.$t('deploy.templateset.unnamed')}`),
        confirmFn() {
    ...
    goCrdcontroller() {
      ...
      if (isEdited) {
        self.$bkInfo({
          title: self.$t('deploy.templateset.confirmExit'),
          content: self.$createElement('p', {
            style: {
              textAlign: 'left',
            },
          }, self.$t('deploy.templateset.unsavedTemplateWarning')),
          confirmFn() {
            self.$router.push({
              name: 'crdcontroller',
            });
