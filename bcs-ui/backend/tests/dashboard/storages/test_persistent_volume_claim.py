...
class TestPersistentVolumeClaim:
    ...
    def test_list_public_cluster_pvc(self, api_client, project_id):
        """ 获取公共集群 PVC，预期是被拦截（PermissionDenied） """
        url = f'/api/dashboard/projects/{project_id}/clusters/{TEST_PUBLIC_CLUSTER_ID}/namespaces/{TEST_NAMESPACE}/storages/persistent_volume_claims/'  # noqa
