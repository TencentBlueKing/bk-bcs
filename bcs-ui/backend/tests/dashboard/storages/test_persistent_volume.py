...
class TestPersistentVolume:
    ...
    def test_list_common_cluster_pv(self, api_client, project_id):
        """ 获取公共集群 PV，预期是被拦截（PermissionDenied） """
        url = f'/api/dashboard/projects/{project_id}/clusters/{TEST_COMMON_CLUSTER_ID}/storages/persistent_volumes/'
