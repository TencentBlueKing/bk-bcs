...
class TestNamespace:
    ...
    def test_list_common_cluster_ns(self, api_client, project_id, common_cluster_ns_mgr):
        """ 获取公共集群中项目拥有的命名空间 """
        response = api_client.get(
            f'/api/dashboard/projects/{project_id}/clusters/{TEST_COMMON_CLUSTER_ID}/namespaces/'
        )
