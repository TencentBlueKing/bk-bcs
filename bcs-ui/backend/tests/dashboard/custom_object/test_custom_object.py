...
class TestCustomObject:
    ...
    def test_list_common_cluster_cobj(self, api_client, project_id):
        """ 获取公共集群 cobj，预期是被拦截（PermissionDenied） """
        url = f'/api/dashboard/projects/{project_id}/clusters/{TEST_COMMON_CLUSTER_ID}/crds/v2/{self.crd_name}/custom_objects/'  # noqa
