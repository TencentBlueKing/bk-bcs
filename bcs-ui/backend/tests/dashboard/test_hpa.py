...
from backend.tests.conftest import TEST_COMMON_CLUSTER_ID, TEST_NAMESPACE
...
class TestHPA:
    ...
    def test_list_common_cluster_hpa(self, api_client, project_id):
        """ 获取公共集群 HPA，预期是被拦截（PermissionDenied） """
        url = f'/api/dashboard/projects/{project_id}/clusters/{TEST_COMMON_CLUSTER_ID}/namespaces/{TEST_NAMESPACE}/hpa/'  # noqa
