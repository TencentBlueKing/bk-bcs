...
class TestPaaSCCClient:
    @mock.patch("backend.components.paas_cc.refine_shared_clusters", return_value=[])
    def test_get_cluster_simple(self, project_id, cluster_id, requests_mock, refine_shared_clusters):
