...
import (
	...
	bsMetrics "github.com/Tencent/bk-bcs/bcs-runtime/bcs-mesos/bcs-dns/plugin/bcsscheduler/metrics"
...
func setup(c *caddy.Controller) error {
	...
	c.OnStartup(func() error {
		metrics.MustRegister(c, bsMetrics.RequestCount, bsMetrics.RequestLatency, bsMetrics.RequestOutProxyCount,
			bsMetrics.DnsTotal, bsMetrics.StorageOperatorTotal, bsMetrics.StorageOperatorLatency, bsMetrics.ZkNotifyTotal)
