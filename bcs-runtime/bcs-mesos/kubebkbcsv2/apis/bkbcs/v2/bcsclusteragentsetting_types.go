...
type BcsClusterAgentSettingSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file
	types.BcsClusterAgentSetting
}
...
type BcsClusterAgentSetting struct {
	...
	Spec   BcsClusterAgentSettingSpec   `json:"spec,omitempty"`
	Status BcsClusterAgentSettingStatus `json:"status,omitempty"`
}
...
type BcsClusterAgentSettingList struct {
	...
	Items           []BcsClusterAgentSetting `json:"items"`
}

func init() {
	SchemeBuilder.Register(&BcsClusterAgentSetting{}, &BcsClusterAgentSettingList{})
}
