...
./vendor/k8s.io/code-generator/generate-groups.sh \
    ...
    github.com/Tencent/bk-bcs/bcs-runtime/bcs-mesos/kubebkbcsv2/client \
    github.com/Tencent/bk-bcs/bcs-runtime/bcs-mesos/kubebkbcsv2/apis \
    "${group_version_pair}" \
...
if [ $GOPATH ]; then
    echo "mv from gopath"
    if [[ ${GOPATH}/src/github.com/Tencent/bk-bcs/bcs-runtime/bcs-mesos/kubebkbcsv2/client == $(pwd)/client ]]; then
        echo "done"
    else
        echo "mv from ${GOPATH}/src/github.com/Tencent/bk-bcs/bcs-runtime/bcs-mesos/kubebkbcsv2/client"
        mv ${GOPATH}/src/github.com/Tencent/bk-bcs/bcs-runtime/bcs-mesos/kubebkbcsv2/client client
    fi
else
  echo "cp from current dir"
  cp -r github.com/Tencent/bk-bcs/bcs-runtime/bcs-mesos/kubebkbcsv2/client client
  rm -rf ./github.com
fi 
