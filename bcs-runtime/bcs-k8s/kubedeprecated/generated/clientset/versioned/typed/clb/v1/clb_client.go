...
// ClbV1Client is used to interact with features provided by the clb group.
type ClbV1Client struct {
	restClient rest.Interface
}

func (c *ClbV1Client) ClbIngresses(namespace string) ClbIngressInterface {
	return newClbIngresses(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*ClbV1Client, error) {
	...
	return &ClbV1Client{client}, nil
}

// NewForConfigOrDie creates a new ClbV1Client for the given config and
