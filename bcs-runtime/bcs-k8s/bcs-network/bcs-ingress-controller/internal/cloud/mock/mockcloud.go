...
func (m *MockLoadBalance) DescribeLoadBalancer(arg0, arg1, arg2, arg3 string) (*cloud.LoadBalanceObject, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DescribeLoadBalancer", arg0, arg1, arg2, arg3)
...
func (mr *MockLoadBalanceMockRecorder) DescribeLoadBalancer(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribeLoadBalancer", reflect.TypeOf((*MockLoadBalance)(nil).DescribeLoadBalancer), arg0, arg1, arg2, arg3)
}

// DescribeLoadBalancerWithNs mocks base method.
func (m *MockLoadBalance) DescribeLoadBalancerWithNs(arg0, arg1, arg2, arg3, arg4 string) (*cloud.LoadBalanceObject, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DescribeLoadBalancerWithNs", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(*cloud.LoadBalanceObject)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockLoadBalanceMockRecorder) DescribeLoadBalancerWithNs(arg0, arg1, arg2, arg3, arg4 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribeLoadBalancerWithNs", reflect.TypeOf((*MockLoadBalance)(nil).DescribeLoadBalancerWithNs), arg0, arg1, arg2, arg3, arg4)
}
...
func (m *MockLoadBalance) EnsureMultiListeners(arg0, arg1 string, arg2 []*v1.Listener) (map[string]cloud.Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnsureMultiListeners", arg0, arg1, arg2)
	ret0, _ := ret[0].(map[string]cloud.Result)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockLoadBalance) EnsureMultiSegmentListeners(arg0, arg1 string, arg2 []*v1.Listener) (map[string]cloud.Result, error) {
	m.ctrl.T.Helper()
