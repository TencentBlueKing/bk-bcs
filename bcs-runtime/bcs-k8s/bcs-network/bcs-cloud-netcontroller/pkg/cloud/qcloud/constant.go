...
const (
	// ENV_NAME_TENCENTCLOUD_VPC_DOMAIN env name of tencent cloud vpc domain
	ENV_NAME_TENCENTCLOUD_VPC_DOMAIN = "TENCENTCLOUD_VPC_DOMAIN"
	// ENV_NAME_TENCENTCLOUD_CVM_DOMAIN env name of tencent cloud cvm domain
	ENV_NAME_TENCENTCLOUD_CVM_DOMAIN = "TENCENTCLOUD_CVM_DOMAIN"
