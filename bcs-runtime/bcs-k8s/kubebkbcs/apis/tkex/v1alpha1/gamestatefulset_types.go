...
// GameStatefulSetSpec defines the desired state of GameStatefulSet
...
// GameStatefulSetStatus defines the observed state of GameStatefulSet
...
// GameStatefulSetList contains a list of GameStatefulSet
type GameStatefulSetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []GameStatefulSet `json:"items"`
}

func init() {
	SchemeBuilder.Register(&GameStatefulSet{}, &GameStatefulSetList{})
}
