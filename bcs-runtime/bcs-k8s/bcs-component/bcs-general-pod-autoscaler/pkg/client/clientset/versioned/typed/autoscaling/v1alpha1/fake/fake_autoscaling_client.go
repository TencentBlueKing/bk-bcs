...
import (
	v1alpha1 "github.com/Tencent/bk-bcs/bcs-runtime/bcs-k8s/bcs-component/bcs-general-pod-autoscaler/pkg/client/clientset/versioned/typed/autoscaling/v1alpha1"
...
func (c *FakeAutoscalingV1alpha1) GeneralPodAutoscalers(namespace string) v1alpha1.GeneralPodAutoscalerInterface {
	return &FakeGeneralPodAutoscalers{c, namespace}
}
