...
func (f *IPFilter) Create(ctx context.Context, event event.TypedCreateEvent[client.Object],
	q workqueue.TypedRateLimitingInterface[reconcile.Request]) {
}

// Update is called in response to an update event
func (f *IPFilter) Update(ctx context.Context, event event.TypedUpdateEvent[client.Object],
	q workqueue.TypedRateLimitingInterface[reconcile.Request]) {
...
func (f *IPFilter) Delete(ctx context.Context, event event.TypedDeleteEvent[client.Object],
	q workqueue.TypedRateLimitingInterface[reconcile.Request]) {
...
func (f *IPFilter) Generic(ctx context.Context, event event.TypedGenericEvent[client.Object],
	q workqueue.TypedRateLimitingInterface[reconcile.Request]) {
}
