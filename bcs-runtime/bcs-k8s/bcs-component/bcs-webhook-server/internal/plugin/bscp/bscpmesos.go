...
// NewMesosInject new Inject object
func NewMesosInject() *MesosInject {
	return &MesosInject{}
}

// Init initialize plugin
func (bi *MesosInject) Init(configFile string) error {
...
func (bi *MesosInject) InjectDeployContent(deploy *commtypes.BcsDeployment) (*commtypes.BcsDeployment, error) {
	// if get no bscp inject annotations, just return original content
