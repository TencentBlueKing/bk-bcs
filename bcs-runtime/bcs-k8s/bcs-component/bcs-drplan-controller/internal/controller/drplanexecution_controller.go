...
// +kubebuilder:rbac:groups=apps.clusternet.io,resources=globalizations;helmcharts;localizations;manifests;subscriptions,verbs=get;list;watch;create;update;patch;delete
