...
import (
	...
	scheme "github.com/Tencent/bk-bcs/bcs-runtime/bcs-k8s/bcs-component/bcs-mcs/pkg/generated/clientset/versioned/scheme"
...
func newManifests(c *McsV1alpha1Client, namespace string) *manifests {
	return &manifests{
		client: c.RESTClient(),
		ns:     namespace,
	}
