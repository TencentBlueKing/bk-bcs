...
const (
	// HookRunKind is the Kind of HookRun
	HookRunKind = "HookRun"
	// HookTemplateKind is the Kind of HookTemplate
	HookTemplateKind = "HookTemplate"
...
func NewWebhookServer(hookClient hookclientset.Interface) *WebhookServer {
