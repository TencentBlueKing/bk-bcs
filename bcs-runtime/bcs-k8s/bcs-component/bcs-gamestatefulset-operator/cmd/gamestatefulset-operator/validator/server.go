...
import (
	...
	"github.com/Tencent/bk-bcs/bcs-runtime/bcs-k8s/bcs-component/bcs-gamestatefulset-operator/pkg/validation"
)
...
// Run run
func Run(s *ServerRunOptions, gssClient gssclientset.Interface, stopCh <-chan struct{}) error {
	webHook := validation.NewWebhookServer(gssClient)
