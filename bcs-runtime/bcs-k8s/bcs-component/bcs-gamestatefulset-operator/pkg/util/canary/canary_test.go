...
import (
	"github.com/Tencent/bk-bcs/bcs-runtime/bcs-k8s/bcs-component/bcs-gamestatefulset-operator/pkg/apis/tkex/v1alpha1"
	"reflect"
	"testing"
	"time"
)
...
func TestGetCurrentCanaryStep(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			deploy: &v1alpha1.GameStatefulSet{
				Spec: v1alpha1.GameStatefulSetSpec{
					UpdateStrategy: v1alpha1.GameStatefulSetUpdateStrategy{
						CanaryStrategy: &v1alpha1.CanaryStrategy{
							Steps: []v1alpha1.CanaryStep{{Pause: &v1alpha1.CanaryPause{}}},
						},
					},
				},
				Status: v1alpha1.GameStatefulSetStatus{
...
func TestComputeStepHash(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			deploy: &v1alpha1.GameStatefulSet{
				Spec: v1alpha1.GameStatefulSetSpec{UpdateStrategy: v1alpha1.GameStatefulSetUpdateStrategy{
					CanaryStrategy: &v1alpha1.CanaryStrategy{
						Steps: []v1alpha1.CanaryStep{{Pause: &v1alpha1.CanaryPause{}}},
					},
				}},
