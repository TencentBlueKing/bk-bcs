...
func (gdc *defaultGameDeploymentControl) UpdateGameDeployment(deploy *gdv1alpha1.GameDeployment,
	...
	delayDuration, updateErr := gdc.updateGameDeployment(deploy, canaryCtx.newStatus, currentRevision, updateRevision, revisions,
		pods, allPods, hrList)
	if updateErr != nil {
...
func (gdc *defaultGameDeploymentControl) updateGameDeployment(
	...
	filteredPods []*v1.Pod, allPods []*v1.Pod, hrList []*hookv1alpha1.HookRun) (time.Duration, error) {
