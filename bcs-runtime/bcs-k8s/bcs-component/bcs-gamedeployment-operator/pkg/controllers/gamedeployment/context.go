...
import (
	...
	hooksutil "github.com/Tencent/bk-bcs/bcs-runtime/bcs-k8s/bcs-component/bcs-gamedeployment-operator/pkg/util/hook"
...
func newCanaryCtx(deploy *gdv1alpha1.GameDeployment, hrList []*hookv1alpha1.HookRun,
