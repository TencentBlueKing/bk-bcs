module github.com/Tencent/bk-bcs/bcs-runtime/bcs-k8s/bcs-component/bcs-repack-descheduler
...
replace (
	...
	k8s.io/kubernetes/pkg/apis/autoscaling => k8s.io/kubernetes/pkg/apis/autoscaling v1.24.0
...
require (
	github.com/Tencent/bk-bcs/bcs-common v0.0.0-20240311084538-07a9ad91d3ff
	github.com/Tencent/bk-bcs/bcs-scenarios/kourse v0.0.0-20240311084538-07a9ad91d3ff
