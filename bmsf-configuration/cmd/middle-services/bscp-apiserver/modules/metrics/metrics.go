...
// Collector is metrics collector for apiserver.
...
func (c *Collector) StatRequest(rpc string, errcode int, inTime, outTime time.Time) int64 {
	c.reqCounter.With(prometheus.Labels{"rpc": rpc, "errcode": common.ToStr(errcode)}).Inc()
