...
func NewPublishAction(viper *viper.Viper, dataMgrCli pbdatamanager.DataManagerClient, bcsControllerCli pbbcscontroller.BCSControllerClient,
	gseControllerCli pbgsecontroller.GSEControllerClient, req *pb.PublishReleaseReq, resp *pb.PublishReleaseResp) *PublishAction {
...
func (act *PublishAction) publishPreBCSMode() (pbcommon.ErrCode, string) {
	...
	logger.V(2).Infof("PublishRelease[%d]| request to bcs-controller PublishReleasePre, %+v", act.req.Seq, r)
...
func (act *PublishAction) publishPreGSEPluginMode() (pbcommon.ErrCode, string) {
	...
	logger.V(2).Infof("PublishRelease[%d]| request to gse-controller PublishReleasePre, %+v", act.req.Seq, r)
...
func (act *PublishAction) publishData() (pbcommon.ErrCode, string) {
	...
	logger.V(2).Infof("PublishRelease[%d]| request to datamanager PublishRelease, %+v", act.req.Seq, r)
...
func (act *PublishAction) publishBCSMode() (pbcommon.ErrCode, string) {
	...
	logger.V(2).Infof("PublishRelease[%d]| request to bcs-controller PublishRelease, %+v", act.req.Seq, r)
...
func (act *PublishAction) publishGSEPluginMode() (pbcommon.ErrCode, string) {
	...
	logger.V(2).Infof("PublishRelease[%d]| request to gse-controller PublishRelease, %+v", act.req.Seq, r)
...
func (act *PublishAction) queryApp() (pbcommon.ErrCode, string) {
	...
	logger.V(2).Infof("PublishRelease[%d]| request to datamanager QueryApp, %+v", act.req.Seq, r)
