...
// ListAction is sharding list action object.
type ListAction struct {
	ctx   context.Context
	viper *viper.Viper
	smgr  *dbsharding.ShardingManager

	req  *pb.QueryShardingListReq
	resp *pb.QueryShardingListResp

	shardings []*pbcommon.Sharding
}
...
func NewListAction(ctx context.Context, viper *viper.Viper, smgr *dbsharding.ShardingManager,
	req *pb.QueryShardingListReq, resp *pb.QueryShardingListResp) *ListAction {
...
func (act *ListAction) Output() error {
	act.resp.Data = &pb.QueryShardingListResp_RespData{Info: act.shardings}
	return nil
}
...
func (act *ListAction) list() (pbcommon.ErrCode, string) {
	shardings, err := act.smgr.QueryShardingList()
	if err != nil {
		return pbcommon.ErrCode_E_DM_DB_EXEC_ERR, err.Error()
	}
	act.shardings = shardings
