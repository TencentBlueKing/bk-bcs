...
// ListAction list target variable objects.
...
func (act *ListAction) Output() error {
	act.resp.Data = &pb.QueryVariableListResp_RespData{TotalCount: act.totalCount, Info: act.variables}
	return nil
}
...
func (act *ListAction) queryVariableList() (pbcommon.ErrCode, string) {
	...
	logger.V(4).Infof("QueryVariableList[%s]| request to DataManager, %+v", r.Seq, r)
