...
// ListAction list target config template bind objects.
...
func (act *ListAction) Output() error {
	act.resp.Data = &pb.QueryTemplateBindListResp_RespData{TotalCount: act.totalCount, Info: act.templateBinds}
	return nil
}
...
func (act *ListAction) queryTemplateBindList() (pbcommon.ErrCode, string) {
	req := &pbdatamanager.QueryTemplateBindListReq{
		Seq:        act.kit.Rid,
		BizId:      act.req.BizId,
	...
	act.templateBinds = resp.Data.Info
