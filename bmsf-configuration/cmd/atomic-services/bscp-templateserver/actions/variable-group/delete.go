...
func (act *DeleteAction) queryVariableGroup() (pbcommon.ErrCode, string) {
	...
	logger.V(4).Infof("DeleteVariableGroup[%s]| request to DataManager, %+v", r.Seq, r)
...
func (act *DeleteAction) deleteVariableGroup() (pbcommon.ErrCode, string) {
	...
	logger.V(4).Infof("DeleteVariableGroup[%s]| request to DataManager, %+v", req.Seq, req)
