...
// Collector is metrics collector for gse plugin connserver.
...
func (c *Collector) setup() {
	c.reqCounter = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Namespace: "bscp",
			Subsystem: "gse_plugin_connserver",
			Name:      "request_total",
...
func (c *Collector) Setup() error {
	c.setup()
	prometheus.MustRegister(c.reqCounter, c.respTimeSummary, c.connGauge)
