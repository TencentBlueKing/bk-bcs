...
func (c *config) check() error {
	...
	c.viper.SetDefault("server.serviceName", "bk-bscp-connserver")

	c.viper.BindEnv("server.metadata", c.envName("SERVICE_METADATA"))
	c.viper.SetDefault("server.metadata", "bk-bscp-connserver")
	...
	c.viper.BindEnv("server.accessNodesLimit", c.envName("ACCESS_NODES_LIMIT"))
	c.viper.SetDefault("server.accessNodesLimit", 10)
