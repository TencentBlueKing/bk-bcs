...
func (act *ListAction) list() (pbcommon.ErrCode, string) {
	r := &pbdatamanager.QueryAppListReq{
		Seq:   act.kit.Rid,
		BizId: act.req.BizId,
		Page:  act.req.Page,
	}
	...
	if err != nil {
		return pbcommon.ErrCode_E_CS_SYSTEM_UNKNOWN, fmt.Sprintf("request to datamanager QueryAppList, %+v", err)
	}
	if resp.Code != pbcommon.ErrCode_E_OK {
		return resp.Code, resp.Message
	}
	act.resp.Data = &pb.QueryAppListResp_RespData{TotalCount: resp.Data.TotalCount, Info: resp.Data.Info}
