...
// DeleteAction action for deleting config template binding
...
func (act *DeleteAction) deleteTemplateBinding() (pbcommon.ErrCode, string) {
...
func (act *DeleteAction) Do() error {
	...
	if errCode, errMsg := act.deleteTemplateBinding(); errCode != pbcommon.ErrCode_E_OK {
