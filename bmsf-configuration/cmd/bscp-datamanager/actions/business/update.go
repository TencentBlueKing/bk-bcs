...
// UpdateAction is business update action object.
...
func (act *UpdateAction) updateBusiness() (pbcommon.ErrCode, string) {
	...
	if exec.RowsAffected == 0 {
		return pbcommon.ErrCode_E_DM_DB_UPDATE_ERR, "update the business failed, there is no business that fit the conditions."
	}
...
func (act *UpdateAction) Do() error {
	...
	// update business.
	if errCode, errMsg := act.updateBusiness(); errCode != pbcommon.ErrCode_E_OK {
