...
// UpdateAction is configset update action object.
...
func (act *UpdateAction) updateConfigSet() (pbcommon.ErrCode, string) {
	...
	if exec.RowsAffected == 0 {
		return pbcommon.ErrCode_E_DM_DB_UPDATE_ERR, "update the configset failed, there is no configset that fit the conditions."
	}
...
func (act *UpdateAction) Do() error {
	...
	// update configSet.
	if errCode, errMsg := act.updateConfigSet(); errCode != pbcommon.ErrCode_E_OK {
