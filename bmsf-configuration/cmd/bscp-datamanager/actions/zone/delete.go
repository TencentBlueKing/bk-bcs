...
// DeleteAction is zone delete action object.
...
func (act *DeleteAction) deleteZone() (pbcommon.ErrCode, string) {
	act.sd.AutoMigrate(&database.Zone{})

	ups := map[string]interface{}{
		"State":        int32(pbcommon.ZoneState_ZS_DELETED),
...
func (act *DeleteAction) Do() error {
	...
	// delete zone.
	if errCode, errMsg := act.deleteZone(); errCode != pbcommon.ErrCode_E_OK {
