...
func init() {
	actions.RegisterAction(actions.Action{Verb: "POST", Path: "/bcsapi/v4/netservice/{uri:*}", Params: nil,
		Handler: handlerActions})
	actions.RegisterAction(actions.Action{Verb: "PUT", Path: "/bcsapi/v4/netservice/{uri:*}", Params: nil,
		Handler: handlerActions})
	actions.RegisterAction(actions.Action{Verb: "GET", Path: "/bcsapi/v4/netservice/{uri:*}", Params: nil,
		Handler: handlerActions})
	actions.RegisterAction(actions.Action{Verb: "DELETE", Path: "/bcsapi/v4/netservice/{uri:*}", Params: nil,
		Handler: handlerActions})
}
