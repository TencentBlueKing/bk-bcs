...
var (
	pattern_BCSProject_CreateProject_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"bcs-project", "v1", "project"}, "", runtime.AssumeColonVerbOpt(true)))
)
