...
func handleContainerMetric(c *rest.Context, promql string, query *UsageQuery) (interface{}, error) {
	...
	params := map[string]interface{}{
		...
		"podName":       chi.URLParam(c.Request, "pod"),
		"containerName": chi.URLParam(c.Request, "container"),
		"provider":      PROVIDER,
	}
...
func ContainerCPUUsage(c context.Context, query UsageQuery) (interface{}, error) {
...
func ContainerMemoryUsed(c context.Context, query UsageQuery) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
...
func ContainerCPULimit(c context.Context, query UsageQuery) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
...
func ContainerMemoryLimit(c context.Context, query UsageQuery) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
...
func ContainerDiskReadTotal(c context.Context, query UsageQuery) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
...
func ContainerDiskWriteTotal(c context.Context, query UsageQuery) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
