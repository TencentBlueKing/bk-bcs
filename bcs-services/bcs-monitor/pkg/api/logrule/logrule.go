...
func GetEntrypoints(c context.Context, req GetEntrypointsReq) (interface{}, error) {
...
func ListLogCollectors(c context.Context, e rest.EmptyReq) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
	listInDB, err := getClusterLogRules(context.Background(), rctx.ProjectId, rctx.ClusterId)
	if err != nil {
		return nil, err
	}

	// 从 bk-log 获取规则数据
	lcs, err := bklog.ListLogCollectors(c, rctx.ClusterId, GetSpaceID(rctx.ProjectCode))
	if err != nil {
		return nil, err
	}
...
func GetLogRule(c context.Context, e rest.EmptyReq) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
	id := chi.URLParam(rctx.Request, "id")
...
func CreateLogRule(c context.Context, req CreateLogRuleReq) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
	...
	cond := operator.NewLeafCondition(operator.Eq, operator.M{
		...
		entity.FieldKeyClusterID: rctx.ClusterId,
...
func UpdateLogRule(c context.Context, req UpdateLogRuleReq) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
...
func DeleteLogRule(c context.Context, e rest.EmptyReq) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
	...
	if lc.ProjectCode != rctx.ProjectCode || lc.ClusterID != rctx.ClusterId {
...
func RetryLogRule(c context.Context, e rest.EmptyReq) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
...
func EnableLogRule(c context.Context, e rest.EmptyReq) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
...
func DisableLogRule(c context.Context, e rest.EmptyReq) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
...
func GetStorageClusters(c context.Context, e rest.EmptyReq) (interface{}, error) {
	rctx, err := rest.GetRestContext(c)
	if err != nil {
		return nil, err
	}
	...
	selectCluster, err := bklog.GetBcsCollectorStorage(c, GetSpaceID(rctx.ProjectCode), rctx.ClusterId)
	if err != nil {
		return nil, err
	}
	for i := range data {
