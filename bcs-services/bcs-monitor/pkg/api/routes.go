...
func registerMetricsRoutes() http.Handler {
	...
	r.Route("/projects/{projectCode}/clusters/{clusterId}", func(route chi.Router) {
		...
		route.Get("/cpu_request_with_init_usage", rest.Handle(metrics.ClusterCPURequestWithInitUsage))
		...
		route.Get("/memory_request_with_init_usage", rest.Handle(metrics.ClusterMemoryRequestWithInitUsage))
		...
		route.Get("/nodes/{node}/cpu_request_with_init_usage", rest.Handle(metrics.GetNodeCPURequestWithInitUsage))
		...
		route.Get("/nodes/{node}/memory_request_with_init_usage", rest.Handle(metrics.GetNodeMemoryRequestWithInitUsage))
