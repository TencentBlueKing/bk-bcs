...
var AvailableNodeMetrics = []string{
	...
	"bcs:cluster:cpu_request_with_init:usage",
	...
	"bcs:cluster:memory_request_with_init:usage",
	...
	"bcs:node:cpu_request_with_init:usage",
	"bcs:node:disk:usage",
	"bcs:node:disk:used",
	"bcs:node:disk:total",
	...
	"bcs:node:memory_request_with_init:usage",
