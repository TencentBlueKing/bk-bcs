...
func (m *ComputeV2) GetNodeCPURequestWithInitUsage(ctx context.Context, projectID, clusterID, nodeName string,
	start, end time.Time, step time.Duration) ([]*prompb.TimeSeries, error) {
	return nil, nil
}

// GetNodeMemoryRequestWithInitUsage 节点含 InitContainer 的内存装箱率
func (m *ComputeV2) GetNodeMemoryRequestWithInitUsage(ctx context.Context, projectID, clusterID, nodeName string,
	start, end time.Time, step time.Duration) ([]*prompb.TimeSeries, error) {
	return nil, nil
}
