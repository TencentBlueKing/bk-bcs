...
func (m *Prometheus) handleGroupMetric(ctx context.Context, projectID, clusterID, group string,
...
func (m *Prometheus) GetClusterGroupNodeNum(ctx context.Context, projectID, clusterID, group string, start,
...
func (m *Prometheus) GetClusterGroupMaxNodeNum(ctx context.Context, projectID, clusterID, group string, start,
	end time.Time, step time.Duration) ([]*prompb.TimeSeries, error) {
	promql :=
