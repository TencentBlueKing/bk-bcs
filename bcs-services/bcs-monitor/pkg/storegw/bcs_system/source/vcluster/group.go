...
func (m *VCluster) handleGroupMetric(ctx context.Context, projectID, clusterID, group string,
...
func (m *VCluster) GetClusterGroupNodeNum(ctx context.Context, projectID, clusterID, group string, start,
...
func (m *VCluster) GetClusterGroupMaxNodeNum(ctx context.Context, projectID, clusterID, group string, start,
	end time.Time, step time.Duration) ([]*prompb.TimeSeries, error) {
	promql :=
