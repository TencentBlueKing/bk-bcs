...
var metricsMaps = map[string]metricsFn{
	...
	// GetClusterCPURequestWithInitUsage
	"bcs:cluster:cpu_request_with_init:usage": func(mp metricsParams) ([]*prompb.TimeSeries, error) {
		return mp.client.GetClusterCPURequestWithInitUsage(mp.ctx, mp.projectID, mp.clusterID,
			mp.startTime, mp.endTime, mp.stepDuration)
	},
	...
	// GetClusterMemoryRequestWithInitUsage
	"bcs:cluster:memory_request_with_init:usage": func(mp metricsParams) ([]*prompb.TimeSeries, error) {
		return mp.client.GetClusterMemoryRequestWithInitUsage(mp.ctx, mp.projectID, mp.clusterID,
			mp.startTime, mp.endTime, mp.stepDuration)
	},
	// GetClusterDiskTotal
	...
	// GetNodeCPURequestWithInitUsage
	"bcs:node:cpu_request_with_init:usage": func(mp metricsParams) ([]*prompb.TimeSeries, error) {
		return mp.client.GetNodeCPURequestWithInitUsage(mp.ctx, mp.projectID, mp.clusterID, mp.node,
			mp.startTime, mp.endTime, mp.stepDuration)
	},
	// GetNodeMemoryTotal
	...
	// GetNodeMemoryRequestWithInitUsage
	"bcs:node:memory_request_with_init:usage": func(mp metricsParams) ([]*prompb.TimeSeries, error) {
		return mp.client.GetNodeMemoryRequestWithInitUsage(mp.ctx, mp.projectID, mp.clusterID, mp.node,
			mp.startTime, mp.endTime, mp.stepDuration)
	},
	...
	"bcs:pod:cpu_peak_usage": func(mp metricsParams) ([]*prompb.TimeSeries, error) {
		return mp.client.GetPodCPUPeakUsage(mp.ctx, mp.projectID, mp.clusterID, mp.namespace,
			mp.podNames, mp.startTime, mp.endTime, mp.stepDuration)
	},
