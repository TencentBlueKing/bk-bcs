	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TypesV1beta1().FederatedReplicaSets(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TypesV1beta1().FederatedReplicaSets(namespace).Watch(options)
			},
		},
		&types_v1beta1.FederatedReplicaSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *federatedReplicaSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&types_v1beta1.FederatedReplicaSet{}, f.defaultInformer)
}
