...
var ingressdnsrecordsResource = schema.GroupVersionResource{Group: "multiclusterdns.kubefed.io", Version: "v1alpha1", Resource: "ingressdnsrecords"}

var ingressdnsrecordsKind = schema.GroupVersionKind{Group: "multiclusterdns.kubefed.io", Version: "v1alpha1", Kind: "IngressDNSRecord"}
...
func (c *FakeIngressDNSRecords) List(opts v1.ListOptions) (result *v1alpha1.IngressDNSRecordList, err error) {
	...
	list := &v1alpha1.IngressDNSRecordList{}
