...
type FederatedServiceAccountInterface interface {
	Create(*v1beta1.FederatedServiceAccount) (*v1beta1.FederatedServiceAccount, error)
	Update(*v1beta1.FederatedServiceAccount) (*v1beta1.FederatedServiceAccount, error)
	UpdateStatus(*v1beta1.FederatedServiceAccount) (*v1beta1.FederatedServiceAccount, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.FederatedServiceAccount, error)
	List(opts v1.ListOptions) (*v1beta1.FederatedServiceAccountList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.FederatedServiceAccount, err error)
...
func newFederatedServiceAccounts(c *TypesV1beta1Client, namespace string) *federatedServiceAccounts {
...
func (c *federatedServiceAccounts) Get(name string, options v1.GetOptions) (result *v1beta1.FederatedServiceAccount, err error) {
	result = &v1beta1.FederatedServiceAccount{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *federatedServiceAccounts) List(opts v1.ListOptions) (result *v1beta1.FederatedServiceAccountList, err error) {
	result = &v1beta1.FederatedServiceAccountList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("federatedserviceaccounts").
...
func (c *federatedServiceAccounts) Create(federatedServiceAccount *v1beta1.FederatedServiceAccount) (result *v1beta1.FederatedServiceAccount, err error) {
	result = &v1beta1.FederatedServiceAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("federatedserviceaccounts").
...
func (c *federatedServiceAccounts) Update(federatedServiceAccount *v1beta1.FederatedServiceAccount) (result *v1beta1.FederatedServiceAccount, err error) {
	result = &v1beta1.FederatedServiceAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedserviceaccounts").
...
func (c *federatedServiceAccounts) UpdateStatus(federatedServiceAccount *v1beta1.FederatedServiceAccount) (result *v1beta1.FederatedServiceAccount, err error) {
	result = &v1beta1.FederatedServiceAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("federatedserviceaccounts").
...
func (c *federatedServiceAccounts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.FederatedServiceAccount, err error) {
	result = &v1beta1.FederatedServiceAccount{}
