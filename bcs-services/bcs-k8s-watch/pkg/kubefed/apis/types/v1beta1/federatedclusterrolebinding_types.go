...
// FederatedClusterRoleBinding is the Schema for the federatedclusterrolebindings API
...
func init() {
	SchemeBuilder.Register(&FederatedClusterRoleBinding{}, &FederatedClusterRoleBindingList{})
}
