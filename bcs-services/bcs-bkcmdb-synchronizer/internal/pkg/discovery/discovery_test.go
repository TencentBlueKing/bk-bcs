...
const (
	serviceDomain = "costmanager.bkbcs.tencent.com"
)
...
// TestGetRandomServiceInstance tests get random service instance
func TestGetRandomServiceInstance(t *testing.T) {
	r := NewRegistry()
