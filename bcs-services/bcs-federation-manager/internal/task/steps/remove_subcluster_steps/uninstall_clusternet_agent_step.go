...
var (
	// UninstallClusternetAgentStepName step name for create cluster
	UninstallClusternetAgentStepName = fedsteps.StepNames{
		Alias: "unintall bcs-clusternet-agent",
		Name:  "UNINSTALL_CLUSTERNET_AGENT",
	}
)

// NewUninstallClusternetAgentStep sum step
func NewUninstallClusternetAgentStep() *UninstallClusternetAgentStep {
	return &UninstallClusternetAgentStep{}
}

// UninstallClusternetAgentStep sum step
type UninstallClusternetAgentStep struct{}

// Alias step name
func (s UninstallClusternetAgentStep) Alias() string {
	return UninstallClusternetAgentStepName.Alias
}

// GetName step name
func (s UninstallClusternetAgentStep) GetName() string {
	return UninstallClusternetAgentStepName.Name
}

// DoWork for worker exec task
func (s UninstallClusternetAgentStep) DoWork(t *types.Task) error {
...
func (s UninstallClusternetAgentStep) BuildStep(kvs []task.KeyValue, opts ...types.StepOption) *types.Step {
