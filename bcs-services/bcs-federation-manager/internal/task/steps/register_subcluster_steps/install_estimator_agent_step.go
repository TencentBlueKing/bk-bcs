...
var (
	// InstallEstimatorAgentStepName step name for create cluster
	InstallEstimatorAgentStepName = fedsteps.StepNames{
		Alias: "install estimator agent",
		Name:  "INSTALL_ESTIMATOR_AGENT",
	}
)

// NewInstallEstimatorAgentStep sum step
func NewInstallEstimatorAgentStep() *InstallEstimatorAgentStep {
	return &InstallEstimatorAgentStep{}
}

// InstallEstimatorAgentStep sum step
type InstallEstimatorAgentStep struct{}

// Alias step name
func (s InstallEstimatorAgentStep) Alias() string {
	return InstallEstimatorAgentStepName.Alias
}

// GetName step name
func (s InstallEstimatorAgentStep) GetName() string {
	return InstallEstimatorAgentStepName.Name
}

// DoWork for worker exec task
func (s InstallEstimatorAgentStep) DoWork(t *types.Task) error {
...
func (s InstallEstimatorAgentStep) BuildStep(kvs []task.KeyValue, opts ...types.StepOption) *types.Step {
