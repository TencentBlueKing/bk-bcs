...
require (
	github.com/Tencent/bk-bcs/bcs-common v0.0.0-20251212085103-085b7dd6834f
...
require (
	...
	github.com/Tencent/bk-bcs/bcs-services/pkg v0.0.0-20241021113845-70cacb22b595
	github.com/avast/retry-go v3.0.0+incompatible
	github.com/clusternet/clusternet v0.17.2
