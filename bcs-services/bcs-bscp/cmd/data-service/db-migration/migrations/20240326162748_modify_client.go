...
func init() {
	...
	migrator.GetMigrator().AddMigration(&migrator.Migration{
		Version: "20240326162748",
		Name:    "20240326162748_modify_client",
		Mode:    migrator.GormMode,
		Up:      mig20240326162748Up,
		Down:    mig20240326162748Down,
	})
}

// mig20240326162748Up for up migration
func mig20240326162748Up(tx *gorm.DB) error {
	// Clients : client
	type Clients struct {
		...
		SpecificFailedReason string  `gorm:"column:specific_failed_reason;type:varchar(20);NOT NULL"`
	}
...
// mig20240326162748Down for down migration
func mig20240326162748Down(tx *gorm.DB) error {
	return nil
}
