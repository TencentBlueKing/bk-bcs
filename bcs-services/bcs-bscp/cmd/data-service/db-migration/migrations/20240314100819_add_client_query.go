...
func init() {
	...
	migrator.GetMigrator().AddMigration(&migrator.Migration{
		Version: "20240314100819",
		Name:    "20240314100819_add_client_query",
		Mode:    migrator.GormMode,
		Up:      mig20240314100819Up,
		Down:    mig20240314100819Down,
	})
}

// mig20240314100819Up for up migration
func mig20240314100819Up(tx *gorm.DB) error {
...
// mig20240314100819Down for down migration
func mig20240314100819Down(tx *gorm.DB) error {
	...
	if err := tx.Migrator().DropTable(ClientQuerys{}); err != nil {
		return err
	}
