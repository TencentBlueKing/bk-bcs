export default {
  ...
  '下载地址：': '下载地址：',
  '创建命令配置文件，配置文件为 YAML 格式': '创建命令配置文件，配置文件为 YAML 格式',
  获取业务下的服务列表: '获取业务下的服务列表',
  拉取服务下所有配置文件: '拉取服务下所有配置文件',
  获取服务下所有配置文件列表: '获取服务下所有配置文件列表',
  '下载指定配置文件到指定目录，例如指定文件为 /etc/nginx/nginx.conf，下载文件到 /root/config 目录': '下载指定配置文件到指定目录，例如指定文件为 /etc/nginx/nginx.conf，下载文件到 /root/config 目录',
  示例已复制: '示例已复制',
