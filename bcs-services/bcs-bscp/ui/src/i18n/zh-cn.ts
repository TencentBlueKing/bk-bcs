export default {
  ...
  最近查询: '最近查询',
  全部常用查询: '全部常用查询',
  'UID/IP/标签/源版本/最近一次拉取配置状态/在线状态/客户端组件类型/客户端组件版本/配置拉取时间范围': 'UID/IP/标签/源版本/最近一次拉取配置状态/在线状态/客户端组件类型/客户端组件版本/配置拉取时间范围',
  '标签/源版本/最近一次拉取配置状态/在线状态/客户端组件类型/客户端组件版本': '标签/源版本/最近一次拉取配置状态/在线状态/客户端组件类型/客户端组件版本',
  常用查询添加成功: '常用查询添加成功',
  常用查询修改成功: '常用查询修改成功',
  常用查询删除成功: '常用查询删除成功',
  重命名: '重命名',
