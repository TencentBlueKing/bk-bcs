export default {
  ...
  'UID/IP/标签/源版本/最近一次拉取配置状态/在线状态/客户端组件类型/客户端组件版本/配置拉取时间范围/错误类别': 'UID/IP/Tag/Source version/Last pull configuration status/Online status/Client component type/Client component version/Set the pull time range/Error category',
