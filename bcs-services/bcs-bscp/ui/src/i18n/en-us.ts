export default {
  ...
  'UID/IP/标签/当前配置版本/目标配置版本/最近一次拉取配置状态/在线状态/客户端组件版本': 'UID/IP/ tag/Current configuration version/Target configuration version/Last pulled configuration status/Online status/Client component version',
  ...
  CPU资源占用: 'CPU usage (Current/Max)',
  内存资源占用: 'Memory resource usage (Current/Max)',
