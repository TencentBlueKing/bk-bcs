...
var file_data_service_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x69, 0x74, 0x65, 0x64, 0x22, 0x97, 0x01, 0x0a, 0x0a, 0x50, 0x75, 0x62, 0x6c, 0x69,
	...
	0x70, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x73,
	...
	0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xfb,
	0x18, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x33, 0x0a, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74,
...
var file_data_service_proto_msgTypes = make([]protoimpl.MessageInfo, 70)
var file_data_service_proto_goTypes = []interface{}{
	...
	(*CountGroupsReleasedAppsReq)(nil),   // 51: pbds.CountGroupsReleasedAppsReq
	(*CountGroupsReleasedAppsResp)(nil),  // 52: pbds.CountGroupsReleasedAppsResp
	(*ListGroupRleasesdAppsReq)(nil),     // 53: pbds.ListGroupRleasesdAppsReq
	(*ListGroupRleasesdAppsResp)(nil),    // 54: pbds.ListGroupRleasesdAppsResp
	...
	(*CountGroupsReleasedAppsResp_CountGroupsReleasedAppsData)(nil), // 68: pbds.CountGroupsReleasedAppsResp.CountGroupsReleasedAppsData
	(*ListGroupRleasesdAppsResp_ListGroupReleasedAppsData)(nil),     // 69: pbds.ListGroupRleasesdAppsResp.ListGroupReleasedAppsData
	(*app.AppSpec)(nil),                        // 70: pbapp.AppSpec
	(*structpb.Struct)(nil),                    // 71: google.protobuf.Struct
	(*base.BasePage)(nil),                      // 72: pbbase.BasePage
	(*app.App)(nil),                            // 73: pbapp.App
	(*config_item.ConfigItemAttachment)(nil),   // 74: pbci.ConfigItemAttachment
	(*config_item.ConfigItemSpec)(nil),         // 75: pbci.ConfigItemSpec
	(*config_item.ConfigItem)(nil),             // 76: pbci.ConfigItem
	(*config_item.ListConfigItemCounts)(nil),   // 77: pbci.ListConfigItemCounts
	(*content.ContentAttachment)(nil),          // 78: pbcontent.ContentAttachment
	(*content.ContentSpec)(nil),                // 79: pbcontent.ContentSpec
	(*content.Content)(nil),                    // 80: pbcontent.Content
	(*commit.CommitAttachment)(nil),            // 81: pbcommit.CommitAttachment
	(*commit.Commit)(nil),                      // 82: pbcommit.Commit
	(*release.ReleaseAttachment)(nil),          // 83: pbrelease.ReleaseAttachment
	(*release.ReleaseSpec)(nil),                // 84: pbrelease.ReleaseSpec
	(*release.Release)(nil),                    // 85: pbrelease.Release
	(*released_ci.ReleasedConfigItem)(nil),     // 86: pbrci.ReleasedConfigItem
	(*strategy_set.StrategySetAttachment)(nil), // 87: pbss.StrategySetAttachment
	(*strategy_set.StrategySetSpec)(nil),       // 88: pbss.StrategySetSpec
	(*strategy_set.StrategySet)(nil),           // 89: pbss.StrategySet
	(*strategy_set.StrategySetState)(nil),      // 90: pbss.StrategySetState
	(*strategy.StrategyAttachment)(nil),        // 91: pbstrategy.StrategyAttachment
	(*strategy.StrategySpec)(nil),              // 92: pbstrategy.StrategySpec
	(*strategy.Strategy)(nil),                  // 93: pbstrategy.Strategy
	(*strategy.StrategyState)(nil),             // 94: pbstrategy.StrategyState
	(*hook.HookAttachment)(nil),                // 95: pbhook.HookAttachment
	(*hook.HookSpec)(nil),                      // 96: pbhook.HookSpec
	(*hook.Hook)(nil),                          // 97: pbhook.Hook
	(*group.GroupAttachment)(nil),              // 98: pbgroup.GroupAttachment
	(*group.GroupSpec)(nil),                    // 99: pbgroup.GroupSpec
	(*group.Group)(nil),                        // 100: pbgroup.Group
	(*strategy.PublishedStrategyHistory)(nil),  // 101: pbstrategy.PublishedStrategyHistory
	(*instance.ReleasedInstanceSpec)(nil),      // 102: pbinstance.ReleasedInstanceSpec
	(*instance.CurrentReleasedInstance)(nil),   // 103: pbinstance.CurrentReleasedInstance
	(*base.EmptyResp)(nil),                     // 104: pbbase.EmptyResp
}
var file_data_service_proto_depIdxs = []int32{
	70,  // 0: pbds.CreateAppReq.spec:type_name -> pbapp.AppSpec
	70,  // 1: pbds.UpdateAppReq.spec:type_name -> pbapp.AppSpec
	71,  // 2: pbds.ListAppsReq.filter:type_name -> google.protobuf.Struct
	72,  // 3: pbds.ListAppsReq.page:type_name -> pbbase.BasePage
	73,  // 4: pbds.ListAppsResp.details:type_name -> pbapp.App
	74,  // 5: pbds.CreateConfigItemReq.attachment:type_name -> pbci.ConfigItemAttachment
	75,  // 6: pbds.CreateConfigItemReq.spec:type_name -> pbci.ConfigItemSpec
	74,  // 7: pbds.UpdateConfigItemReq.attachment:type_name -> pbci.ConfigItemAttachment
	75,  // 8: pbds.UpdateConfigItemReq.spec:type_name -> pbci.ConfigItemSpec
	74,  // 9: pbds.DeleteConfigItemReq.attachment:type_name -> pbci.ConfigItemAttachment
	76,  // 10: pbds.ListConfigItemsResp.details:type_name -> pbci.ConfigItem
	77,  // 11: pbds.ListConfigItemCountResp.details:type_name -> pbci.ListConfigItemCounts
	78,  // 12: pbds.CreateContentReq.attachment:type_name -> pbcontent.ContentAttachment
	79,  // 13: pbds.CreateContentReq.spec:type_name -> pbcontent.ContentSpec
	71,  // 14: pbds.ListContentsReq.filter:type_name -> google.protobuf.Struct
	72,  // 15: pbds.ListContentsReq.page:type_name -> pbbase.BasePage
	80,  // 16: pbds.ListContentsResp.details:type_name -> pbcontent.Content
	81,  // 17: pbds.CreateCommitReq.attachment:type_name -> pbcommit.CommitAttachment
	71,  // 18: pbds.ListCommitsReq.filter:type_name -> google.protobuf.Struct
	72,  // 19: pbds.ListCommitsReq.page:type_name -> pbbase.BasePage
	82,  // 20: pbds.ListCommitsResp.details:type_name -> pbcommit.Commit
	83,  // 21: pbds.CreateReleaseReq.attachment:type_name -> pbrelease.ReleaseAttachment
	84,  // 22: pbds.CreateReleaseReq.spec:type_name -> pbrelease.ReleaseSpec
	71,  // 23: pbds.ListReleasesReq.filter:type_name -> google.protobuf.Struct
	72,  // 24: pbds.ListReleasesReq.page:type_name -> pbbase.BasePage
	85,  // 25: pbds.ListReleasesResp.details:type_name -> pbrelease.Release
	71,  // 26: pbds.ListReleasedCIsReq.filter:type_name -> google.protobuf.Struct
	72,  // 27: pbds.ListReleasedCIsReq.page:type_name -> pbbase.BasePage
	86,  // 28: pbds.ListReleasedCIsResp.details:type_name -> pbrci.ReleasedConfigItem
	87,  // 29: pbds.CreateStrategySetReq.attachment:type_name -> pbss.StrategySetAttachment
	88,  // 30: pbds.CreateStrategySetReq.spec:type_name -> pbss.StrategySetSpec
	71,  // 31: pbds.ListStrategySetsReq.filter:type_name -> google.protobuf.Struct
	72,  // 32: pbds.ListStrategySetsReq.page:type_name -> pbbase.BasePage
	89,  // 33: pbds.ListStrategySetsResp.details:type_name -> pbss.StrategySet
	87,  // 34: pbds.UpdateStrategySetReq.attachment:type_name -> pbss.StrategySetAttachment
	90,  // 35: pbds.UpdateStrategySetReq.state:type_name -> pbss.StrategySetState
	88,  // 36: pbds.UpdateStrategySetReq.spec:type_name -> pbss.StrategySetSpec
	87,  // 37: pbds.DeleteStrategySetReq.attachment:type_name -> pbss.StrategySetAttachment
	91,  // 38: pbds.CreateStrategyReq.attachment:type_name -> pbstrategy.StrategyAttachment
	92,  // 39: pbds.CreateStrategyReq.spec:type_name -> pbstrategy.StrategySpec
	71,  // 40: pbds.ListStrategiesReq.filter:type_name -> google.protobuf.Struct
	72,  // 41: pbds.ListStrategiesReq.page:type_name -> pbbase.BasePage
	93,  // 42: pbds.ListStrategiesResp.details:type_name -> pbstrategy.Strategy
	91,  // 43: pbds.UpdateStrategyReq.attachment:type_name -> pbstrategy.StrategyAttachment
	94,  // 44: pbds.UpdateStrategyReq.status:type_name -> pbstrategy.StrategyState
	92,  // 45: pbds.UpdateStrategyReq.spec:type_name -> pbstrategy.StrategySpec
	91,  // 46: pbds.DeleteStrategyReq.attachment:type_name -> pbstrategy.StrategyAttachment
	95,  // 47: pbds.CreateHookReq.attachment:type_name -> pbhook.HookAttachment
	96,  // 48: pbds.CreateHookReq.spec:type_name -> pbhook.HookSpec
	71,  // 49: pbds.ListHooksReq.filter:type_name -> google.protobuf.Struct
	72,  // 50: pbds.ListHooksReq.page:type_name -> pbbase.BasePage
	97,  // 51: pbds.ListHooksResp.details:type_name -> pbhook.Hook
	95,  // 52: pbds.UpdateHookReq.attachment:type_name -> pbhook.HookAttachment
	96,  // 53: pbds.UpdateHookReq.spec:type_name -> pbhook.HookSpec
	95,  // 54: pbds.DeleteHookReq.attachment:type_name -> pbhook.HookAttachment
	98,  // 55: pbds.CreateGroupReq.attachment:type_name -> pbgroup.GroupAttachment
	99,  // 56: pbds.CreateGroupReq.spec:type_name -> pbgroup.GroupSpec
	71,  // 57: pbds.ListGroupsReq.filter:type_name -> google.protobuf.Struct
	72,  // 58: pbds.ListGroupsReq.page:type_name -> pbbase.BasePage
	100, // 59: pbds.ListGroupsResp.details:type_name -> pbgroup.Group
	98,  // 60: pbds.UpdateGroupReq.attachment:type_name -> pbgroup.GroupAttachment
	99,  // 61: pbds.UpdateGroupReq.spec:type_name -> pbgroup.GroupSpec
	98,  // 62: pbds.DeleteGroupReq.attachment:type_name -> pbgroup.GroupAttachment
	68,  // 63: pbds.CountGroupsReleasedAppsResp.data:type_name -> pbds.CountGroupsReleasedAppsResp.CountGroupsReleasedAppsData
	69,  // 64: pbds.ListGroupRleasesdAppsResp.details:type_name -> pbds.ListGroupRleasesdAppsResp.ListGroupReleasedAppsData
	71,  // 65: pbds.ListPubStrategyHistoriesReq.filter:type_name -> google.protobuf.Struct
	72,  // 66: pbds.ListPubStrategyHistoriesReq.page:type_name -> pbbase.BasePage
	101, // 67: pbds.ListPubStrategyHistoriesResp.details:type_name -> pbstrategy.PublishedStrategyHistory
	83,  // 68: pbds.CreateCRInstanceReq.attachment:type_name -> pbrelease.ReleaseAttachment
	102, // 69: pbds.CreateCRInstanceReq.spec:type_name -> pbinstance.ReleasedInstanceSpec
	71,  // 70: pbds.ListCRInstancesReq.filter:type_name -> google.protobuf.Struct
	72,  // 71: pbds.ListCRInstancesReq.page:type_name -> pbbase.BasePage
	103, // 72: pbds.ListCRInstancesResp.details:type_name -> pbinstance.CurrentReleasedInstance
	83,  // 73: pbds.DeleteCRInstanceReq.attachment:type_name -> pbrelease.ReleaseAttachment
	71,  // 74: pbds.ListInstancesReq.filter:type_name -> google.protobuf.Struct
	72,  // 75: pbds.ListInstancesReq.page:type_name -> pbbase.BasePage
	66,  // 76: pbds.ListInstancesResp.details:type_name -> pbds.InstanceResource
	...
	15,  // 89: pbds.Data.ListConfigItemCount:input_type -> pbds.ListConfigItemCountReq
	17,  // 90: pbds.Data.CreateContent:input_type -> pbds.CreateContentReq
	18,  // 91: pbds.Data.GetContent:input_type -> pbds.GetContentReq
	19,  // 92: pbds.Data.ListContents:input_type -> pbds.ListContentsReq
	21,  // 93: pbds.Data.CreateCommit:input_type -> pbds.CreateCommitReq
	22,  // 94: pbds.Data.GetLatestCommit:input_type -> pbds.GetLatestCommitReq
	23,  // 95: pbds.Data.ListCommits:input_type -> pbds.ListCommitsReq
	25,  // 96: pbds.Data.CreateRelease:input_type -> pbds.CreateReleaseReq
	26,  // 97: pbds.Data.ListReleases:input_type -> pbds.ListReleasesReq
	28,  // 98: pbds.Data.GetReleasedConfigItem:input_type -> pbds.GetReleasedCIReq
	29,  // 99: pbds.Data.ListReleasedConfigItems:input_type -> pbds.ListReleasedCIsReq
	31,  // 100: pbds.Data.CreateStrategySet:input_type -> pbds.CreateStrategySetReq
	32,  // 101: pbds.Data.ListStrategySets:input_type -> pbds.ListStrategySetsReq
	34,  // 102: pbds.Data.UpdateStrategySet:input_type -> pbds.UpdateStrategySetReq
	35,  // 103: pbds.Data.DeleteStrategySet:input_type -> pbds.DeleteStrategySetReq
	36,  // 104: pbds.Data.CreateStrategy:input_type -> pbds.CreateStrategyReq
	37,  // 105: pbds.Data.ListStrategies:input_type -> pbds.ListStrategiesReq
	39,  // 106: pbds.Data.UpdateStrategy:input_type -> pbds.UpdateStrategyReq
	40,  // 107: pbds.Data.DeleteStrategy:input_type -> pbds.DeleteStrategyReq
	41,  // 108: pbds.Data.CreateHook:input_type -> pbds.CreateHookReq
	42,  // 109: pbds.Data.ListHooks:input_type -> pbds.ListHooksReq
	44,  // 110: pbds.Data.UpdateHook:input_type -> pbds.UpdateHookReq
	45,  // 111: pbds.Data.DeleteHook:input_type -> pbds.DeleteHookReq
	46,  // 112: pbds.Data.CreateGroup:input_type -> pbds.CreateGroupReq
	47,  // 113: pbds.Data.ListGroups:input_type -> pbds.ListGroupsReq
	49,  // 114: pbds.Data.UpdateGroup:input_type -> pbds.UpdateGroupReq
	50,  // 115: pbds.Data.DeleteGroup:input_type -> pbds.DeleteGroupReq
	51,  // 116: pbds.Data.CountGroupsReleasedApps:input_type -> pbds.CountGroupsReleasedAppsReq
	53,  // 117: pbds.Data.ListGroupRleasesdApps:input_type -> pbds.ListGroupRleasesdAppsReq
	55,  // 118: pbds.Data.Publish:input_type -> pbds.PublishReq
	57,  // 119: pbds.Data.FinishPublish:input_type -> pbds.FinishPublishReq
	58,  // 120: pbds.Data.ListPublishedStrategyHistories:input_type -> pbds.ListPubStrategyHistoriesReq
	60,  // 121: pbds.Data.CreateCRInstance:input_type -> pbds.CreateCRInstanceReq
	61,  // 122: pbds.Data.ListCRInstances:input_type -> pbds.ListCRInstancesReq
	63,  // 123: pbds.Data.DeleteCRInstance:input_type -> pbds.DeleteCRInstanceReq
	64,  // 124: pbds.Data.ListInstances:input_type -> pbds.ListInstancesReq
	67,  // 125: pbds.Data.Ping:input_type -> pbds.PingMsg
	0,   // 126: pbds.Data.CreateApp:output_type -> pbds.CreateResp
	104, // 127: pbds.Data.UpdateApp:output_type -> pbbase.EmptyResp
	104, // 128: pbds.Data.DeleteApp:output_type -> pbbase.EmptyResp
	73,  // 129: pbds.Data.GetApp:output_type -> pbapp.App
	73,  // 130: pbds.Data.GetAppByID:output_type -> pbapp.App
	8,   // 131: pbds.Data.ListApps:output_type -> pbds.ListAppsResp
	8,   // 132: pbds.Data.ListAppsRest:output_type -> pbds.ListAppsResp
	0,   // 133: pbds.Data.CreateConfigItem:output_type -> pbds.CreateResp
	104, // 134: pbds.Data.UpdateConfigItem:output_type -> pbbase.EmptyResp
	104, // 135: pbds.Data.DeleteConfigItem:output_type -> pbbase.EmptyResp
	76,  // 136: pbds.Data.GetConfigItem:output_type -> pbci.ConfigItem
	14,  // 137: pbds.Data.ListConfigItems:output_type -> pbds.ListConfigItemsResp
	16,  // 138: pbds.Data.ListConfigItemCount:output_type -> pbds.ListConfigItemCountResp
	0,   // 139: pbds.Data.CreateContent:output_type -> pbds.CreateResp
	80,  // 140: pbds.Data.GetContent:output_type -> pbcontent.Content
	20,  // 141: pbds.Data.ListContents:output_type -> pbds.ListContentsResp
	0,   // 142: pbds.Data.CreateCommit:output_type -> pbds.CreateResp
	82,  // 143: pbds.Data.GetLatestCommit:output_type -> pbcommit.Commit
	24,  // 144: pbds.Data.ListCommits:output_type -> pbds.ListCommitsResp
	0,   // 145: pbds.Data.CreateRelease:output_type -> pbds.CreateResp
	27,  // 146: pbds.Data.ListReleases:output_type -> pbds.ListReleasesResp
	86,  // 147: pbds.Data.GetReleasedConfigItem:output_type -> pbrci.ReleasedConfigItem
	30,  // 148: pbds.Data.ListReleasedConfigItems:output_type -> pbds.ListReleasedCIsResp
	0,   // 149: pbds.Data.CreateStrategySet:output_type -> pbds.CreateResp
	33,  // 150: pbds.Data.ListStrategySets:output_type -> pbds.ListStrategySetsResp
	104, // 151: pbds.Data.UpdateStrategySet:output_type -> pbbase.EmptyResp
	104, // 152: pbds.Data.DeleteStrategySet:output_type -> pbbase.EmptyResp
	0,   // 153: pbds.Data.CreateStrategy:output_type -> pbds.CreateResp
	38,  // 154: pbds.Data.ListStrategies:output_type -> pbds.ListStrategiesResp
	104, // 155: pbds.Data.UpdateStrategy:output_type -> pbbase.EmptyResp
	104, // 156: pbds.Data.DeleteStrategy:output_type -> pbbase.EmptyResp
	0,   // 157: pbds.Data.CreateHook:output_type -> pbds.CreateResp
	43,  // 158: pbds.Data.ListHooks:output_type -> pbds.ListHooksResp
	104, // 159: pbds.Data.UpdateHook:output_type -> pbbase.EmptyResp
	104, // 160: pbds.Data.DeleteHook:output_type -> pbbase.EmptyResp
	0,   // 161: pbds.Data.CreateGroup:output_type -> pbds.CreateResp
	48,  // 162: pbds.Data.ListGroups:output_type -> pbds.ListGroupsResp
	104, // 163: pbds.Data.UpdateGroup:output_type -> pbbase.EmptyResp
	104, // 164: pbds.Data.DeleteGroup:output_type -> pbbase.EmptyResp
	52,  // 165: pbds.Data.CountGroupsReleasedApps:output_type -> pbds.CountGroupsReleasedAppsResp
	54,  // 166: pbds.Data.ListGroupRleasesdApps:output_type -> pbds.ListGroupRleasesdAppsResp
	56,  // 167: pbds.Data.Publish:output_type -> pbds.PublishResp
	104, // 168: pbds.Data.FinishPublish:output_type -> pbbase.EmptyResp
	59,  // 169: pbds.Data.ListPublishedStrategyHistories:output_type -> pbds.ListPubStrategyHistoriesResp
	0,   // 170: pbds.Data.CreateCRInstance:output_type -> pbds.CreateResp
	62,  // 171: pbds.Data.ListCRInstances:output_type -> pbds.ListCRInstancesResp
	104, // 172: pbds.Data.DeleteCRInstance:output_type -> pbbase.EmptyResp
	65,  // 173: pbds.Data.ListInstances:output_type -> pbds.ListInstancesResp
	67,  // 174: pbds.Data.Ping:output_type -> pbds.PingMsg
