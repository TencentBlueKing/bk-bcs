...
func (x *AppMeta) GetAppId() uint32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
var file_feed_server_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x69, 0x6e, 0x67, 0x52, 0x0a, 0x61, 0x70, 0x69, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x8a, 0x01, 0x0a, 0x12,
	...
	0x07, 0x61, 0x70, 0x70, 0x4d, 0x65, 0x74, 0x61, 0x22, 0xa0, 0x01, 0x0a, 0x07, 0x41, 0x70, 0x70,
	0x4d, 0x65, 0x74, 0x61, 0x12, 0x15, 0x0a, 0x06, 0x61, 0x70, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x61, 0x70, 0x70, 0x49, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x75,
	...
	0x49, 0x64, 0x12, 0x30, 0x0a, 0x0a, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x70, 0x62, 0x66, 0x73, 0x2e, 0x52, 0x65,
	0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x0a, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69,
	0x74, 0x6f, 0x72, 0x79, 0x12, 0x2d, 0x0a, 0x0a, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x6d, 0x65, 0x74,
	0x61, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x62, 0x66, 0x73, 0x2e,
	0x46, 0x69, 0x6c, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x52, 0x09, 0x66, 0x69, 0x6c, 0x65, 0x4d, 0x65,
	0x74, 0x61, 0x73, 0x22, 0x20, 0x0a, 0x0a, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72,
	...
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x32, 0x83, 0x02,
...
var file_feed_server_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_feed_server_proto_goTypes = []interface{}{
	...
	(*FileMeta)(nil),                   // 9: pbfs.FileMeta
	(*RepositorySpec)(nil),             // 10: pbfs.RepositorySpec
	(*FeedWatchMessage)(nil),           // 11: pbfs.FeedWatchMessage
	(*MessagingMeta)(nil),              // 12: pbfs.MessagingMeta
	(*MessagingResp)(nil),              // 13: pbfs.MessagingResp
	nil,                                // 14: pbfs.AppMeta.LabelsEntry
	(*base.Versioning)(nil),            // 15: pbbase.Versioning
	(*commit.CommitSpec)(nil),          // 16: pbcommit.CommitSpec
	(*config_item.ConfigItemSpec)(nil), // 17: pbci.ConfigItemSpec
}
var file_feed_server_proto_depIdxs = []int32{
	15, // 0: pbfs.HandshakeMessage.api_version:type_name -> pbbase.Versioning
	1,  // 1: pbfs.HandshakeMessage.spec:type_name -> pbfs.SidecarSpec
	15, // 2: pbfs.SidecarSpec.version:type_name -> pbbase.Versioning
	15, // 3: pbfs.HandshakeResp.api_version:type_name -> pbbase.Versioning
	15, // 4: pbfs.SideWatchMeta.api_version:type_name -> pbbase.Versioning
	15, // 5: pbfs.PullAppFileMetaReq.api_version:type_name -> pbbase.Versioning
	6,  // 6: pbfs.PullAppFileMetaReq.app_meta:type_name -> pbfs.AppMeta
	14, // 7: pbfs.AppMeta.labels:type_name -> pbfs.AppMeta.LabelsEntry
	8,  // 8: pbfs.PullAppFileMetaResp.repository:type_name -> pbfs.Repository
	9,  // 9: pbfs.PullAppFileMetaResp.file_metas:type_name -> pbfs.FileMeta
	16, // 10: pbfs.FileMeta.commit_spec:type_name -> pbcommit.CommitSpec
	17, // 11: pbfs.FileMeta.config_item_spec:type_name -> pbci.ConfigItemSpec
	10, // 12: pbfs.FileMeta.repository_spec:type_name -> pbfs.RepositorySpec
	15, // 13: pbfs.FeedWatchMessage.api_version:type_name -> pbbase.Versioning
	15, // 14: pbfs.MessagingMeta.api_version:type_name -> pbbase.Versioning
	0,  // 15: pbfs.Upstream.Handshake:input_type -> pbfs.HandshakeMessage
	4,  // 16: pbfs.Upstream.Watch:input_type -> pbfs.SideWatchMeta
	12, // 17: pbfs.Upstream.Messaging:input_type -> pbfs.MessagingMeta
	5,  // 18: pbfs.Upstream.PullAppFileMeta:input_type -> pbfs.PullAppFileMetaReq
	3,  // 19: pbfs.Upstream.Handshake:output_type -> pbfs.HandshakeResp
	11, // 20: pbfs.Upstream.Watch:output_type -> pbfs.FeedWatchMessage
	13, // 21: pbfs.Upstream.Messaging:output_type -> pbfs.MessagingResp
	7,  // 22: pbfs.Upstream.PullAppFileMeta:output_type -> pbfs.PullAppFileMetaResp
