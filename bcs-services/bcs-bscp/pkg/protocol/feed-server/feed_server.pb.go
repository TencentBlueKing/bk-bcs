...
var file_feed_server_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x32, 0xf5, 0x03, 0x0a, 0x08, 0x55, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61,
...
var file_feed_server_proto_goTypes = []interface{}{
	...
	(*hook.HookSpec)(nil),                    // 28: pbhook.HookSpec
	(*base.Revision)(nil),                    // 29: pbbase.Revision
...
var file_feed_server_proto_depIdxs = []int32{
	...
	24, // 12: pbfs.PullAppFileMetaReq.api_version:type_name -> pbbase.Versioning
	...
	28, // 16: pbfs.PullAppFileMetaResp.pre_hook:type_name -> pbhook.HookSpec
	28, // 17: pbfs.PullAppFileMetaResp.post_hook:type_name -> pbhook.HookSpec
	24, // 18: pbfs.GetDownloadURLReq.api_version:type_name -> pbbase.Versioning
	10, // 19: pbfs.GetDownloadURLReq.file_meta:type_name -> pbfs.FileMeta
	29, // 20: pbfs.App.revision:type_name -> pbbase.Revision
	...
	29, // 24: pbfs.KvMeta.revision:type_name -> pbbase.Revision
	30, // 25: pbfs.KvMeta.kv_attachment:type_name -> pbkv.KvAttachment
	7,  // 26: pbfs.GetKvValueReq.app_meta:type_name -> pbfs.AppMeta
	1,  // 27: pbfs.Upstream.Handshake:input_type -> pbfs.HandshakeMessage
	3,  // 28: pbfs.Upstream.Messaging:input_type -> pbfs.MessagingMeta
	5,  // 29: pbfs.Upstream.Watch:input_type -> pbfs.SideWatchMeta
	11, // 30: pbfs.Upstream.PullAppFileMeta:input_type -> pbfs.PullAppFileMetaReq
	13, // 31: pbfs.Upstream.GetDownloadURL:input_type -> pbfs.GetDownloadURLReq
	18, // 32: pbfs.Upstream.PullKvMeta:input_type -> pbfs.PullKvMetaReq
	21, // 33: pbfs.Upstream.GetKvValue:input_type -> pbfs.GetKvValueReq
	16, // 34: pbfs.Upstream.ListApps:input_type -> pbfs.ListAppsReq
	2,  // 35: pbfs.Upstream.Handshake:output_type -> pbfs.HandshakeResp
	4,  // 36: pbfs.Upstream.Messaging:output_type -> pbfs.MessagingResp
	6,  // 37: pbfs.Upstream.Watch:output_type -> pbfs.FeedWatchMessage
	12, // 38: pbfs.Upstream.PullAppFileMeta:output_type -> pbfs.PullAppFileMetaResp
	14, // 39: pbfs.Upstream.GetDownloadURL:output_type -> pbfs.GetDownloadURLResp
	19, // 40: pbfs.Upstream.PullKvMeta:output_type -> pbfs.PullKvMetaResp
	22, // 41: pbfs.Upstream.GetKvValue:output_type -> pbfs.GetKvValueResp
	17, // 42: pbfs.Upstream.ListApps:output_type -> pbfs.ListAppsResp
