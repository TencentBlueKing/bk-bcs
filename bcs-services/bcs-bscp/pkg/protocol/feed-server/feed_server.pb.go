...
var file_feed_server_proto_rawDesc = []byte{
	...
	0x6f, 0x6f, 0x6b, 0x2f, 0x68, 0x6f, 0x6f, 0x6b, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x37,
	...
	0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6e, 0x0a, 0x10, 0x48, 0x61, 0x6e, 0x64, 0x73,
	...
	0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x32, 0xca, 0x02, 0x0a, 0x08, 0x55, 0x70, 0x73, 0x74, 0x72,
...
var file_feed_server_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_feed_server_proto_goTypes = []interface{}{
	...
	nil,                                      // 16: pbfs.AppMeta.LabelsEntry
	(*base.Versioning)(nil),                  // 17: pbbase.Versioning
	(*hook.HookSpec)(nil),                    // 18: pbhook.HookSpec
	(*commit.CommitSpec)(nil),                // 19: pbcommit.CommitSpec
	(*config_item.ConfigItemSpec)(nil),       // 20: pbci.ConfigItemSpec
	(*config_item.ConfigItemAttachment)(nil), // 21: pbci.ConfigItemAttachment
}
var file_feed_server_proto_depIdxs = []int32{
	17, // 0: pbfs.HandshakeMessage.api_version:type_name -> pbbase.Versioning
	1,  // 1: pbfs.HandshakeMessage.spec:type_name -> pbfs.SidecarSpec
	17, // 2: pbfs.SidecarSpec.version:type_name -> pbbase.Versioning
	17, // 3: pbfs.HandshakeResp.api_version:type_name -> pbbase.Versioning
	17, // 4: pbfs.SideWatchMeta.api_version:type_name -> pbbase.Versioning
	17, // 5: pbfs.PullAppFileMetaReq.api_version:type_name -> pbbase.Versioning
	6,  // 6: pbfs.PullAppFileMetaReq.app_meta:type_name -> pbfs.AppMeta
	16, // 7: pbfs.AppMeta.labels:type_name -> pbfs.AppMeta.LabelsEntry
	...
	18, // 10: pbfs.PullAppFileMetaResp.pre_hook:type_name -> pbhook.HookSpec
	18, // 11: pbfs.PullAppFileMetaResp.post_hook:type_name -> pbhook.HookSpec
	17, // 12: pbfs.GetDownloadURLReq.api_version:type_name -> pbbase.Versioning
	11, // 13: pbfs.GetDownloadURLReq.file_meta:type_name -> pbfs.FileMeta
	19, // 14: pbfs.FileMeta.commit_spec:type_name -> pbcommit.CommitSpec
	20, // 15: pbfs.FileMeta.config_item_spec:type_name -> pbci.ConfigItemSpec
	21, // 16: pbfs.FileMeta.config_item_attachment:type_name -> pbci.ConfigItemAttachment
	12, // 17: pbfs.FileMeta.repository_spec:type_name -> pbfs.RepositorySpec
	17, // 18: pbfs.FeedWatchMessage.api_version:type_name -> pbbase.Versioning
	17, // 19: pbfs.MessagingMeta.api_version:type_name -> pbbase.Versioning
	0,  // 20: pbfs.Upstream.Handshake:input_type -> pbfs.HandshakeMessage
	4,  // 21: pbfs.Upstream.Watch:input_type -> pbfs.SideWatchMeta
	14, // 22: pbfs.Upstream.Messaging:input_type -> pbfs.MessagingMeta
	5,  // 23: pbfs.Upstream.PullAppFileMeta:input_type -> pbfs.PullAppFileMetaReq
	8,  // 24: pbfs.Upstream.GetDownloadURL:input_type -> pbfs.GetDownloadURLReq
	3,  // 25: pbfs.Upstream.Handshake:output_type -> pbfs.HandshakeResp
	13, // 26: pbfs.Upstream.Watch:output_type -> pbfs.FeedWatchMessage
	15, // 27: pbfs.Upstream.Messaging:output_type -> pbfs.MessagingResp
	7,  // 28: pbfs.Upstream.PullAppFileMeta:output_type -> pbfs.PullAppFileMetaResp
	9,  // 29: pbfs.Upstream.GetDownloadURL:output_type -> pbfs.GetDownloadURLResp
