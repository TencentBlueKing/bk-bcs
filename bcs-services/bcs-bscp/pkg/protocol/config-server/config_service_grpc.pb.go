...
const (
	...
	Config_ListClientMetrics_FullMethodName                 = "/pbcs.Config/ListClientMetrics"
	Config_ListClientMetricEvents_FullMethodName            = "/pbcs.Config/ListClientMetricEvents"
...
func (c *configClient) ListClientMetrics(ctx context.Context, in *ListClientMetricsReq, opts ...grpc.CallOption) (*ListClientMetricsResp, error) {
	out := new(ListClientMetricsResp)
	err := c.cc.Invoke(ctx, Config_ListClientMetrics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *configClient) ListClientMetricEvents(ctx context.Context, in *ListClientMetricEventsReq, opts ...grpc.CallOption) (*ListClientMetricEventsResp, error) {
	out := new(ListClientMetricEventsResp)
	err := c.cc.Invoke(ctx, Config_ListClientMetricEvents_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedConfigServer) ListClientMetrics(context.Context, *ListClientMetricsReq) (*ListClientMetricsResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListClientMetrics not implemented")
}
func (UnimplementedConfigServer) ListClientMetricEvents(context.Context, *ListClientMetricEventsReq) (*ListClientMetricEventsResp, error) {
...
func _Config_ListClientMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListClientMetricsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConfigServer).ListClientMetrics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Config_ListClientMetrics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigServer).ListClientMetrics(ctx, req.(*ListClientMetricsReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Config_ListClientMetricEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListClientMetricEventsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConfigServer).ListClientMetricEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Config_ListClientMetricEvents_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigServer).ListClientMetricEvents(ctx, req.(*ListClientMetricEventsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Config_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Config_ListClientMetrics_Handler,
		},
		{
			MethodName: "ListClientMetricEvents",
			Handler:    _Config_ListClientMetricEvents_Handler,
		},
		{
