...
var file_config_service_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x62, 0x69, 0x7a, 0x49, 0x64, 0x22, 0xa8, 0x02, 0x0a,
	...
	0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x1a, 0xcd, 0x01, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74,
	...
	0x41, 0x70, 0x70, 0x73, 0x4e, 0x75, 0x6d, 0x22, 0x97, 0x01, 0x0a, 0x0a, 0x50, 0x75, 0x62, 0x6c,
	...
	0x75, 0x70, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x06, 0x67, 0x72, 0x6f, 0x75, 0x70,
	...
	0x63, 0x65, 0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x32, 0xce, 0x2f, 0x0a, 0x06,
	...
	0x6e, 0x66, 0x69, 0x67, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x12, 0xb2, 0x01, 0x0a, 0x0d, 0x43,
	...
	0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x12, 0xa1, 0x01, 0x0a, 0x07, 0x50, 0x75, 0x62, 0x6c, 0x69,
...
var file_config_service_proto_goTypes = []interface{}{
	...
	(*strategy.PublishedStrategyHistory)(nil),   // 95: pbstrategy.PublishedStrategyHistory
	(*instance.CurrentReleasedInstance)(nil),    // 96: pbinstance.CurrentReleasedInstance
}
var file_config_service_proto_depIdxs = []int32{
	...
	83, // 24: pbcs.ListHooksReq.filter:type_name -> google.protobuf.Struct
	84, // 25: pbcs.ListHooksReq.page:type_name -> pbbase.BasePage
	94, // 26: pbcs.ListHooksResp.details:type_name -> pbhook.Hook
	83, // 27: pbcs.CreateGroupReq.selector:type_name -> google.protobuf.Struct
	83, // 28: pbcs.UpdateGroupReq.selector:type_name -> google.protobuf.Struct
	82, // 29: pbcs.ListAllGroupsResp.details:type_name -> pbcs.ListAllGroupsResp.ListAllGroupsData
	83, // 30: pbcs.ListPubStrategyHistoriesReq.filter:type_name -> google.protobuf.Struct
	84, // 31: pbcs.ListPubStrategyHistoriesReq.page:type_name -> pbbase.BasePage
	95, // 32: pbcs.ListPubStrategyHistoriesResp.details:type_name -> pbstrategy.PublishedStrategyHistory
	83, // 33: pbcs.ListPublishedInstanceReq.filter:type_name -> google.protobuf.Struct
	84, // 34: pbcs.ListPublishedInstanceReq.page:type_name -> pbbase.BasePage
	96, // 35: pbcs.ListPublishedInstanceResp.details:type_name -> pbinstance.CurrentReleasedInstance
	83, // 36: pbcs.ListAllGroupsResp.ListAllGroupsData.selector:type_name -> google.protobuf.Struct
	...
	67, // 72: pbcs.Config.ListAllGroups:input_type -> pbcs.ListAllGroupsReq
	69, // 73: pbcs.Config.Publish:input_type -> pbcs.PublishReq
	71, // 74: pbcs.Config.FinishPublish:input_type -> pbcs.FinishPublishReq
	73, // 75: pbcs.Config.ListPublishedStrategyHistories:input_type -> pbcs.ListPubStrategyHistoriesReq
	75, // 76: pbcs.Config.PublishInstance:input_type -> pbcs.PublishInstanceReq
	77, // 77: pbcs.Config.DeletePublishedInstance:input_type -> pbcs.DeletePublishedInstanceReq
	79, // 78: pbcs.Config.ListPublishedInstance:input_type -> pbcs.ListPublishedInstanceReq
	1,  // 79: pbcs.Config.ListBiz:output_type -> pbcs.ListBizResp
	3,  // 80: pbcs.Config.CreateApp:output_type -> pbcs.CreateAppResp
	5,  // 81: pbcs.Config.UpdateApp:output_type -> pbcs.UpdateAppResp
	7,  // 82: pbcs.Config.DeleteApp:output_type -> pbcs.DeleteAppResp
	85, // 83: pbcs.Config.GetApp:output_type -> pbapp.App
	12, // 84: pbcs.Config.ListApps:output_type -> pbcs.ListAppsResp
	12, // 85: pbcs.Config.ListAppsRest:output_type -> pbcs.ListAppsResp
	12, // 86: pbcs.Config.ListAppsBySpaceRest:output_type -> pbcs.ListAppsResp
	14, // 87: pbcs.Config.CreateConfigItem:output_type -> pbcs.CreateConfigItemResp
	16, // 88: pbcs.Config.UpdateConfigItem:output_type -> pbcs.UpdateConfigItemResp
	18, // 89: pbcs.Config.DeleteConfigItem:output_type -> pbcs.DeleteConfigItemResp
	20, // 90: pbcs.Config.GetConfigItem:output_type -> pbcs.GetConfigItemResp
	22, // 91: pbcs.Config.ListConfigItems:output_type -> pbcs.ListConfigItemsResp
	24, // 92: pbcs.Config.CreateContent:output_type -> pbcs.CreateContentResp
	26, // 93: pbcs.Config.ListContents:output_type -> pbcs.ListContentsResp
	28, // 94: pbcs.Config.CreateCommit:output_type -> pbcs.CreateCommitResp
	30, // 95: pbcs.Config.ListCommits:output_type -> pbcs.ListCommitsResp
	32, // 96: pbcs.Config.CreateRelease:output_type -> pbcs.CreateReleaseResp
	34, // 97: pbcs.Config.ListReleases:output_type -> pbcs.ListReleasesResp
	36, // 98: pbcs.Config.ListReleasedConfigItems:output_type -> pbcs.ListReleasedConfigItemsResp
	38, // 99: pbcs.Config.CreateStrategySet:output_type -> pbcs.CreateStrategySetResp
	40, // 100: pbcs.Config.UpdateStrategySet:output_type -> pbcs.UpdateStrategySetResp
	42, // 101: pbcs.Config.DeleteStrategySet:output_type -> pbcs.DeleteStrategySetResp
	44, // 102: pbcs.Config.ListStrategySets:output_type -> pbcs.ListStrategySetsResp
	46, // 103: pbcs.Config.CreateStrategy:output_type -> pbcs.CreateStrategyResp
	48, // 104: pbcs.Config.UpdateStrategy:output_type -> pbcs.UpdateStrategyResp
	50, // 105: pbcs.Config.DeleteStrategy:output_type -> pbcs.DeleteStrategyResp
	52, // 106: pbcs.Config.ListStrategies:output_type -> pbcs.ListStrategiesResp
	54, // 107: pbcs.Config.CreateHook:output_type -> pbcs.CreateHookResp
	58, // 108: pbcs.Config.DeleteHook:output_type -> pbcs.DeleteHookResp
	56, // 109: pbcs.Config.UpdateHook:output_type -> pbcs.UpdateHookResp
	60, // 110: pbcs.Config.ListHooks:output_type -> pbcs.ListHooksResp
	62, // 111: pbcs.Config.CreateGroup:output_type -> pbcs.CreateGroupResp
	66, // 112: pbcs.Config.DeleteGroup:output_type -> pbcs.DeleteGroupResp
	64, // 113: pbcs.Config.UpdateGroup:output_type -> pbcs.UpdateGroupResp
	68, // 114: pbcs.Config.ListAllGroups:output_type -> pbcs.ListAllGroupsResp
	70, // 115: pbcs.Config.Publish:output_type -> pbcs.PublishResp
	72, // 116: pbcs.Config.FinishPublish:output_type -> pbcs.FinishPublishResp
	74, // 117: pbcs.Config.ListPublishedStrategyHistories:output_type -> pbcs.ListPubStrategyHistoriesResp
	76, // 118: pbcs.Config.PublishInstance:output_type -> pbcs.PublishInstanceResp
	78, // 119: pbcs.Config.DeletePublishedInstance:output_type -> pbcs.DeletePublishedInstanceResp
	80, // 120: pbcs.Config.ListPublishedInstance:output_type -> pbcs.ListPublishedInstanceResp
