...
var file_config_service_proto_rawDesc = []byte{
	...
	0x32, 0xa7, 0x40, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x6e, 0x0a, 0x09, 0x43,
...
var file_config_service_proto_msgTypes = make([]protoimpl.MessageInfo, 115)
var file_config_service_proto_goTypes = []interface{}{
	...
	(*FinishPublishReq)(nil),                                    // 100: pbcs.FinishPublishReq
	(*FinishPublishResp)(nil),                                   // 101: pbcs.FinishPublishResp
	(*ListPubStrategyHistoriesReq)(nil),                         // 102: pbcs.ListPubStrategyHistoriesReq
	(*ListPubStrategyHistoriesResp)(nil),                        // 103: pbcs.ListPubStrategyHistoriesResp
	(*PublishInstanceReq)(nil),                                  // 104: pbcs.PublishInstanceReq
	(*PublishInstanceResp)(nil),                                 // 105: pbcs.PublishInstanceResp
	(*DeletePublishedInstanceReq)(nil),                          // 106: pbcs.DeletePublishedInstanceReq
	(*DeletePublishedInstanceResp)(nil),                         // 107: pbcs.DeletePublishedInstanceResp
	(*ListPublishedInstanceReq)(nil),                            // 108: pbcs.ListPublishedInstanceReq
	(*ListPublishedInstanceResp)(nil),                           // 109: pbcs.ListPublishedInstanceResp
	(*BatchUpsertConfigItemsReq_ConfigItem)(nil),                // 110: pbcs.BatchUpsertConfigItemsReq.ConfigItem
	(*ListAllGroupsResp_ListAllGroupsData)(nil),                 // 111: pbcs.ListAllGroupsResp.ListAllGroupsData
	(*ListAllGroupsResp_ListAllGroupsData_BindApp)(nil),         // 112: pbcs.ListAllGroupsResp.ListAllGroupsData.BindApp
	(*ListAppGroupsResp_ListAppGroupsData)(nil),                 // 113: pbcs.ListAppGroupsResp.ListAppGroupsData
	(*ListGroupReleasedAppsResp_ListGroupReleasedAppsData)(nil), // 114: pbcs.ListGroupReleasedAppsResp.ListGroupReleasedAppsData
	(*credential_scope.UpdateScopeSpec)(nil),                    // 115: pbcrs.UpdateScopeSpec
	(*credential_scope.CredentialScopeList)(nil),                // 116: pbcrs.CredentialScopeList
	(*credential.CredentialList)(nil),                           // 117: pbcredential.CredentialList
	(*structpb.Struct)(nil),                                     // 118: google.protobuf.Struct
	(*base.BasePage)(nil),                                       // 119: pbbase.BasePage
	(*app.App)(nil),                                             // 120: pbapp.App
	(*config_item.ConfigItem)(nil),                              // 121: pbci.ConfigItem
	...
	(*strategy.Strategy)(nil),                                   // 129: pbstrategy.Strategy
...
var file_config_service_proto_depIdxs = []int32{
	115, // 0: pbcs.UpdateCredentialScopeReq.alter_scope:type_name -> pbcrs.UpdateScopeSpec
	116, // 1: pbcs.ListCredentialScopesResp.details:type_name -> pbcrs.CredentialScopeList
	117, // 2: pbcs.ListCredentialsResp.details:type_name -> pbcredential.CredentialList
	118, // 3: pbcs.ListAppsReq.filter:type_name -> google.protobuf.Struct
	119, // 4: pbcs.ListAppsReq.page:type_name -> pbbase.BasePage
	120, // 5: pbcs.ListAppsResp.details:type_name -> pbapp.App
	110, // 6: pbcs.BatchUpsertConfigItemsReq.items:type_name -> pbcs.BatchUpsertConfigItemsReq.ConfigItem
	121, // 7: pbcs.GetConfigItemResp.config_item:type_name -> pbci.ConfigItem
	122, // 8: pbcs.GetConfigItemResp.content:type_name -> pbcontent.ContentSpec
	121, // 9: pbcs.ListConfigItemsResp.details:type_name -> pbci.ConfigItem
	123, // 10: pbcs.ListConfigItemCountResp.details:type_name -> pbci.ListConfigItemCounts
	118, // 11: pbcs.ListContentsReq.filter:type_name -> google.protobuf.Struct
	119, // 12: pbcs.ListContentsReq.page:type_name -> pbbase.BasePage
	124, // 13: pbcs.ListContentsResp.details:type_name -> pbcontent.Content
	118, // 14: pbcs.ListCommitsReq.filter:type_name -> google.protobuf.Struct
	119, // 15: pbcs.ListCommitsReq.page:type_name -> pbbase.BasePage
	125, // 16: pbcs.ListCommitsResp.details:type_name -> pbcommit.Commit
	126, // 17: pbcs.ListReleasesResp.details:type_name -> pbrelease.Release
	119, // 18: pbcs.ListReleasedConfigItemsReq.page:type_name -> pbbase.BasePage
	127, // 19: pbcs.ListReleasedConfigItemsResp.details:type_name -> pbrci.ReleasedConfigItem
	118, // 20: pbcs.ListStrategySetsReq.filter:type_name -> google.protobuf.Struct
	119, // 21: pbcs.ListStrategySetsReq.page:type_name -> pbbase.BasePage
	128, // 22: pbcs.ListStrategySetsResp.details:type_name -> pbss.StrategySet
	118, // 23: pbcs.ListStrategiesReq.filter:type_name -> google.protobuf.Struct
	119, // 24: pbcs.ListStrategiesReq.page:type_name -> pbbase.BasePage
	129, // 25: pbcs.ListStrategiesResp.details:type_name -> pbstrategy.Strategy
	118, // 26: pbcs.ListHooksReq.filter:type_name -> google.protobuf.Struct
	119, // 27: pbcs.ListHooksReq.page:type_name -> pbbase.BasePage
	130, // 28: pbcs.ListHooksResp.details:type_name -> pbhook.Hook
	131, // 29: pbcs.ListTemplateSpacesResp.details:type_name -> pbts.TemplateSpace
	118, // 30: pbcs.CreateGroupReq.selector:type_name -> google.protobuf.Struct
	118, // 31: pbcs.UpdateGroupReq.selector:type_name -> google.protobuf.Struct
	111, // 32: pbcs.ListAllGroupsResp.details:type_name -> pbcs.ListAllGroupsResp.ListAllGroupsData
	113, // 33: pbcs.ListAppGroupsResp.details:type_name -> pbcs.ListAppGroupsResp.ListAppGroupsData
	114, // 34: pbcs.ListGroupReleasedAppsResp.details:type_name -> pbcs.ListGroupReleasedAppsResp.ListGroupReleasedAppsData
	118, // 35: pbcs.ListPubStrategyHistoriesReq.filter:type_name -> google.protobuf.Struct
	119, // 36: pbcs.ListPubStrategyHistoriesReq.page:type_name -> pbbase.BasePage
	132, // 37: pbcs.ListPubStrategyHistoriesResp.details:type_name -> pbstrategy.PublishedStrategyHistory
	118, // 38: pbcs.ListPublishedInstanceReq.filter:type_name -> google.protobuf.Struct
	119, // 39: pbcs.ListPublishedInstanceReq.page:type_name -> pbbase.BasePage
	133, // 40: pbcs.ListPublishedInstanceResp.details:type_name -> pbinstance.CurrentReleasedInstance
	112, // 41: pbcs.ListAllGroupsResp.ListAllGroupsData.bind_apps:type_name -> pbcs.ListAllGroupsResp.ListAllGroupsData.BindApp
	118, // 42: pbcs.ListAllGroupsResp.ListAllGroupsData.selector:type_name -> google.protobuf.Struct
	118, // 43: pbcs.ListAppGroupsResp.ListAppGroupsData.old_selector:type_name -> google.protobuf.Struct
	118, // 44: pbcs.ListAppGroupsResp.ListAppGroupsData.new_selector:type_name -> google.protobuf.Struct
	...
	100, // 90: pbcs.Config.FinishPublish:input_type -> pbcs.FinishPublishReq
	102, // 91: pbcs.Config.ListPublishedStrategyHistories:input_type -> pbcs.ListPubStrategyHistoriesReq
	104, // 92: pbcs.Config.PublishInstance:input_type -> pbcs.PublishInstanceReq
	106, // 93: pbcs.Config.DeletePublishedInstance:input_type -> pbcs.DeletePublishedInstanceReq
	108, // 94: pbcs.Config.ListPublishedInstance:input_type -> pbcs.ListPublishedInstanceReq
	...
	120, // 104: pbcs.Config.GetApp:output_type -> pbapp.App
	120, // 105: pbcs.Config.GetAppByName:output_type -> pbapp.App
	25,  // 106: pbcs.Config.ListApps:output_type -> pbcs.ListAppsResp
	25,  // 107: pbcs.Config.ListAppsRest:output_type -> pbcs.ListAppsResp
	25,  // 108: pbcs.Config.ListAppsBySpaceRest:output_type -> pbcs.ListAppsResp
	29,  // 109: pbcs.Config.CreateConfigItem:output_type -> pbcs.CreateConfigItemResp
	28,  // 110: pbcs.Config.BatchUpsertConfigItems:output_type -> pbcs.BatchUpsertConfigItemsResp
	31,  // 111: pbcs.Config.UpdateConfigItem:output_type -> pbcs.UpdateConfigItemResp
	33,  // 112: pbcs.Config.DeleteConfigItem:output_type -> pbcs.DeleteConfigItemResp
	35,  // 113: pbcs.Config.GetConfigItem:output_type -> pbcs.GetConfigItemResp
	37,  // 114: pbcs.Config.ListConfigItems:output_type -> pbcs.ListConfigItemsResp
	39,  // 115: pbcs.Config.ListConfigItemCount:output_type -> pbcs.ListConfigItemCountResp
	41,  // 116: pbcs.Config.CreateContent:output_type -> pbcs.CreateContentResp
	43,  // 117: pbcs.Config.ListContents:output_type -> pbcs.ListContentsResp
	45,  // 118: pbcs.Config.CreateCommit:output_type -> pbcs.CreateCommitResp
	47,  // 119: pbcs.Config.ListCommits:output_type -> pbcs.ListCommitsResp
	49,  // 120: pbcs.Config.CreateRelease:output_type -> pbcs.CreateReleaseResp
	51,  // 121: pbcs.Config.ListReleases:output_type -> pbcs.ListReleasesResp
	53,  // 122: pbcs.Config.ListReleasedConfigItems:output_type -> pbcs.ListReleasedConfigItemsResp
	55,  // 123: pbcs.Config.CreateStrategySet:output_type -> pbcs.CreateStrategySetResp
	57,  // 124: pbcs.Config.UpdateStrategySet:output_type -> pbcs.UpdateStrategySetResp
	59,  // 125: pbcs.Config.DeleteStrategySet:output_type -> pbcs.DeleteStrategySetResp
	61,  // 126: pbcs.Config.ListStrategySets:output_type -> pbcs.ListStrategySetsResp
	63,  // 127: pbcs.Config.CreateStrategy:output_type -> pbcs.CreateStrategyResp
	65,  // 128: pbcs.Config.UpdateStrategy:output_type -> pbcs.UpdateStrategyResp
	67,  // 129: pbcs.Config.DeleteStrategy:output_type -> pbcs.DeleteStrategyResp
	69,  // 130: pbcs.Config.ListStrategies:output_type -> pbcs.ListStrategiesResp
	71,  // 131: pbcs.Config.CreateHook:output_type -> pbcs.CreateHookResp
	75,  // 132: pbcs.Config.DeleteHook:output_type -> pbcs.DeleteHookResp
	73,  // 133: pbcs.Config.UpdateHook:output_type -> pbcs.UpdateHookResp
	77,  // 134: pbcs.Config.ListHooks:output_type -> pbcs.ListHooksResp
	79,  // 135: pbcs.Config.CreateTemplateSpace:output_type -> pbcs.CreateTemplateSpaceResp
	83,  // 136: pbcs.Config.DeleteTemplateSpace:output_type -> pbcs.DeleteTemplateSpaceResp
	81,  // 137: pbcs.Config.UpdateTemplateSpace:output_type -> pbcs.UpdateTemplateSpaceResp
	85,  // 138: pbcs.Config.ListTemplateSpaces:output_type -> pbcs.ListTemplateSpacesResp
	87,  // 139: pbcs.Config.CreateGroup:output_type -> pbcs.CreateGroupResp
	91,  // 140: pbcs.Config.DeleteGroup:output_type -> pbcs.DeleteGroupResp
	89,  // 141: pbcs.Config.UpdateGroup:output_type -> pbcs.UpdateGroupResp
	93,  // 142: pbcs.Config.ListAllGroups:output_type -> pbcs.ListAllGroupsResp
	95,  // 143: pbcs.Config.ListAppGroups:output_type -> pbcs.ListAppGroupsResp
	97,  // 144: pbcs.Config.ListGroupReleasedApps:output_type -> pbcs.ListGroupReleasedAppsResp
	99,  // 145: pbcs.Config.Publish:output_type -> pbcs.PublishResp
	101, // 146: pbcs.Config.FinishPublish:output_type -> pbcs.FinishPublishResp
	103, // 147: pbcs.Config.ListPublishedStrategyHistories:output_type -> pbcs.ListPubStrategyHistoriesResp
	105, // 148: pbcs.Config.PublishInstance:output_type -> pbcs.PublishInstanceResp
	107, // 149: pbcs.Config.DeletePublishedInstance:output_type -> pbcs.DeletePublishedInstanceResp
	109, // 150: pbcs.Config.ListPublishedInstance:output_type -> pbcs.ListPublishedInstanceResp
	13,  // 151: pbcs.Config.CreateCredentials:output_type -> pbcs.CreateCredentialResp
	11,  // 152: pbcs.Config.ListCredentials:output_type -> pbcs.ListCredentialsResp
	7,   // 153: pbcs.Config.DeleteCredential:output_type -> pbcs.DeleteCredentialsResp
	9,   // 154: pbcs.Config.UpdateCredential:output_type -> pbcs.UpdateCredentialsResp
	3,   // 155: pbcs.Config.ListCredentialScopes:output_type -> pbcs.ListCredentialScopesResp
	1,   // 156: pbcs.Config.UpdateCredentialScope:output_type -> pbcs.UpdateCredentialScopeResp
