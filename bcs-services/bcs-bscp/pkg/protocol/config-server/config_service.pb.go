...
func (*ListAllGroupsResp_ListAllGroupsData_BindApp) Descriptor() ([]byte, []int) {
	return file_config_service_proto_rawDescGZIP(), []int{82, 0, 0}
}
...
var file_config_service_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x32, 0xc6, 0x39, 0x0a, 0x06, 0x43,
	...
	0x7a, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0x69, 0x0a, 0x08, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x70, 0x70,
	...
	0x01, 0x2a, 0x12, 0x69, 0x0a, 0x0b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x47, 0x72, 0x6f, 0x75,
	...
	0x7d, 0x2f, 0x62, 0x69, 0x7a, 0x5f, 0x69, 0x64, 0x2f, 0x7b, 0x62, 0x69, 0x7a, 0x5f, 0x69, 0x64,
	0x7d, 0x3a, 0x01, 0x2a, 0x12, 0xab, 0x01, 0x0a, 0x0d, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x50,
...
var file_config_service_proto_msgTypes = make([]protoimpl.MessageInfo, 103)
var file_config_service_proto_goTypes = []interface{}{
	...
	(*ListAllGroupsResp_ListAllGroupsData_BindApp)(nil),         // 100: pbcs.ListAllGroupsResp.ListAllGroupsData.BindApp
	(*ListAppGroupsResp_ListAppGroupsData)(nil),                 // 101: pbcs.ListAppGroupsResp.ListAppGroupsData
	(*ListGroupReleasedAppsResp_ListGroupReleasedAppsData)(nil), // 102: pbcs.ListGroupReleasedAppsResp.ListGroupReleasedAppsData
	(*credential_scope.UpdateScopeSpec)(nil),                    // 103: pbcrs.UpdateScopeSpec
	(*credential_scope.CredentialScopeList)(nil),                // 104: pbcrs.CredentialScopeList
	(*credential.CredentialList)(nil),                           // 105: pbcredential.CredentialList
	(*structpb.Struct)(nil),                                     // 106: google.protobuf.Struct
	(*base.BasePage)(nil),                                       // 107: pbbase.BasePage
	(*app.App)(nil),                                             // 108: pbapp.App
	(*config_item.ConfigItem)(nil),                              // 109: pbci.ConfigItem
	(*content.ContentSpec)(nil),                                 // 110: pbcontent.ContentSpec
	(*config_item.ListConfigItemCounts)(nil),                    // 111: pbci.ListConfigItemCounts
	(*content.Content)(nil),                                     // 112: pbcontent.Content
	...
	(*strategy.Strategy)(nil),                                   // 117: pbstrategy.Strategy
	(*hook.Hook)(nil),                                           // 118: pbhook.Hook
	(*strategy.PublishedStrategyHistory)(nil),                   // 119: pbstrategy.PublishedStrategyHistory
	(*instance.CurrentReleasedInstance)(nil),                    // 120: pbinstance.CurrentReleasedInstance
}
var file_config_service_proto_depIdxs = []int32{
	103, // 0: pbcs.UpdateCredentialScopeReq.alter_scope:type_name -> pbcrs.UpdateScopeSpec
	104, // 1: pbcs.ListCredentialScopesResp.details:type_name -> pbcrs.CredentialScopeList
	105, // 2: pbcs.ListCredentialsResp.details:type_name -> pbcredential.CredentialList
	106, // 3: pbcs.ListAppsReq.filter:type_name -> google.protobuf.Struct
	107, // 4: pbcs.ListAppsReq.page:type_name -> pbbase.BasePage
	108, // 5: pbcs.ListAppsResp.details:type_name -> pbapp.App
	109, // 6: pbcs.GetConfigItemResp.config_item:type_name -> pbci.ConfigItem
	110, // 7: pbcs.GetConfigItemResp.content:type_name -> pbcontent.ContentSpec
	109, // 8: pbcs.ListConfigItemsResp.details:type_name -> pbci.ConfigItem
	111, // 9: pbcs.ListConfigItemCountResp.details:type_name -> pbci.ListConfigItemCounts
	106, // 10: pbcs.ListContentsReq.filter:type_name -> google.protobuf.Struct
	107, // 11: pbcs.ListContentsReq.page:type_name -> pbbase.BasePage
	112, // 12: pbcs.ListContentsResp.details:type_name -> pbcontent.Content
	106, // 13: pbcs.ListCommitsReq.filter:type_name -> google.protobuf.Struct
	107, // 14: pbcs.ListCommitsReq.page:type_name -> pbbase.BasePage
	113, // 15: pbcs.ListCommitsResp.details:type_name -> pbcommit.Commit
	114, // 16: pbcs.ListReleasesResp.details:type_name -> pbrelease.Release
	107, // 17: pbcs.ListReleasedConfigItemsReq.page:type_name -> pbbase.BasePage
	115, // 18: pbcs.ListReleasedConfigItemsResp.details:type_name -> pbrci.ReleasedConfigItem
	106, // 19: pbcs.ListStrategySetsReq.filter:type_name -> google.protobuf.Struct
	107, // 20: pbcs.ListStrategySetsReq.page:type_name -> pbbase.BasePage
	116, // 21: pbcs.ListStrategySetsResp.details:type_name -> pbss.StrategySet
	106, // 22: pbcs.ListStrategiesReq.filter:type_name -> google.protobuf.Struct
	107, // 23: pbcs.ListStrategiesReq.page:type_name -> pbbase.BasePage
	117, // 24: pbcs.ListStrategiesResp.details:type_name -> pbstrategy.Strategy
	106, // 25: pbcs.ListHooksReq.filter:type_name -> google.protobuf.Struct
	107, // 26: pbcs.ListHooksReq.page:type_name -> pbbase.BasePage
	118, // 27: pbcs.ListHooksResp.details:type_name -> pbhook.Hook
	106, // 28: pbcs.CreateGroupReq.selector:type_name -> google.protobuf.Struct
	106, // 29: pbcs.UpdateGroupReq.selector:type_name -> google.protobuf.Struct
	99,  // 30: pbcs.ListAllGroupsResp.details:type_name -> pbcs.ListAllGroupsResp.ListAllGroupsData
	101, // 31: pbcs.ListAppGroupsResp.details:type_name -> pbcs.ListAppGroupsResp.ListAppGroupsData
	102, // 32: pbcs.ListGroupReleasedAppsResp.details:type_name -> pbcs.ListGroupReleasedAppsResp.ListGroupReleasedAppsData
	106, // 33: pbcs.ListPubStrategyHistoriesReq.filter:type_name -> google.protobuf.Struct
	107, // 34: pbcs.ListPubStrategyHistoriesReq.page:type_name -> pbbase.BasePage
	119, // 35: pbcs.ListPubStrategyHistoriesResp.details:type_name -> pbstrategy.PublishedStrategyHistory
	106, // 36: pbcs.ListPublishedInstanceReq.filter:type_name -> google.protobuf.Struct
	107, // 37: pbcs.ListPublishedInstanceReq.page:type_name -> pbbase.BasePage
	120, // 38: pbcs.ListPublishedInstanceResp.details:type_name -> pbinstance.CurrentReleasedInstance
	100, // 39: pbcs.ListAllGroupsResp.ListAllGroupsData.bind_apps:type_name -> pbcs.ListAllGroupsResp.ListAllGroupsData.BindApp
	106, // 40: pbcs.ListAllGroupsResp.ListAllGroupsData.selector:type_name -> google.protobuf.Struct
	106, // 41: pbcs.ListAppGroupsResp.ListAppGroupsData.old_selector:type_name -> google.protobuf.Struct
	106, // 42: pbcs.ListAppGroupsResp.ListAppGroupsData.new_selector:type_name -> google.protobuf.Struct
	...
	75,  // 75: pbcs.Config.CreateGroup:input_type -> pbcs.CreateGroupReq
	79,  // 76: pbcs.Config.DeleteGroup:input_type -> pbcs.DeleteGroupReq
	77,  // 77: pbcs.Config.UpdateGroup:input_type -> pbcs.UpdateGroupReq
	81,  // 78: pbcs.Config.ListAllGroups:input_type -> pbcs.ListAllGroupsReq
	83,  // 79: pbcs.Config.ListAppGroups:input_type -> pbcs.ListAppGroupsReq
	85,  // 80: pbcs.Config.ListGroupReleasedApps:input_type -> pbcs.ListGroupReleasedAppsReq
	87,  // 81: pbcs.Config.Publish:input_type -> pbcs.PublishReq
	89,  // 82: pbcs.Config.FinishPublish:input_type -> pbcs.FinishPublishReq
	91,  // 83: pbcs.Config.ListPublishedStrategyHistories:input_type -> pbcs.ListPubStrategyHistoriesReq
	93,  // 84: pbcs.Config.PublishInstance:input_type -> pbcs.PublishInstanceReq
	95,  // 85: pbcs.Config.DeletePublishedInstance:input_type -> pbcs.DeletePublishedInstanceReq
	97,  // 86: pbcs.Config.ListPublishedInstance:input_type -> pbcs.ListPublishedInstanceReq
	...
	108, // 96: pbcs.Config.GetApp:output_type -> pbapp.App
	24,  // 97: pbcs.Config.ListApps:output_type -> pbcs.ListAppsResp
	...
	26,  // 100: pbcs.Config.CreateConfigItem:output_type -> pbcs.CreateConfigItemResp
	28,  // 101: pbcs.Config.UpdateConfigItem:output_type -> pbcs.UpdateConfigItemResp
	30,  // 102: pbcs.Config.DeleteConfigItem:output_type -> pbcs.DeleteConfigItemResp
	32,  // 103: pbcs.Config.GetConfigItem:output_type -> pbcs.GetConfigItemResp
	34,  // 104: pbcs.Config.ListConfigItems:output_type -> pbcs.ListConfigItemsResp
	36,  // 105: pbcs.Config.ListConfigItemCount:output_type -> pbcs.ListConfigItemCountResp
	38,  // 106: pbcs.Config.CreateContent:output_type -> pbcs.CreateContentResp
	40,  // 107: pbcs.Config.ListContents:output_type -> pbcs.ListContentsResp
	42,  // 108: pbcs.Config.CreateCommit:output_type -> pbcs.CreateCommitResp
	44,  // 109: pbcs.Config.ListCommits:output_type -> pbcs.ListCommitsResp
	46,  // 110: pbcs.Config.CreateRelease:output_type -> pbcs.CreateReleaseResp
	48,  // 111: pbcs.Config.ListReleases:output_type -> pbcs.ListReleasesResp
	50,  // 112: pbcs.Config.ListReleasedConfigItems:output_type -> pbcs.ListReleasedConfigItemsResp
	52,  // 113: pbcs.Config.CreateStrategySet:output_type -> pbcs.CreateStrategySetResp
	54,  // 114: pbcs.Config.UpdateStrategySet:output_type -> pbcs.UpdateStrategySetResp
	56,  // 115: pbcs.Config.DeleteStrategySet:output_type -> pbcs.DeleteStrategySetResp
	58,  // 116: pbcs.Config.ListStrategySets:output_type -> pbcs.ListStrategySetsResp
	60,  // 117: pbcs.Config.CreateStrategy:output_type -> pbcs.CreateStrategyResp
	62,  // 118: pbcs.Config.UpdateStrategy:output_type -> pbcs.UpdateStrategyResp
	64,  // 119: pbcs.Config.DeleteStrategy:output_type -> pbcs.DeleteStrategyResp
	66,  // 120: pbcs.Config.ListStrategies:output_type -> pbcs.ListStrategiesResp
	68,  // 121: pbcs.Config.CreateHook:output_type -> pbcs.CreateHookResp
	72,  // 122: pbcs.Config.DeleteHook:output_type -> pbcs.DeleteHookResp
	70,  // 123: pbcs.Config.UpdateHook:output_type -> pbcs.UpdateHookResp
	74,  // 124: pbcs.Config.ListHooks:output_type -> pbcs.ListHooksResp
	76,  // 125: pbcs.Config.CreateGroup:output_type -> pbcs.CreateGroupResp
	80,  // 126: pbcs.Config.DeleteGroup:output_type -> pbcs.DeleteGroupResp
	78,  // 127: pbcs.Config.UpdateGroup:output_type -> pbcs.UpdateGroupResp
	82,  // 128: pbcs.Config.ListAllGroups:output_type -> pbcs.ListAllGroupsResp
	84,  // 129: pbcs.Config.ListAppGroups:output_type -> pbcs.ListAppGroupsResp
	86,  // 130: pbcs.Config.ListGroupReleasedApps:output_type -> pbcs.ListGroupReleasedAppsResp
	88,  // 131: pbcs.Config.Publish:output_type -> pbcs.PublishResp
	90,  // 132: pbcs.Config.FinishPublish:output_type -> pbcs.FinishPublishResp
	92,  // 133: pbcs.Config.ListPublishedStrategyHistories:output_type -> pbcs.ListPubStrategyHistoriesResp
	94,  // 134: pbcs.Config.PublishInstance:output_type -> pbcs.PublishInstanceResp
	96,  // 135: pbcs.Config.DeletePublishedInstance:output_type -> pbcs.DeletePublishedInstanceResp
	98,  // 136: pbcs.Config.ListPublishedInstance:output_type -> pbcs.ListPublishedInstanceResp
	13,  // 137: pbcs.Config.CreateCredentials:output_type -> pbcs.CreateCredentialResp
	11,  // 138: pbcs.Config.ListCredentials:output_type -> pbcs.ListCredentialsResp
	7,   // 139: pbcs.Config.DeleteCredential:output_type -> pbcs.DeleteCredentialsResp
	9,   // 140: pbcs.Config.UpdateCredential:output_type -> pbcs.UpdateCredentialsResp
	3,   // 141: pbcs.Config.ListCredentialScopes:output_type -> pbcs.ListCredentialScopesResp
	1,   // 142: pbcs.Config.UpdateCredentialScope:output_type -> pbcs.UpdateCredentialScopeResp
