...
var file_config_service_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x73, 0x32, 0xe6, 0x30, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x48,
	...
	0x70, 0x70, 0x5f, 0x69, 0x64, 0x7d, 0x2f, 0x62, 0x69, 0x7a, 0x5f, 0x69, 0x64, 0x2f, 0x7b, 0x62,
	0x69, 0x7a, 0x5f, 0x69, 0x64, 0x7d, 0x3a, 0x01, 0x2a, 0x12, 0x6a, 0x0a, 0x0b, 0x43, 0x72, 0x65,
...
var file_config_service_proto_msgTypes = make([]protoimpl.MessageInfo, 83)
var file_config_service_proto_goTypes = []interface{}{
	...
	(*ListAllGroupsReq)(nil),                    // 61: pbcs.ListAllGroupsReq
	(*ListAllGroupsResp)(nil),                   // 62: pbcs.ListAllGroupsResp
	(*CreateGroupCategoryReq)(nil),              // 63: pbcs.CreateGroupCategoryReq
	(*CreateGroupCategoryResp)(nil),             // 64: pbcs.CreateGroupCategoryResp
	(*DeleteGroupCategoryReq)(nil),              // 65: pbcs.DeleteGroupCategoryReq
	(*DeleteGroupCategoryResp)(nil),             // 66: pbcs.DeleteGroupCategoryResp
	(*ListGroupCategoriesReq)(nil),              // 67: pbcs.ListGroupCategoriesReq
	(*ListGroupCategoriesResp)(nil),             // 68: pbcs.ListGroupCategoriesResp
	(*PublishReq)(nil),                          // 69: pbcs.PublishReq
	(*PublishResp)(nil),                         // 70: pbcs.PublishResp
	(*FinishPublishReq)(nil),                    // 71: pbcs.FinishPublishReq
	(*FinishPublishResp)(nil),                   // 72: pbcs.FinishPublishResp
	(*ListPubStrategyHistoriesReq)(nil),         // 73: pbcs.ListPubStrategyHistoriesReq
	(*ListPubStrategyHistoriesResp)(nil),        // 74: pbcs.ListPubStrategyHistoriesResp
	(*PublishInstanceReq)(nil),                  // 75: pbcs.PublishInstanceReq
	(*PublishInstanceResp)(nil),                 // 76: pbcs.PublishInstanceResp
	(*DeletePublishedInstanceReq)(nil),          // 77: pbcs.DeletePublishedInstanceReq
	(*DeletePublishedInstanceResp)(nil),         // 78: pbcs.DeletePublishedInstanceResp
	(*ListPublishedInstanceReq)(nil),            // 79: pbcs.ListPublishedInstanceReq
	(*ListPublishedInstanceResp)(nil),           // 80: pbcs.ListPublishedInstanceResp
	(*ListBizResp_BizData)(nil),                 // 81: pbcs.ListBizResp.BizData
	(*ListAllGroupsResp_ListAllGroupsData)(nil), // 82: pbcs.ListAllGroupsResp.ListAllGroupsData
	...
	(*content.ContentSpec)(nil),                 // 87: pbcontent.ContentSpec
	...
	(*group.Group)(nil),                         // 94: pbgroup.Group
	(*group_category.GroupCategory)(nil),        // 95: pbgc.GroupCategory
	(*strategy.PublishedStrategyHistory)(nil),   // 96: pbstrategy.PublishedStrategyHistory
	(*instance.CurrentReleasedInstance)(nil),    // 97: pbinstance.CurrentReleasedInstance
}
var file_config_service_proto_depIdxs = []int32{
	81, // 0: pbcs.ListBizResp.biz_list:type_name -> pbcs.ListBizResp.BizData
	83, // 1: pbcs.ListAppsReq.filter:type_name -> google.protobuf.Struct
	84, // 2: pbcs.ListAppsReq.page:type_name -> pbbase.BasePage
	85, // 3: pbcs.ListAppsResp.details:type_name -> pbapp.App
	86, // 4: pbcs.GetConfigItemResp.config_item:type_name -> pbci.ConfigItem
	87, // 5: pbcs.GetConfigItemResp.content:type_name -> pbcontent.ContentSpec
	86, // 6: pbcs.ListConfigItemsResp.details:type_name -> pbci.ConfigItem
	83, // 7: pbcs.ListContentsReq.filter:type_name -> google.protobuf.Struct
	84, // 8: pbcs.ListContentsReq.page:type_name -> pbbase.BasePage
	88, // 9: pbcs.ListContentsResp.details:type_name -> pbcontent.Content
	83, // 10: pbcs.ListCommitsReq.filter:type_name -> google.protobuf.Struct
	84, // 11: pbcs.ListCommitsReq.page:type_name -> pbbase.BasePage
	89, // 12: pbcs.ListCommitsResp.details:type_name -> pbcommit.Commit
	83, // 13: pbcs.ListReleasesReq.filter:type_name -> google.protobuf.Struct
	84, // 14: pbcs.ListReleasesReq.page:type_name -> pbbase.BasePage
	90, // 15: pbcs.ListReleasesResp.details:type_name -> pbrelease.Release
	84, // 16: pbcs.ListReleasedConfigItemsReq.page:type_name -> pbbase.BasePage
	91, // 17: pbcs.ListReleasedConfigItemsResp.details:type_name -> pbrci.ReleasedConfigItem
	83, // 18: pbcs.ListStrategySetsReq.filter:type_name -> google.protobuf.Struct
	84, // 19: pbcs.ListStrategySetsReq.page:type_name -> pbbase.BasePage
	92, // 20: pbcs.ListStrategySetsResp.details:type_name -> pbss.StrategySet
	83, // 21: pbcs.ListStrategiesReq.filter:type_name -> google.protobuf.Struct
	84, // 22: pbcs.ListStrategiesReq.page:type_name -> pbbase.BasePage
	93, // 23: pbcs.ListStrategiesResp.details:type_name -> pbstrategy.Strategy
	83, // 24: pbcs.CreateGroupReq.selector:type_name -> google.protobuf.Struct
	83, // 25: pbcs.UpdateGroupReq.selector:type_name -> google.protobuf.Struct
	94, // 26: pbcs.ListGroupsResp.details:type_name -> pbgroup.Group
	82, // 27: pbcs.ListAllGroupsResp.details:type_name -> pbcs.ListAllGroupsResp.ListAllGroupsData
	95, // 28: pbcs.ListGroupCategoriesResp.details:type_name -> pbgc.GroupCategory
	83, // 29: pbcs.ListPubStrategyHistoriesReq.filter:type_name -> google.protobuf.Struct
	84, // 30: pbcs.ListPubStrategyHistoriesReq.page:type_name -> pbbase.BasePage
	96, // 31: pbcs.ListPubStrategyHistoriesResp.details:type_name -> pbstrategy.PublishedStrategyHistory
	83, // 32: pbcs.ListPublishedInstanceReq.filter:type_name -> google.protobuf.Struct
	84, // 33: pbcs.ListPublishedInstanceReq.page:type_name -> pbbase.BasePage
	97, // 34: pbcs.ListPublishedInstanceResp.details:type_name -> pbinstance.CurrentReleasedInstance
	94, // 35: pbcs.ListAllGroupsResp.ListAllGroupsData.groups:type_name -> pbgroup.Group
	...
	61, // 68: pbcs.Config.ListAllGroups:input_type -> pbcs.ListAllGroupsReq
	63, // 69: pbcs.Config.CreateGroupCategory:input_type -> pbcs.CreateGroupCategoryReq
	65, // 70: pbcs.Config.DeleteGroupCategory:input_type -> pbcs.DeleteGroupCategoryReq
	67, // 71: pbcs.Config.ListGroupCategories:input_type -> pbcs.ListGroupCategoriesReq
	69, // 72: pbcs.Config.Publish:input_type -> pbcs.PublishReq
	71, // 73: pbcs.Config.FinishPublish:input_type -> pbcs.FinishPublishReq
	73, // 74: pbcs.Config.ListPublishedStrategyHistories:input_type -> pbcs.ListPubStrategyHistoriesReq
	75, // 75: pbcs.Config.PublishInstance:input_type -> pbcs.PublishInstanceReq
	77, // 76: pbcs.Config.DeletePublishedInstance:input_type -> pbcs.DeletePublishedInstanceReq
	79, // 77: pbcs.Config.ListPublishedInstance:input_type -> pbcs.ListPublishedInstanceReq
	1,  // 78: pbcs.Config.ListBiz:output_type -> pbcs.ListBizResp
	3,  // 79: pbcs.Config.CreateApp:output_type -> pbcs.CreateAppResp
	5,  // 80: pbcs.Config.UpdateApp:output_type -> pbcs.UpdateAppResp
	7,  // 81: pbcs.Config.DeleteApp:output_type -> pbcs.DeleteAppResp
	85, // 82: pbcs.Config.GetApp:output_type -> pbapp.App
	12, // 83: pbcs.Config.ListApps:output_type -> pbcs.ListAppsResp
	12, // 84: pbcs.Config.ListAppsRest:output_type -> pbcs.ListAppsResp
	12, // 85: pbcs.Config.ListAppsBySpaceRest:output_type -> pbcs.ListAppsResp
	14, // 86: pbcs.Config.CreateConfigItem:output_type -> pbcs.CreateConfigItemResp
	16, // 87: pbcs.Config.UpdateConfigItem:output_type -> pbcs.UpdateConfigItemResp
	18, // 88: pbcs.Config.DeleteConfigItem:output_type -> pbcs.DeleteConfigItemResp
	20, // 89: pbcs.Config.GetConfigItem:output_type -> pbcs.GetConfigItemResp
	22, // 90: pbcs.Config.ListConfigItems:output_type -> pbcs.ListConfigItemsResp
	24, // 91: pbcs.Config.CreateContent:output_type -> pbcs.CreateContentResp
	26, // 92: pbcs.Config.ListContents:output_type -> pbcs.ListContentsResp
	28, // 93: pbcs.Config.CreateCommit:output_type -> pbcs.CreateCommitResp
	30, // 94: pbcs.Config.ListCommits:output_type -> pbcs.ListCommitsResp
	32, // 95: pbcs.Config.CreateRelease:output_type -> pbcs.CreateReleaseResp
	34, // 96: pbcs.Config.ListReleases:output_type -> pbcs.ListReleasesResp
	36, // 97: pbcs.Config.ListReleasedConfigItems:output_type -> pbcs.ListReleasedConfigItemsResp
	38, // 98: pbcs.Config.CreateStrategySet:output_type -> pbcs.CreateStrategySetResp
	40, // 99: pbcs.Config.UpdateStrategySet:output_type -> pbcs.UpdateStrategySetResp
	42, // 100: pbcs.Config.DeleteStrategySet:output_type -> pbcs.DeleteStrategySetResp
	44, // 101: pbcs.Config.ListStrategySets:output_type -> pbcs.ListStrategySetsResp
	46, // 102: pbcs.Config.CreateStrategy:output_type -> pbcs.CreateStrategyResp
	48, // 103: pbcs.Config.UpdateStrategy:output_type -> pbcs.UpdateStrategyResp
	50, // 104: pbcs.Config.DeleteStrategy:output_type -> pbcs.DeleteStrategyResp
	52, // 105: pbcs.Config.ListStrategies:output_type -> pbcs.ListStrategiesResp
	54, // 106: pbcs.Config.CreateGroup:output_type -> pbcs.CreateGroupResp
	58, // 107: pbcs.Config.DeleteGroup:output_type -> pbcs.DeleteGroupResp
	56, // 108: pbcs.Config.UpdateGroup:output_type -> pbcs.UpdateGroupResp
	60, // 109: pbcs.Config.ListGroups:output_type -> pbcs.ListGroupsResp
	62, // 110: pbcs.Config.ListAllGroups:output_type -> pbcs.ListAllGroupsResp
	64, // 111: pbcs.Config.CreateGroupCategory:output_type -> pbcs.CreateGroupCategoryResp
	66, // 112: pbcs.Config.DeleteGroupCategory:output_type -> pbcs.DeleteGroupCategoryResp
	68, // 113: pbcs.Config.ListGroupCategories:output_type -> pbcs.ListGroupCategoriesResp
	70, // 114: pbcs.Config.Publish:output_type -> pbcs.PublishResp
	72, // 115: pbcs.Config.FinishPublish:output_type -> pbcs.FinishPublishResp
	74, // 116: pbcs.Config.ListPublishedStrategyHistories:output_type -> pbcs.ListPubStrategyHistoriesResp
	76, // 117: pbcs.Config.PublishInstance:output_type -> pbcs.PublishInstanceResp
	78, // 118: pbcs.Config.DeletePublishedInstance:output_type -> pbcs.DeletePublishedInstanceResp
	80, // 119: pbcs.Config.ListPublishedInstance:output_type -> pbcs.ListPublishedInstanceResp
