...
func (*ListAllGroupsResp_ListAllGroupsData_BindApp) Descriptor() ([]byte, []int) {
	return file_config_service_proto_rawDescGZIP(), []int{183, 0, 0}
}
...
var file_config_service_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x32, 0x9a, 0x7e, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66,
...
var file_config_service_proto_msgTypes = make([]protoimpl.MessageInfo, 198)
var file_config_service_proto_goTypes = []interface{}{
	...
	(*CreateTemplateVariableReq)(nil),                                       // 168: pbcs.CreateTemplateVariableReq
	(*CreateTemplateVariableResp)(nil),                                      // 169: pbcs.CreateTemplateVariableResp
	(*UpdateTemplateVariableReq)(nil),                                       // 170: pbcs.UpdateTemplateVariableReq
	(*UpdateTemplateVariableResp)(nil),                                      // 171: pbcs.UpdateTemplateVariableResp
	(*DeleteTemplateVariableReq)(nil),                                       // 172: pbcs.DeleteTemplateVariableReq
	(*DeleteTemplateVariableResp)(nil),                                      // 173: pbcs.DeleteTemplateVariableResp
	(*ListTemplateVariablesReq)(nil),                                        // 174: pbcs.ListTemplateVariablesReq
	(*ListTemplateVariablesResp)(nil),                                       // 175: pbcs.ListTemplateVariablesResp
	(*CreateGroupReq)(nil),                                                  // 176: pbcs.CreateGroupReq
	(*CreateGroupResp)(nil),                                                 // 177: pbcs.CreateGroupResp
	(*UpdateGroupReq)(nil),                                                  // 178: pbcs.UpdateGroupReq
	(*UpdateGroupResp)(nil),                                                 // 179: pbcs.UpdateGroupResp
	(*DeleteGroupReq)(nil),                                                  // 180: pbcs.DeleteGroupReq
	(*DeleteGroupResp)(nil),                                                 // 181: pbcs.DeleteGroupResp
	(*ListAllGroupsReq)(nil),                                                // 182: pbcs.ListAllGroupsReq
	(*ListAllGroupsResp)(nil),                                               // 183: pbcs.ListAllGroupsResp
	(*ListAppGroupsReq)(nil),                                                // 184: pbcs.ListAppGroupsReq
	(*ListAppGroupsResp)(nil),                                               // 185: pbcs.ListAppGroupsResp
	(*ListGroupReleasedAppsReq)(nil),                                        // 186: pbcs.ListGroupReleasedAppsReq
	(*ListGroupReleasedAppsResp)(nil),                                       // 187: pbcs.ListGroupReleasedAppsResp
	(*PublishReq)(nil),                                                      // 188: pbcs.PublishReq
	(*GenerateReleaseAndPublishReq)(nil),                                    // 189: pbcs.GenerateReleaseAndPublishReq
	(*GenerateReleaseAndPublishResp)(nil),                                   // 190: pbcs.GenerateReleaseAndPublishResp
	(*PublishResp)(nil),                                                     // 191: pbcs.PublishResp
	(*BatchUpsertConfigItemsReq_ConfigItem)(nil),                            // 192: pbcs.BatchUpsertConfigItemsReq.ConfigItem
	(*GetHookInfoSpec_Releases)(nil),                                        // 193: pbcs.GetHookInfoSpec.Releases
	(*ListAllGroupsResp_ListAllGroupsData)(nil),                             // 194: pbcs.ListAllGroupsResp.ListAllGroupsData
	(*ListAllGroupsResp_ListAllGroupsData_BindApp)(nil),                     // 195: pbcs.ListAllGroupsResp.ListAllGroupsData.BindApp
	(*ListAppGroupsResp_ListAppGroupsData)(nil),                             // 196: pbcs.ListAppGroupsResp.ListAppGroupsData
	(*ListGroupReleasedAppsResp_ListGroupReleasedAppsData)(nil),             // 197: pbcs.ListGroupReleasedAppsResp.ListGroupReleasedAppsData
	(*credential_scope.UpdateScopeSpec)(nil),                                // 198: pbcrs.UpdateScopeSpec
	(*credential_scope.CredentialScopeList)(nil),                            // 199: pbcrs.CredentialScopeList
	(*credential.CredentialList)(nil),                                       // 200: pbcredential.CredentialList
	(*app.App)(nil),                                                         // 201: pbapp.App
	(*config_item.ConfigItem)(nil),                                          // 202: pbci.ConfigItem
	(*content.ContentSpec)(nil),                                             // 203: pbcontent.ContentSpec
	(*config_item.ListConfigItemCounts)(nil),                                // 204: pbci.ListConfigItemCounts
	(*config_hook.ConfigHook)(nil),                                          // 205: pbch.ConfigHook
	(*release.Release)(nil),                                                 // 206: pbrelease.Release
	(*hook.Hook)(nil),                                                       // 207: pbhook.Hook
	(*hook.CountHookTags)(nil),                                              // 208: pbhook.CountHookTags
	(*hook_release.HookRelease)(nil),                                        // 209: pbhr.HookRelease
	(*hook.HookAttachment)(nil),                                             // 210: pbhook.HookAttachment
	(*base.Revision)(nil),                                                   // 211: pbbase.Revision
	(*hook_release.ListHookReleasesReferencesDetails)(nil),                  // 212: pbhr.ListHookReleasesReferencesDetails
	(*template_space.TemplateSpace)(nil),                                    // 213: pbts.TemplateSpace
	...
	(*template_set.TemplateSet)(nil),                                        // 217: pbtset.TemplateSet
	(*template_set.TemplateSetOfBizDetail)(nil),                             // 218: pbtset.TemplateSetOfBizDetail
	(*app_template_binding.TemplateBinding)(nil),                            // 219: pbatb.TemplateBinding
	(*app_template_binding.AppTemplateBinding)(nil),                         // 220: pbatb.AppTemplateBinding
	(*app_template_binding.AppBoundTmplRevision)(nil),                       // 221: pbatb.AppBoundTmplRevision
	(*template_binding_relation.TemplateBoundCounts)(nil),                   // 222: pbtbr.TemplateBoundCounts
	(*template_binding_relation.TemplateRevisionBoundCounts)(nil),           // 223: pbtbr.TemplateRevisionBoundCounts
	(*template_binding_relation.TemplateSetBoundCounts)(nil),                // 224: pbtbr.TemplateSetBoundCounts
	(*template_binding_relation.TemplateBoundUnnamedAppDetail)(nil),         // 225: pbtbr.TemplateBoundUnnamedAppDetail
	(*template_binding_relation.TemplateBoundNamedAppDetail)(nil),           // 226: pbtbr.TemplateBoundNamedAppDetail
	(*template_binding_relation.TemplateBoundTemplateSetDetail)(nil),        // 227: pbtbr.TemplateBoundTemplateSetDetail
	(*template_binding_relation.MultiTemplateBoundTemplateSetDetail)(nil),   // 228: pbtbr.MultiTemplateBoundTemplateSetDetail
	(*template_binding_relation.TemplateRevisionBoundUnnamedAppDetail)(nil), // 229: pbtbr.TemplateRevisionBoundUnnamedAppDetail
	(*template_binding_relation.TemplateRevisionBoundNamedAppDetail)(nil),   // 230: pbtbr.TemplateRevisionBoundNamedAppDetail
	(*template_binding_relation.TemplateSetBoundUnnamedAppDetail)(nil),      // 231: pbtbr.TemplateSetBoundUnnamedAppDetail
	(*template_binding_relation.MultiTemplateSetBoundUnnamedAppDetail)(nil), // 232: pbtbr.MultiTemplateSetBoundUnnamedAppDetail
	(*template_binding_relation.TemplateSetBoundNamedAppDetail)(nil),        // 233: pbtbr.TemplateSetBoundNamedAppDetail
	(*template_variable.TemplateVariable)(nil),                              // 234: pbtv.TemplateVariable
...
var file_config_service_proto_depIdxs = []int32{
	198, // 0: pbcs.UpdateCredentialScopeReq.alter_scope:type_name -> pbcrs.UpdateScopeSpec
	199, // 1: pbcs.ListCredentialScopesResp.details:type_name -> pbcrs.CredentialScopeList
	200, // 2: pbcs.ListCredentialsResp.details:type_name -> pbcredential.CredentialList
	201, // 3: pbcs.ListAppsResp.details:type_name -> pbapp.App
	192, // 4: pbcs.BatchUpsertConfigItemsReq.items:type_name -> pbcs.BatchUpsertConfigItemsReq.ConfigItem
	202, // 5: pbcs.GetConfigItemResp.config_item:type_name -> pbci.ConfigItem
	203, // 6: pbcs.GetConfigItemResp.content:type_name -> pbcontent.ContentSpec
	202, // 7: pbcs.ListConfigItemsResp.details:type_name -> pbci.ConfigItem
	204, // 8: pbcs.ListConfigItemCountResp.details:type_name -> pbci.ListConfigItemCounts
	205, // 9: pbcs.GetConfigHookResp.config_hook:type_name -> pbch.ConfigHook
	206, // 10: pbcs.ListReleasesResp.details:type_name -> pbrelease.Release
	207, // 11: pbcs.ListHooksResp.details:type_name -> pbhook.Hook
	208, // 12: pbcs.ListHookTagsResp.details:type_name -> pbhook.CountHookTags
	209, // 13: pbcs.ListHookReleaseResp.details:type_name -> pbhr.HookRelease
	67,  // 14: pbcs.GetHookResp.spec:type_name -> pbcs.GetHookInfoSpec
	210, // 15: pbcs.GetHookResp.attachment:type_name -> pbhook.HookAttachment
	211, // 16: pbcs.GetHookResp.revision:type_name -> pbbase.Revision
	193, // 17: pbcs.GetHookInfoSpec.releases:type_name -> pbcs.GetHookInfoSpec.Releases
	212, // 18: pbcs.ListHookReleasesReferencesResp.details:type_name -> pbhr.ListHookReleasesReferencesDetails
	213, // 19: pbcs.ListTemplateSpacesResp.details:type_name -> pbts.TemplateSpace
	213, // 20: pbcs.ListTemplateSpacesByIDsResp.details:type_name -> pbts.TemplateSpace
	214, // 21: pbcs.ListTemplatesResp.details:type_name -> pbtemplate.Template
	214, // 22: pbcs.ListTemplatesByIDsResp.details:type_name -> pbtemplate.Template
	214, // 23: pbcs.ListTemplatesNotBoundResp.details:type_name -> pbtemplate.Template
	214, // 24: pbcs.ListTemplatesOfTemplateSetResp.details:type_name -> pbtemplate.Template
	215, // 25: pbcs.ListTemplateRevisionsResp.details:type_name -> pbtr.TemplateRevision
	215, // 26: pbcs.ListTemplateRevisionsByIDsResp.details:type_name -> pbtr.TemplateRevision
	216, // 27: pbcs.ListTemplateRevisionNamesByTemplateIDsResp.details:type_name -> pbtr.TemplateRevisionNamesDetail
	217, // 28: pbcs.ListTemplateSetsResp.details:type_name -> pbtset.TemplateSet
	217, // 29: pbcs.ListAppTemplateSetsResp.details:type_name -> pbtset.TemplateSet
	217, // 30: pbcs.ListTemplateSetsByIDsResp.details:type_name -> pbtset.TemplateSet
	218, // 31: pbcs.ListTemplateSetsOfBizResp.details:type_name -> pbtset.TemplateSetOfBizDetail
	219, // 32: pbcs.CreateAppTemplateBindingReq.bindings:type_name -> pbatb.TemplateBinding
	219, // 33: pbcs.UpdateAppTemplateBindingReq.bindings:type_name -> pbatb.TemplateBinding
	220, // 34: pbcs.ListAppTemplateBindingsResp.details:type_name -> pbatb.AppTemplateBinding
	221, // 35: pbcs.ListAppBoundTemplateRevisionsResp.details:type_name -> pbatb.AppBoundTmplRevision
	219, // 36: pbcs.UpdateAppBoundTemplateRevisionsReq.bindings:type_name -> pbatb.TemplateBinding
	222, // 37: pbcs.ListTemplateBoundCountsResp.details:type_name -> pbtbr.TemplateBoundCounts
	223, // 38: pbcs.ListTemplateRevisionBoundCountsResp.details:type_name -> pbtbr.TemplateRevisionBoundCounts
	224, // 39: pbcs.ListTemplateSetBoundCountsResp.details:type_name -> pbtbr.TemplateSetBoundCounts
	225, // 40: pbcs.ListTemplateBoundUnnamedAppDetailsResp.details:type_name -> pbtbr.TemplateBoundUnnamedAppDetail
	226, // 41: pbcs.ListTemplateBoundNamedAppDetailsResp.details:type_name -> pbtbr.TemplateBoundNamedAppDetail
	227, // 42: pbcs.ListTemplateBoundTemplateSetDetailsResp.details:type_name -> pbtbr.TemplateBoundTemplateSetDetail
	228, // 43: pbcs.ListMultiTemplateBoundTemplateSetDetailsResp.details:type_name -> pbtbr.MultiTemplateBoundTemplateSetDetail
	229, // 44: pbcs.ListTemplateRevisionBoundUnnamedAppDetailsResp.details:type_name -> pbtbr.TemplateRevisionBoundUnnamedAppDetail
	230, // 45: pbcs.ListTemplateRevisionBoundNamedAppDetailsResp.details:type_name -> pbtbr.TemplateRevisionBoundNamedAppDetail
	231, // 46: pbcs.ListTemplateSetBoundUnnamedAppDetailsResp.details:type_name -> pbtbr.TemplateSetBoundUnnamedAppDetail
	232, // 47: pbcs.ListMultiTemplateSetBoundUnnamedAppDetailsResp.details:type_name -> pbtbr.MultiTemplateSetBoundUnnamedAppDetail
	233, // 48: pbcs.ListTemplateSetBoundNamedAppDetailsResp.details:type_name -> pbtbr.TemplateSetBoundNamedAppDetail
	234, // 49: pbcs.ListTemplateVariablesResp.details:type_name -> pbtv.TemplateVariable
	235, // 50: pbcs.CreateGroupReq.selector:type_name -> google.protobuf.Struct
	235, // 51: pbcs.UpdateGroupReq.selector:type_name -> google.protobuf.Struct
	194, // 52: pbcs.ListAllGroupsResp.details:type_name -> pbcs.ListAllGroupsResp.ListAllGroupsData
	196, // 53: pbcs.ListAppGroupsResp.details:type_name -> pbcs.ListAppGroupsResp.ListAppGroupsData
	197, // 54: pbcs.ListGroupReleasedAppsResp.details:type_name -> pbcs.ListGroupReleasedAppsResp.ListGroupReleasedAppsData
	195, // 55: pbcs.ListAllGroupsResp.ListAllGroupsData.bind_apps:type_name -> pbcs.ListAllGroupsResp.ListAllGroupsData.BindApp
	235, // 56: pbcs.ListAllGroupsResp.ListAllGroupsData.selector:type_name -> google.protobuf.Struct
	235, // 57: pbcs.ListAppGroupsResp.ListAppGroupsData.old_selector:type_name -> google.protobuf.Struct
	235, // 58: pbcs.ListAppGroupsResp.ListAppGroupsData.new_selector:type_name -> google.protobuf.Struct
	14,  // 59: pbcs.Config.CreateApp:input_type -> pbcs.CreateAppReq
	16,  // 60: pbcs.Config.UpdateApp:input_type -> pbcs.UpdateAppReq
	18,  // 61: pbcs.Config.DeleteApp:input_type -> pbcs.DeleteAppReq
	20,  // 62: pbcs.Config.GetApp:input_type -> pbcs.GetAppReq
	21,  // 63: pbcs.Config.GetAppByName:input_type -> pbcs.GetAppByNameReq
	22,  // 64: pbcs.Config.ListAppsRest:input_type -> pbcs.ListAppsRestReq
	23,  // 65: pbcs.Config.ListAppsBySpaceRest:input_type -> pbcs.ListAppsBySpaceRestReq
	25,  // 66: pbcs.Config.CreateConfigItem:input_type -> pbcs.CreateConfigItemReq
	26,  // 67: pbcs.Config.BatchUpsertConfigItems:input_type -> pbcs.BatchUpsertConfigItemsReq
	29,  // 68: pbcs.Config.UpdateConfigItem:input_type -> pbcs.UpdateConfigItemReq
	31,  // 69: pbcs.Config.DeleteConfigItem:input_type -> pbcs.DeleteConfigItemReq
	33,  // 70: pbcs.Config.GetConfigItem:input_type -> pbcs.GetConfigItemReq
	35,  // 71: pbcs.Config.ListConfigItems:input_type -> pbcs.ListConfigItemsReq
	37,  // 72: pbcs.Config.ListConfigItemCount:input_type -> pbcs.ListConfigItemCountReq
	41,  // 73: pbcs.Config.UpdateConfigHook:input_type -> pbcs.UpdateConfigHookReq
	43,  // 74: pbcs.Config.GetConfigHook:input_type -> pbcs.GetConfigHookReq
	45,  // 75: pbcs.Config.CreateRelease:input_type -> pbcs.CreateReleaseReq
	47,  // 76: pbcs.Config.ListReleases:input_type -> pbcs.ListReleasesReq
	49,  // 77: pbcs.Config.CreateHook:input_type -> pbcs.CreateHookReq
	51,  // 78: pbcs.Config.DeleteHook:input_type -> pbcs.DeleteHookReq
	53,  // 79: pbcs.Config.ListHooks:input_type -> pbcs.ListHooksReq
	55,  // 80: pbcs.Config.ListHookTags:input_type -> pbcs.ListHookTagsReq
	65,  // 81: pbcs.Config.GetHook:input_type -> pbcs.GetHookReq
	57,  // 82: pbcs.Config.CreateHookRelease:input_type -> pbcs.CreateHookReleaseReq
	59,  // 83: pbcs.Config.ListHookRelease:input_type -> pbcs.ListHookReleaseReq
	61,  // 84: pbcs.Config.DeleteHookRelease:input_type -> pbcs.DeleteHookReleaseReq
	63,  // 85: pbcs.Config.PublishHookRelease:input_type -> pbcs.PublishHookReleaseReq
	68,  // 86: pbcs.Config.GetHookRelease:input_type -> pbcs.GetHookReleaseReq
	69,  // 87: pbcs.Config.UpdateHookRelease:input_type -> pbcs.UpdateHookReleaseReq
	71,  // 88: pbcs.Config.ListHookReleasesReferences:input_type -> pbcs.ListHookReleasesReferencesReq
	73,  // 89: pbcs.Config.CreateTemplateSpace:input_type -> pbcs.CreateTemplateSpaceReq
	77,  // 90: pbcs.Config.DeleteTemplateSpace:input_type -> pbcs.DeleteTemplateSpaceReq
	75,  // 91: pbcs.Config.UpdateTemplateSpace:input_type -> pbcs.UpdateTemplateSpaceReq
	79,  // 92: pbcs.Config.ListTemplateSpaces:input_type -> pbcs.ListTemplateSpacesReq
	236, // 93: pbcs.Config.GetAllBizsOfTemplateSpaces:input_type -> pbbase.EmptyReq
	82,  // 94: pbcs.Config.CreateDefaultTemplateSpace:input_type -> pbcs.CreateDefaultTemplateSpaceReq
	84,  // 95: pbcs.Config.ListTemplateSpacesByIDs:input_type -> pbcs.ListTemplateSpacesByIDsReq
	86,  // 96: pbcs.Config.CreateTemplate:input_type -> pbcs.CreateTemplateReq
	90,  // 97: pbcs.Config.DeleteTemplate:input_type -> pbcs.DeleteTemplateReq
	92,  // 98: pbcs.Config.BatchDeleteTemplate:input_type -> pbcs.BatchDeleteTemplateReq
	88,  // 99: pbcs.Config.UpdateTemplate:input_type -> pbcs.UpdateTemplateReq
	94,  // 100: pbcs.Config.ListTemplates:input_type -> pbcs.ListTemplatesReq
	96,  // 101: pbcs.Config.AddTemplatesToTemplateSets:input_type -> pbcs.AddTemplatesToTemplateSetsReq
	98,  // 102: pbcs.Config.DeleteTemplatesFromTemplateSets:input_type -> pbcs.DeleteTemplatesFromTemplateSetsReq
	100, // 103: pbcs.Config.ListTemplatesByIDs:input_type -> pbcs.ListTemplatesByIDsReq
	102, // 104: pbcs.Config.ListTemplatesNotBound:input_type -> pbcs.ListTemplatesNotBoundReq
	104, // 105: pbcs.Config.ListTemplatesOfTemplateSet:input_type -> pbcs.ListTemplatesOfTemplateSetReq
	106, // 106: pbcs.Config.CreateTemplateRevision:input_type -> pbcs.CreateTemplateRevisionReq
	108, // 107: pbcs.Config.ListTemplateRevisions:input_type -> pbcs.ListTemplateRevisionsReq
	110, // 108: pbcs.Config.DeleteTemplateRevision:input_type -> pbcs.DeleteTemplateRevisionReq
	112, // 109: pbcs.Config.ListTemplateRevisionsByIDs:input_type -> pbcs.ListTemplateRevisionsByIDsReq
	114, // 110: pbcs.Config.ListTemplateRevisionNamesByTemplateIDs:input_type -> pbcs.ListTemplateRevisionNamesByTemplateIDsReq
	116, // 111: pbcs.Config.CreateTemplateSet:input_type -> pbcs.CreateTemplateSetReq
	120, // 112: pbcs.Config.DeleteTemplateSet:input_type -> pbcs.DeleteTemplateSetReq
	118, // 113: pbcs.Config.UpdateTemplateSet:input_type -> pbcs.UpdateTemplateSetReq
	122, // 114: pbcs.Config.ListTemplateSets:input_type -> pbcs.ListTemplateSetsReq
	124, // 115: pbcs.Config.ListAppTemplateSets:input_type -> pbcs.ListAppTemplateSetsReq
	126, // 116: pbcs.Config.ListTemplateSetsByIDs:input_type -> pbcs.ListTemplateSetsByIDsReq
	128, // 117: pbcs.Config.ListTemplateSetsOfBiz:input_type -> pbcs.ListTemplateSetsOfBizReq
	130, // 118: pbcs.Config.CreateAppTemplateBinding:input_type -> pbcs.CreateAppTemplateBindingReq
	134, // 119: pbcs.Config.DeleteAppTemplateBinding:input_type -> pbcs.DeleteAppTemplateBindingReq
	132, // 120: pbcs.Config.UpdateAppTemplateBinding:input_type -> pbcs.UpdateAppTemplateBindingReq
	136, // 121: pbcs.Config.ListAppTemplateBindings:input_type -> pbcs.ListAppTemplateBindingsReq
	138, // 122: pbcs.Config.ListAppBoundTemplateRevisions:input_type -> pbcs.ListAppBoundTemplateRevisionsReq
	140, // 123: pbcs.Config.UpdateAppBoundTemplateRevisions:input_type -> pbcs.UpdateAppBoundTemplateRevisionsReq
	142, // 124: pbcs.Config.DeleteAppBoundTemplateSets:input_type -> pbcs.DeleteAppBoundTemplateSetsReq
	144, // 125: pbcs.Config.ListTemplateBoundCounts:input_type -> pbcs.ListTemplateBoundCountsReq
	146, // 126: pbcs.Config.ListTemplateRevisionBoundCounts:input_type -> pbcs.ListTemplateRevisionBoundCountsReq
	148, // 127: pbcs.Config.ListTemplateSetBoundCounts:input_type -> pbcs.ListTemplateSetBoundCountsReq
	150, // 128: pbcs.Config.ListTemplateBoundUnnamedAppDetails:input_type -> pbcs.ListTemplateBoundUnnamedAppDetailsReq
	152, // 129: pbcs.Config.ListTemplateBoundNamedAppDetails:input_type -> pbcs.ListTemplateBoundNamedAppDetailsReq
	154, // 130: pbcs.Config.ListTemplateBoundTemplateSetDetails:input_type -> pbcs.ListTemplateBoundTemplateSetDetailsReq
	156, // 131: pbcs.Config.ListMultiTemplateBoundTemplateSetDetails:input_type -> pbcs.ListMultiTemplateBoundTemplateSetDetailsReq
	158, // 132: pbcs.Config.ListTemplateRevisionBoundUnnamedAppDetails:input_type -> pbcs.ListTemplateRevisionBoundUnnamedAppDetailsReq
	160, // 133: pbcs.Config.ListTemplateRevisionBoundNamedAppDetails:input_type -> pbcs.ListTemplateRevisionBoundNamedAppDetailsReq
	162, // 134: pbcs.Config.ListTemplateSetBoundUnnamedAppDetails:input_type -> pbcs.ListTemplateSetBoundUnnamedAppDetailsReq
	164, // 135: pbcs.Config.ListMultiTemplateSetBoundUnnamedAppDetails:input_type -> pbcs.ListMultiTemplateSetBoundUnnamedAppDetailsReq
	166, // 136: pbcs.Config.ListTemplateSetBoundNamedAppDetails:input_type -> pbcs.ListTemplateSetBoundNamedAppDetailsReq
	168, // 137: pbcs.Config.CreateTemplateVariable:input_type -> pbcs.CreateTemplateVariableReq
	172, // 138: pbcs.Config.DeleteTemplateVariable:input_type -> pbcs.DeleteTemplateVariableReq
	170, // 139: pbcs.Config.UpdateTemplateVariable:input_type -> pbcs.UpdateTemplateVariableReq
	174, // 140: pbcs.Config.ListTemplateVariables:input_type -> pbcs.ListTemplateVariablesReq
	176, // 141: pbcs.Config.CreateGroup:input_type -> pbcs.CreateGroupReq
	180, // 142: pbcs.Config.DeleteGroup:input_type -> pbcs.DeleteGroupReq
	178, // 143: pbcs.Config.UpdateGroup:input_type -> pbcs.UpdateGroupReq
	182, // 144: pbcs.Config.ListAllGroups:input_type -> pbcs.ListAllGroupsReq
	184, // 145: pbcs.Config.ListAppGroups:input_type -> pbcs.ListAppGroupsReq
	186, // 146: pbcs.Config.ListGroupReleasedApps:input_type -> pbcs.ListGroupReleasedAppsReq
	188, // 147: pbcs.Config.Publish:input_type -> pbcs.PublishReq
	189, // 148: pbcs.Config.GenerateReleaseAndPublish:input_type -> pbcs.GenerateReleaseAndPublishReq
	12,  // 149: pbcs.Config.CreateCredentials:input_type -> pbcs.CreateCredentialReq
	10,  // 150: pbcs.Config.ListCredentials:input_type -> pbcs.ListCredentialsReq
	6,   // 151: pbcs.Config.DeleteCredential:input_type -> pbcs.DeleteCredentialsReq
	8,   // 152: pbcs.Config.UpdateCredential:input_type -> pbcs.UpdateCredentialsReq
	2,   // 153: pbcs.Config.ListCredentialScopes:input_type -> pbcs.ListCredentialScopesReq
	0,   // 154: pbcs.Config.UpdateCredentialScope:input_type -> pbcs.UpdateCredentialScopeReq
	15,  // 155: pbcs.Config.CreateApp:output_type -> pbcs.CreateAppResp
	17,  // 156: pbcs.Config.UpdateApp:output_type -> pbcs.UpdateAppResp
	19,  // 157: pbcs.Config.DeleteApp:output_type -> pbcs.DeleteAppResp
	201, // 158: pbcs.Config.GetApp:output_type -> pbapp.App
	201, // 159: pbcs.Config.GetAppByName:output_type -> pbapp.App
	24,  // 160: pbcs.Config.ListAppsRest:output_type -> pbcs.ListAppsResp
	24,  // 161: pbcs.Config.ListAppsBySpaceRest:output_type -> pbcs.ListAppsResp
	28,  // 162: pbcs.Config.CreateConfigItem:output_type -> pbcs.CreateConfigItemResp
	27,  // 163: pbcs.Config.BatchUpsertConfigItems:output_type -> pbcs.BatchUpsertConfigItemsResp
	30,  // 164: pbcs.Config.UpdateConfigItem:output_type -> pbcs.UpdateConfigItemResp
	32,  // 165: pbcs.Config.DeleteConfigItem:output_type -> pbcs.DeleteConfigItemResp
	34,  // 166: pbcs.Config.GetConfigItem:output_type -> pbcs.GetConfigItemResp
	36,  // 167: pbcs.Config.ListConfigItems:output_type -> pbcs.ListConfigItemsResp
	38,  // 168: pbcs.Config.ListConfigItemCount:output_type -> pbcs.ListConfigItemCountResp
	42,  // 169: pbcs.Config.UpdateConfigHook:output_type -> pbcs.UpdateConfigHookResp
	44,  // 170: pbcs.Config.GetConfigHook:output_type -> pbcs.GetConfigHookResp
	46,  // 171: pbcs.Config.CreateRelease:output_type -> pbcs.CreateReleaseResp
	48,  // 172: pbcs.Config.ListReleases:output_type -> pbcs.ListReleasesResp
	50,  // 173: pbcs.Config.CreateHook:output_type -> pbcs.CreateHookResp
	52,  // 174: pbcs.Config.DeleteHook:output_type -> pbcs.DeleteHookResp
	54,  // 175: pbcs.Config.ListHooks:output_type -> pbcs.ListHooksResp
	56,  // 176: pbcs.Config.ListHookTags:output_type -> pbcs.ListHookTagsResp
	66,  // 177: pbcs.Config.GetHook:output_type -> pbcs.GetHookResp
	58,  // 178: pbcs.Config.CreateHookRelease:output_type -> pbcs.CreateHookReleaseResp
	60,  // 179: pbcs.Config.ListHookRelease:output_type -> pbcs.ListHookReleaseResp
	62,  // 180: pbcs.Config.DeleteHookRelease:output_type -> pbcs.DeleteHookReleaseResp
	64,  // 181: pbcs.Config.PublishHookRelease:output_type -> pbcs.PublishHookReleaseResp
	209, // 182: pbcs.Config.GetHookRelease:output_type -> pbhr.HookRelease
	70,  // 183: pbcs.Config.UpdateHookRelease:output_type -> pbcs.UpdateHookReleaseResp
	72,  // 184: pbcs.Config.ListHookReleasesReferences:output_type -> pbcs.ListHookReleasesReferencesResp
	74,  // 185: pbcs.Config.CreateTemplateSpace:output_type -> pbcs.CreateTemplateSpaceResp
	78,  // 186: pbcs.Config.DeleteTemplateSpace:output_type -> pbcs.DeleteTemplateSpaceResp
	76,  // 187: pbcs.Config.UpdateTemplateSpace:output_type -> pbcs.UpdateTemplateSpaceResp
	80,  // 188: pbcs.Config.ListTemplateSpaces:output_type -> pbcs.ListTemplateSpacesResp
	81,  // 189: pbcs.Config.GetAllBizsOfTemplateSpaces:output_type -> pbcs.GetAllBizsOfTemplateSpacesResp
	83,  // 190: pbcs.Config.CreateDefaultTemplateSpace:output_type -> pbcs.CreateDefaultTemplateSpaceResp
	85,  // 191: pbcs.Config.ListTemplateSpacesByIDs:output_type -> pbcs.ListTemplateSpacesByIDsResp
	87,  // 192: pbcs.Config.CreateTemplate:output_type -> pbcs.CreateTemplateResp
	91,  // 193: pbcs.Config.DeleteTemplate:output_type -> pbcs.DeleteTemplateResp
	93,  // 194: pbcs.Config.BatchDeleteTemplate:output_type -> pbcs.BatchDeleteTemplateResp
	89,  // 195: pbcs.Config.UpdateTemplate:output_type -> pbcs.UpdateTemplateResp
	95,  // 196: pbcs.Config.ListTemplates:output_type -> pbcs.ListTemplatesResp
	97,  // 197: pbcs.Config.AddTemplatesToTemplateSets:output_type -> pbcs.AddTemplatesToTemplateSetsResp
	99,  // 198: pbcs.Config.DeleteTemplatesFromTemplateSets:output_type -> pbcs.DeleteTemplatesFromTemplateSetsResp
	101, // 199: pbcs.Config.ListTemplatesByIDs:output_type -> pbcs.ListTemplatesByIDsResp
	103, // 200: pbcs.Config.ListTemplatesNotBound:output_type -> pbcs.ListTemplatesNotBoundResp
	105, // 201: pbcs.Config.ListTemplatesOfTemplateSet:output_type -> pbcs.ListTemplatesOfTemplateSetResp
	107, // 202: pbcs.Config.CreateTemplateRevision:output_type -> pbcs.CreateTemplateRevisionResp
	109, // 203: pbcs.Config.ListTemplateRevisions:output_type -> pbcs.ListTemplateRevisionsResp
	111, // 204: pbcs.Config.DeleteTemplateRevision:output_type -> pbcs.DeleteTemplateRevisionResp
	113, // 205: pbcs.Config.ListTemplateRevisionsByIDs:output_type -> pbcs.ListTemplateRevisionsByIDsResp
	115, // 206: pbcs.Config.ListTemplateRevisionNamesByTemplateIDs:output_type -> pbcs.ListTemplateRevisionNamesByTemplateIDsResp
	117, // 207: pbcs.Config.CreateTemplateSet:output_type -> pbcs.CreateTemplateSetResp
	121, // 208: pbcs.Config.DeleteTemplateSet:output_type -> pbcs.DeleteTemplateSetResp
	119, // 209: pbcs.Config.UpdateTemplateSet:output_type -> pbcs.UpdateTemplateSetResp
	123, // 210: pbcs.Config.ListTemplateSets:output_type -> pbcs.ListTemplateSetsResp
	125, // 211: pbcs.Config.ListAppTemplateSets:output_type -> pbcs.ListAppTemplateSetsResp
	127, // 212: pbcs.Config.ListTemplateSetsByIDs:output_type -> pbcs.ListTemplateSetsByIDsResp
	129, // 213: pbcs.Config.ListTemplateSetsOfBiz:output_type -> pbcs.ListTemplateSetsOfBizResp
	131, // 214: pbcs.Config.CreateAppTemplateBinding:output_type -> pbcs.CreateAppTemplateBindingResp
	135, // 215: pbcs.Config.DeleteAppTemplateBinding:output_type -> pbcs.DeleteAppTemplateBindingResp
	133, // 216: pbcs.Config.UpdateAppTemplateBinding:output_type -> pbcs.UpdateAppTemplateBindingResp
	137, // 217: pbcs.Config.ListAppTemplateBindings:output_type -> pbcs.ListAppTemplateBindingsResp
	139, // 218: pbcs.Config.ListAppBoundTemplateRevisions:output_type -> pbcs.ListAppBoundTemplateRevisionsResp
	141, // 219: pbcs.Config.UpdateAppBoundTemplateRevisions:output_type -> pbcs.UpdateAppBoundTemplateRevisionsResp
	143, // 220: pbcs.Config.DeleteAppBoundTemplateSets:output_type -> pbcs.DeleteAppBoundTemplateSetsResp
	145, // 221: pbcs.Config.ListTemplateBoundCounts:output_type -> pbcs.ListTemplateBoundCountsResp
	147, // 222: pbcs.Config.ListTemplateRevisionBoundCounts:output_type -> pbcs.ListTemplateRevisionBoundCountsResp
	149, // 223: pbcs.Config.ListTemplateSetBoundCounts:output_type -> pbcs.ListTemplateSetBoundCountsResp
	151, // 224: pbcs.Config.ListTemplateBoundUnnamedAppDetails:output_type -> pbcs.ListTemplateBoundUnnamedAppDetailsResp
	153, // 225: pbcs.Config.ListTemplateBoundNamedAppDetails:output_type -> pbcs.ListTemplateBoundNamedAppDetailsResp
	155, // 226: pbcs.Config.ListTemplateBoundTemplateSetDetails:output_type -> pbcs.ListTemplateBoundTemplateSetDetailsResp
	157, // 227: pbcs.Config.ListMultiTemplateBoundTemplateSetDetails:output_type -> pbcs.ListMultiTemplateBoundTemplateSetDetailsResp
	159, // 228: pbcs.Config.ListTemplateRevisionBoundUnnamedAppDetails:output_type -> pbcs.ListTemplateRevisionBoundUnnamedAppDetailsResp
	161, // 229: pbcs.Config.ListTemplateRevisionBoundNamedAppDetails:output_type -> pbcs.ListTemplateRevisionBoundNamedAppDetailsResp
	163, // 230: pbcs.Config.ListTemplateSetBoundUnnamedAppDetails:output_type -> pbcs.ListTemplateSetBoundUnnamedAppDetailsResp
	165, // 231: pbcs.Config.ListMultiTemplateSetBoundUnnamedAppDetails:output_type -> pbcs.ListMultiTemplateSetBoundUnnamedAppDetailsResp
	167, // 232: pbcs.Config.ListTemplateSetBoundNamedAppDetails:output_type -> pbcs.ListTemplateSetBoundNamedAppDetailsResp
	169, // 233: pbcs.Config.CreateTemplateVariable:output_type -> pbcs.CreateTemplateVariableResp
	173, // 234: pbcs.Config.DeleteTemplateVariable:output_type -> pbcs.DeleteTemplateVariableResp
	171, // 235: pbcs.Config.UpdateTemplateVariable:output_type -> pbcs.UpdateTemplateVariableResp
	175, // 236: pbcs.Config.ListTemplateVariables:output_type -> pbcs.ListTemplateVariablesResp
	177, // 237: pbcs.Config.CreateGroup:output_type -> pbcs.CreateGroupResp
	181, // 238: pbcs.Config.DeleteGroup:output_type -> pbcs.DeleteGroupResp
	179, // 239: pbcs.Config.UpdateGroup:output_type -> pbcs.UpdateGroupResp
	183, // 240: pbcs.Config.ListAllGroups:output_type -> pbcs.ListAllGroupsResp
	185, // 241: pbcs.Config.ListAppGroups:output_type -> pbcs.ListAppGroupsResp
	187, // 242: pbcs.Config.ListGroupReleasedApps:output_type -> pbcs.ListGroupReleasedAppsResp
	191, // 243: pbcs.Config.Publish:output_type -> pbcs.PublishResp
	191, // 244: pbcs.Config.GenerateReleaseAndPublish:output_type -> pbcs.PublishResp
	13,  // 245: pbcs.Config.CreateCredentials:output_type -> pbcs.CreateCredentialResp
	11,  // 246: pbcs.Config.ListCredentials:output_type -> pbcs.ListCredentialsResp
	7,   // 247: pbcs.Config.DeleteCredential:output_type -> pbcs.DeleteCredentialsResp
	9,   // 248: pbcs.Config.UpdateCredential:output_type -> pbcs.UpdateCredentialsResp
	3,   // 249: pbcs.Config.ListCredentialScopes:output_type -> pbcs.ListCredentialScopesResp
	1,   // 250: pbcs.Config.UpdateCredentialScope:output_type -> pbcs.UpdateCredentialScopeResp
