...
// ListStrategiesOption defines options to list strategy.
type ListStrategiesOption struct {
...
// Validate the list strategy options
func (opt *ListStrategiesOption) Validate(po *PageOption) error {
	if opt.BizID <= 0 {
...
// ListStrategyDetails defines the response details of requested ListStrategiesOption.
type ListStrategyDetails struct {
	Count   uint32            `json:"count"`
	Details []*table.Strategy `json:"details"`
}
