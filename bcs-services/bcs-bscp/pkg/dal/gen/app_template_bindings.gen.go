...
func newAppTemplateBinding(db *gorm.DB, opts ...gen.DOOption) appTemplateBinding {
	...
	_appTemplateBinding.TemplateReleaseIDs = field.NewField(tableName, "template_release_ids")
...
func (a *appTemplateBinding) updateTableName(table string) *appTemplateBinding {
	...
	a.TemplateReleaseIDs = field.NewField(table, "template_release_ids")
...
func (a *appTemplateBinding) fillFieldMap() {
	...
	a.fieldMap["template_release_ids"] = a.TemplateReleaseIDs
