...
func newApp(db *gorm.DB, opts ...gen.DOOption) app {
	...
	_app.PreHookID = field.NewUint32(tableName, "pre_hook_id")
	_app.PreHookReleaseID = field.NewUint32(tableName, "pre_hook_release_id")
	_app.PostHookID = field.NewUint32(tableName, "post_hook_id")
	_app.PostHookReleaseID = field.NewUint32(tableName, "post_hook_release_id")
...
func (a *app) updateTableName(table string) *app {
	...
	a.PreHookID = field.NewUint32(table, "pre_hook_id")
	a.PreHookReleaseID = field.NewUint32(table, "pre_hook_release_id")
	a.PostHookID = field.NewUint32(table, "post_hook_id")
	a.PostHookReleaseID = field.NewUint32(table, "post_hook_release_id")
...
func (a *app) fillFieldMap() {
	...
	a.fieldMap["pre_hook_id"] = a.PreHookID
	a.fieldMap["pre_hook_release_id"] = a.PreHookReleaseID
	a.fieldMap["post_hook_id"] = a.PostHookID
	a.fieldMap["post_hook_release_id"] = a.PostHookReleaseID
