...
func (a authorizer) Authorize(kt *kit.Kit, resources ...*meta.ResourceAttribute) error {
	...
	if err != nil {
		...
		return errf.New(errf.DoAuthorizeFailed, i18n.T(kt, "get permission to apply failed"))
	}
	...
	if err != nil {
		...
		return errf.New(errf.PermissionDenied, i18n.T(kt, "grpc status with details failed"))
	}
	return st.Err()
}
