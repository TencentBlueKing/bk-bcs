...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=clb.bmsf.tencent.com, Version=v1
	case v1.SchemeGroupVersion.WithResource("clbingresses"):
		...
		// Group=mesh.bmsf.tencent.com, Version=v1
	case mesh_v1.SchemeGroupVersion.WithResource("appnodes"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Mesh().V1().AppNodes().Informer()}, nil
	case mesh_v1.SchemeGroupVersion.WithResource("appsvcs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Mesh().V1().AppSvcs().Informer()}, nil

		// Group=network.bmsf.tencent.com, Version=v1
	case network_v1.SchemeGroupVersion.WithResource("cloudlisteners"):
