...
func TestIng(t *testing.T) {
	...
	manifest, _ := example.LoadDemoManifest(ctx, "network/simple_ingress", "", "", resCsts.Ing)
	...
	assert.Equal(t, "IngressList", mapx.GetStr(respData, "manifest.kind"))
	...
	assert.Equal(t, "Ingress", mapx.GetStr(respData, "manifest.kind"))
