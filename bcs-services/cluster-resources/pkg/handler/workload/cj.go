...
func (h *Handler) ListCJ(
	...
	resp.Data, err = resAction.NewResMgr(req.ClusterID, req.ApiVersion, resCsts.CJ).List(
...
func (h *Handler) GetCJ(
	...
	resp.Data, err = resAction.NewResMgr(req.ClusterID, req.ApiVersion, resCsts.CJ).Get(
...
func (h *Handler) CreateCJ(
	...
	resp.Data, err = resAction.NewResMgr(req.ClusterID, "", resCsts.CJ).Create(
...
func (h *Handler) UpdateCJ(
	...
	resp.Data, err = resAction.NewResMgr(req.ClusterID, "", resCsts.CJ).Update(
...
func (h *Handler) DeleteCJ(
	...
	return resAction.NewResMgr(req.ClusterID, "", resCsts.CJ).Delete(
