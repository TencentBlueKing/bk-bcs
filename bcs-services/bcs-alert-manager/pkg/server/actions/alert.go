...
func (ac *AlertAction) CreateBusinessAlertInfo(ctx context.Context, req *alertmanager.CreateBusinessAlertInfoReq, resp *alertmanager.CreateBusinessAlertInfoResp) {
	...
	case alert.Resource:
		alertData.Labels = map[string]string{
			string(alert.AlarmLabelsAlertType):         req.ResourceAlertLabel.CommonLabel.AlarmType,
			string(alert.AlarmLabelsClusterID):         req.ResourceAlertLabel.CommonLabel.ClusterID,
	...
	case alert.Module:
		alertData.Labels = map[string]string{
			string(alert.AlarmLabelsAlertType):  req.ModuleAlertLabel.CommonLabel.AlarmType,
			string(alert.AlarmLabelsClusterID):  req.ModuleAlertLabel.CommonLabel.ClusterID,
