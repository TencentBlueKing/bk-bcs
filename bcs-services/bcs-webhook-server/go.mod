...
replace (
	...
	github.com/Tencent/bk-bcs/bcs-runtime/bcs-k8s/bcs-component/bcs-gamedeployment-operator => ../../bcs-runtime/bcs-k8s/bcs-component/bcs-gamedeployment-operator
	github.com/Tencent/bk-bcs/bcs-runtime/bcs-k8s/bcs-component/bcs-gamestatefulset-operator => ../../bcs-runtime/bcs-k8s/bcs-component/bcs-gamestatefulset-operator
	github.com/Tencent/bk-bcs/bcs-runtime/bcs-k8s/kubernetes/common => ../../bcs-runtime/bcs-k8s/kubernetes/common
...
require (
	...
	github.com/Tencent/bk-bcs/bcs-k8s/bcs-gamedeployment-operator v0.0.0-20211020081756-b0c6bdef9dcb // indirect
