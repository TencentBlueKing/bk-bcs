...
// GetBusinessResp represents the response for get business
type GetBusinessResp struct {
	CommonResp
	Data GetBusinessRespData `json:"data"`
}

// GetBusinessRespData defines the data structure for gett business information.
type GetBusinessRespData struct {
	Count int64                      `json:"count"`
	Info  *[]GetBusinessRespDataInfo `json:"info"`
}

// GetBusinessRespDataInfo defines the data structure for gett business information.
type GetBusinessRespDataInfo struct {
