...
// DeleteAllByBkBizIDAndBkClusterIDReq delete all data by bk_biz_id and bk_cluster_id request
type DeleteAllByBkBizIDAndBkClusterIDReq struct {
	BkBizID     int64   `json:"bkBizID"`
	BkClusterID []int64 `json:"bkClusterID"`
}
...
func DeleteAllByBkBizIDAndBkClusterID(ctx context.Context, req *DeleteAllByBkBizIDAndBkClusterIDReq) (*bool, error) {
	cmdbClient := cmdb.New()
