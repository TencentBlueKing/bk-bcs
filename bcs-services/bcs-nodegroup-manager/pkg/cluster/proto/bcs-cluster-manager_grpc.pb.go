...
type ClusterManagerClient interface {
	...
	ListClusterNodeGroup(ctx context.Context, in *ListClusterNodeGroupRequest, opts ...grpc.CallOption) (*ListNodeGroupResponse, error)
...
func (c *clusterManagerClient) ListClusterNodeGroup(ctx context.Context, in *ListClusterNodeGroupRequest, opts ...grpc.CallOption) (*ListNodeGroupResponse, error) {
...
func (UnimplementedClusterManagerServer) ListClusterNodeGroup(context.Context, *ListClusterNodeGroupRequest) (*ListNodeGroupResponse, error) {
...
var ClusterManager_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "bcs-cluster-manager.proto",
}
