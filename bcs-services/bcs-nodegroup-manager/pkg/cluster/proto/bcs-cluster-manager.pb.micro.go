...
type ClusterManagerService interface {
	...
	ListClusterNodeGroup(ctx context.Context, in *ListClusterNodeGroupRequest, opts ...client.CallOption) (*ListNodeGroupResponse, error)
...
func (c *clusterManagerService) ListClusterNodeGroup(ctx context.Context, in *ListClusterNodeGroupRequest, opts ...client.CallOption) (*ListNodeGroupResponse, error) {
...
type ClusterManagerHandler interface {
	...
	ListClusterNodeGroup(context.Context, *ListClusterNodeGroupRequest, *ListNodeGroupResponse) error
...
func RegisterClusterManagerHandler(s server.Server, hdlr ClusterManagerHandler, opts ...server.HandlerOption) error {
	type clusterManager interface {
		...
		ListClusterNodeGroup(ctx context.Context, in *ListClusterNodeGroupRequest, out *ListNodeGroupResponse) error
...
func (h *clusterManagerHandler) ListClusterNodeGroup(ctx context.Context, in *ListClusterNodeGroupRequest, out *ListNodeGroupResponse) error {
