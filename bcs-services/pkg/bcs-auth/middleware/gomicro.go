...
type GoMicroAuth struct {
	...
	checkUserPerm func(ctx context.Context, req server.Request, user UserInfo) (bool, error)
...
func (g *GoMicroAuth) SetCheckUserPerm(checkUserPerm func(ctx context.Context,
	req server.Request, user UserInfo) (bool, error)) *GoMicroAuth {
...
func (g *GoMicroAuth) AuthorizationFunc(fn server.HandlerFunc) server.HandlerFunc {
	return func(ctx context.Context, req server.Request, rsp interface{}) (err error) {
		...
		if allow, err := g.checkUserPerm(ctx, req, UserInfo{
