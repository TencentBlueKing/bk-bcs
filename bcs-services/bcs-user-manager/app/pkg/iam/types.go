...
const (
	...
	// IamAppCodeHeader app-code
	IamAppCodeHeader = "X-Bk-App-Code"
	// IamAppSecretHeader app-secret
	IamAppSecretHeader = "X-Bk-App-Secret"

	// SystemIDBKBCS systemID
	SystemIDBKBCS = "bk_bcs_app"
	// SystemNameBKBCSEn system english name
	SystemNameBKBCSEn = "BlueKing Container Service"
	// SystemNameBKBCS system name
	SystemNameBKBCS = "容器管理平台"
...
// ClusterScope/NameSpace/NameSpaceScope Resource Action
const (
