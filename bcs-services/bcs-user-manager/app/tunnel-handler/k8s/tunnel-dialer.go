...
func (f *TunnelProxyDispatcher) wsTunnelChanged(clusterId string, credentials *models.BcsWsClusterCredentials) bool {
...
func (f *TunnelProxyDispatcher) getTransport(clusterId string, credentials *models.BcsWsClusterCredentials) http.RoundTripper {
