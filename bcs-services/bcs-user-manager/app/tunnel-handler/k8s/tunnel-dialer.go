...
func lookupWsHandler(clusterId string) (*proxy.UpgradeAwareHandler, bool, error) {
...
func getTransport(clusterId string, credentials *models.BcsWsClusterCredentials) http.RoundTripper {
	tp := &http.Transport{}
