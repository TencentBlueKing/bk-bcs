...
const (
	...
	HelmManager_UploadChart_FullMethodName          = "/helmmanager.HelmManager/UploadChart"
	...
	HelmManager_GetReleaseManifest_FullMethodName   = "/helmmanager.HelmManager/GetReleaseManifest"
	...
	HelmManager_ImportClusterRelease_FullMethodName = "/helmmanager.HelmManager/ImportClusterRelease"
)
...
func (c *helmManagerClient) UploadChart(ctx context.Context, in *UploadChartReq, opts ...grpc.CallOption) (*UploadChartResp, error) {
	...
	err := c.cc.Invoke(ctx, HelmManager_UploadChart_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helmManagerClient) GetReleaseManifest(ctx context.Context, in *GetReleaseManifestReq, opts ...grpc.CallOption) (*GetReleaseManifestResp, error) {
	...
	err := c.cc.Invoke(ctx, HelmManager_GetReleaseManifest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helmManagerClient) ImportClusterRelease(ctx context.Context, in *ImportClusterReleaseReq, opts ...grpc.CallOption) (*ImportClusterReleaseResp, error) {
	...
	err := c.cc.Invoke(ctx, HelmManager_ImportClusterRelease_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelmManagerServer) UploadChart(context.Context, *UploadChartReq) (*UploadChartResp, error) {
...
func (UnimplementedHelmManagerServer) GetReleaseManifest(context.Context, *GetReleaseManifestReq) (*GetReleaseManifestResp, error) {
...
func (UnimplementedHelmManagerServer) ImportClusterRelease(context.Context, *ImportClusterReleaseReq) (*ImportClusterReleaseResp, error) {
...
func _HelmManager_UploadChart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelmManager_UploadChart_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HelmManager_GetReleaseManifest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelmManager_GetReleaseManifest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HelmManager_ImportClusterRelease_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HelmManager_ImportClusterRelease_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
