...
var uninstallV1CMD = &cobra.Command{
	Use:   "uninstallv1",
	Short: "uninstallv1",
	Long:  "uninstallv1 chart release",
	Run:   UninstallV1,
}

// UninstallV1 provide the actions to do uninstallV1CMD
func UninstallV1(cmd *cobra.Command, args []string) {
	if len(args) < 1 {
	...
	if err := c.Release().UninstallV1(cmd.Context(), req); err != nil {
...
func init() {
	uninstallV1CMD.PersistentFlags().StringVarP(
