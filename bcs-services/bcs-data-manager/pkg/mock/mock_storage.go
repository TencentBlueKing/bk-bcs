...
func (m *MockStorage) QueryK8sHPA(cluster, namespace string) ([]*storage.Hpa, error) {
	rawHPAList := []byte("{\"result\":true,\"code\":0,\"message\":\"success\",\"data\":[{\"namespace\":\"bcs-system\",\"createTime\":\"2022-06-06T06:45:43.321Z\",\"clusterId\":\"BCS-K8S-90000\",\"resourceName\":\"bcs-storage\",\"updateTime\":\"2022-06-06T12:23:07.528Z\",\"resourceType\":\"HorizontalPodAutoscaler\",\"data\":{\"spec\":{\"minReplicas\":2,\"scaleTargetRef\":{\"name\":\"bcs-storage\",\"apiVersion\":\"apps/v1\",\"kind\":\"Deployment\"},\"targetCPUUtilizationPercentage\":50,\"maxReplicas\":3},\"status\":{\"currentReplicas\":2,\"desiredReplicas\":0},\"metadata\":{\"uid\":\"d3d9d584-2ef7-4092-b872-dfcbc94a32df\",\"annotations\":{\"kubectl.kubernetes.io/last-applied-configuration\":\"{\\\"apiVersion\\\":\\\"autoscaling/v2beta1\\\",\\\"kind\\\":\\\"HorizontalPodAutoscaler\\\",\\\"metadata\\\":{\\\"annotations\\\":{},\\\"name\\\":\\\"bcs-storage\\\",\\\"namespace\\\":\\\"bcs-system\\\"},\\\"spec\\\":{\\\"maxReplicas\\\":3,\\\"metrics\\\":[{\\\"resource\\\":{\\\"name\\\":\\\"memory\\\",\\\"targetAverageUtilization\\\":50},\\\"type\\\":\\\"Resource\\\"},{\\\"resource\\\":{\\\"name\\\":\\\"cpu\\\",\\\"targetAverageUtilization\\\":50},\\\"type\\\":\\\"Resource\\\"}],\\\"minReplicas\\\":2,\\\"scaleTargetRef\\\":{\\\"apiVersion\\\":\\\"apps/v1\\\",\\\"kind\\\":\\\"Deployment\\\",\\\"name\\\":\\\"bcs-storage\\\"}}}\\n\",\"autoscaling.alpha.kubernetes.io/conditions\":\"[{\\\"type\\\":\\\"AbleToScale\\\",\\\"status\\\":\\\"True\\\",\\\"lastTransitionTime\\\":\\\"2022-06-06T06:45:59Z\\\",\\\"reason\\\":\\\"SucceededGetScale\\\",\\\"message\\\":\\\"the HPA controller was able to get the target's current scale\\\"},{\\\"type\\\":\\\"ScalingActive\\\",\\\"status\\\":\\\"False\\\",\\\"lastTransitionTime\\\":\\\"2022-06-06T06:45:59Z\\\",\\\"reason\\\":\\\"FailedGetResourceMetric\\\",\\\"message\\\":\\\"the HPA was unable to compute the replica count: unable to get metrics for resource memory: unable to fetch metrics from resource metrics API: the server could not find the requested resource (get pods.metrics.k8s.io)\\\"}]\",\"autoscaling.alpha.kubernetes.io/metrics\":\"[{\\\"type\\\":\\\"Resource\\\",\\\"resource\\\":{\\\"name\\\":\\\"memory\\\",\\\"targetAverageUtilization\\\":50}}]\"},\"creationTimestamp\":\"2022-06-06T06:45:43Z\",\"name\":\"bcs-storage\",\"namespace\":\"bcs-system\",\"resourceVersion\":\"348638467\",\"selfLink\":\"/apis/autoscaling/v1/namespaces/bcs-system/horizontalpodautoscalers/bcs-storage\"}},\"_id\":\"629d7d5a214efacd2b2e5987\"}]}")
	basicRsp := &bcsapi.BasicResponse{}
	json.Unmarshal(rawHPAList, basicRsp)
	var hpaList []*storage.Hpa
	json.Unmarshal(basicRsp.Data, &hpaList)
	m.On("QueryK8sHPA").Return(hpaList, nil)
	args := m.Called()
	return args.Get(0).([]*storage.Hpa), args.Error(1)
}

func (m *MockStorage) QueryK8sGPA(cluster, namespace string) ([]*storage.Gpa, error) {
	rawGPAList := []byte("{\"result\":true,\"code\":0,\"message\":\"success\",\"data\":[{\"createTime\":\"2022-06-06T09:42:54.307Z\",\"updateTime\":\"2022-06-06T12:23:07.503Z\",\"data\":{\"status\":{\"currentReplicas\":2,\"desiredReplicas\":0,\"conditions\":[{\"type\":\"AbleToScale\",\"lastTransitionTime\":\"2022-06-06T09:15:56Z\",\"message\":\"the GPA controller was able to get the target's current scale\",\"reason\":\"SucceededGetScale\",\"status\":\"True\"},{\"type\":\"ScalingActive\",\"lastTransitionTime\":\"2022-06-06T09:15:56Z\",\"message\":\"the GPA was unable to compute the replica count: unable to get metrics for resource cpu: unable to fetch metrics from resource metrics API: the server could not find the requested resource (get pods.metrics.k8s.io)\",\"reason\":\"FailedGetResourceMetric\",\"status\":\"False\"}]},\"apiVersion\":\"autoscaling.tkex.tencent.com/v1alpha1\",\"kind\":\"GeneralPodAutoscaler\",\"metadata\":{\"creationTimestamp\":\"2022-06-06T09:15:26Z\",\"labels\":{\"app.kubernetes.io/platform\":\"bk-bcs\",\"app.kubernetes.io/instance\":\"bcs-storage\",\"app.kubernetes.io/name\":\"bcs-storage\"},\"selfLink\":\"/apis/autoscaling.tkex.tencent.com/v1alpha1/namespaces/bcs-system/generalpodautoscalers/bcs-storage\",\"generation\":1,\"namespace\":\"bcs-system\",\"annotations\":{\"kubectl.kubernetes.io/last-applied-configuration\":\"{\\\"apiVersion\\\":\\\"autoscaling.tkex.tencent.com/v1alpha1\\\",\\\"kind\\\":\\\"GeneralPodAutoscaler\\\",\\\"metadata\\\":{\\\"annotations\\\":{},\\\"name\\\":\\\"bcs-storage\\\",\\\"namespace\\\":\\\"bcs-system\\\"},\\\"spec\\\":{\\\"maxReplicas\\\":3,\\\"metric\\\":{\\\"metrics\\\":[{\\\"resource\\\":{\\\"name\\\":\\\"cpu\\\",\\\"target\\\":{\\\"averageValue\\\":50,\\\"type\\\":\\\"AverageValue\\\"}},\\\"type\\\":\\\"Resource\\\"}]},\\\"minReplicas\\\":2,\\\"scaleTargetRef\\\":{\\\"apiVersion\\\":\\\"apps/v1\\\",\\\"kind\\\":\\\"Deployment\\\",\\\"name\\\":\\\"bcs-storage\\\"}}}\\n\"},\"name\":\"bcs-storage\",\"resourceVersion\":\"348707686\",\"uid\":\"7996c565-2506-46ad-a9ea-19b639e214ce\"},\"spec\":{\"minReplicas\":2,\"scaleTargetRef\":{\"kind\":\"Deployment\",\"name\":\"bcs-storage\",\"apiVersion\":\"apps/v1\"},\"maxReplicas\":3,\"metric\":{\"metrics\":[{\"resource\":{\"name\":\"cpu\",\"target\":{\"averageValue\":\"50\",\"type\":\"AverageValue\"}},\"type\":\"Resource\"}]}}},\"_id\":\"629dcc1e214efacd2b540979\",\"resourceType\":\"GeneralPodAutoscaler\",\"clusterId\":\"BCS-K8S-90000\",\"namespace\":\"bcs-system\",\"resourceName\":\"bcs-storage\"}]}")
	basicRsp := &bcsapi.BasicResponse{}
	json.Unmarshal(rawGPAList, basicRsp)
	var gpaList []*storage.Gpa
	json.Unmarshal(basicRsp.Data, &gpaList)
	m.On("QueryK8sGPA").Return(gpaList, nil)
	args := m.Called()
	return args.Get(0).([]*storage.Gpa), args.Error(1)
}
