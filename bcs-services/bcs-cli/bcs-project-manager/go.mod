...
// from golang version 1.20
replace k8s.io/client-go => k8s.io/client-go v0.28.8

require (
	github.com/Tencent/bk-bcs/bcs-common v0.0.0-20231206103142-ffe83641df7a
	github.com/Tencent/bk-bcs/bcs-services/bcs-cluster-manager v0.0.0-20231206103142-ffe83641df7a
	github.com/Tencent/bk-bcs/bcs-services/bcs-project-manager v0.0.0-20231206103142-ffe83641df7a
