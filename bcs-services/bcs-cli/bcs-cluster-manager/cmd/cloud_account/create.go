...
func newCreateCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "create",
		Short: "create cloud account from bcs-cluster-manager",
		Run:   create,
	}

	cmd.Flags().StringVarP(&file, "file", "f", "./create_cloud_account.json", `create cloud account from json file. file template: 
	{"cloudID":"tencentCloud","accountName":"test001","desc":"腾讯云测试账号","account":{"secretID":"xxxxxxxxxx",
	"secretKey":"yyyyyyyyyy"},"enable":true,"creator":"bcs","projectID":"b363e23b1b354928xxxxxxxxxxxxxxx"}`)
