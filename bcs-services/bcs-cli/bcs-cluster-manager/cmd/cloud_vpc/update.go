...
func newUpdateCmd() *cobra.Command {
	...
	cmd.Flags().StringVarP(&file, "file", "f", "./update_cloud_vpc.json", `update cloud vpc from json file.
file template:{"cloudID":"tencentCloud","networkType":"overlay","region":"ap-guangzhou","regionName":"广州",
