...
//allClusterData :bcs cc request allCluster api data
...
//allMasterListData :bcs cc request allMaster api data
...
//versionConfigData :bcs cc request clusterConfig api data
...
// versionConfigure :versionConfigData.Creator
type versionConfigure struct {
	AreaID string `json:"area_id"`
	VpcID  string `json:"vpc_id"`
}

// clustersInfoData :bcs cc request project/cluster api data
...
// clustersInfoData :bcs cc request allNode api data
