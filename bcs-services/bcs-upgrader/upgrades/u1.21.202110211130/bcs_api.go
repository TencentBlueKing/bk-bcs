...
func createProject(project bcsProject, helper *upgrader.Helper) error {
...
func findProject(projectID string, helper *upgrader.Helper) (*bcsProject, error) {
...
func updateProject(project bcsProject, helper *upgrader.Helper) error {
...
func createClusters(clusters bcsReqCreateCluster, helper *upgrader.Helper) error {
...
func findCluster(clustersID string, helper *upgrader.Helper) (*bcsRespFindCluster, error) {
...
func updateCluster(data bcsReqUpdateCluster, helper *upgrader.Helper) error {
...
func createNode(data reqCreateNode, helper *upgrader.Helper) error {
...
func deleteNode(data reqDeleteNode, helper *upgrader.Helper) error {
	dataJson, err := json.Marshal(data)
	if err != nil {
		return err
	}
...
func findClusterNode(clustersID string, helper *upgrader.Helper) ([]bcsNodeListData, error) {
