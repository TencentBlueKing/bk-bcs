...
// ListVpcs list vpcs
func (vm *VPCManager) ListVpcs(vpcID string, opt *cloudprovider.CommonOption) ([]*cmproto.CloudVpc, error) {
...
func (vm *VPCManager) ListSubnets(vpcID string, zone string, opt *cloudprovider.CommonOption) ([]*cmproto.Subnet, error) {
...
func (vm *VPCManager) ListSecurityGroups(opt *cloudprovider.CommonOption) ([]*cmproto.SecurityGroup, error) {
	return nil, cloudprovider.ErrCloudNotImplemented
}
