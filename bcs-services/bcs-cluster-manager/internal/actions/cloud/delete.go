...
type DeleteAction struct {
	...
	req   *cmproto.DeleteCloudRequest
	resp  *cmproto.DeleteCloudResponse
}
...
func (da *DeleteAction) Handle(
	ctx context.Context, req *cmproto.DeleteCloudRequest, resp *cmproto.DeleteCloudResponse) {
	if req == nil || resp == nil {
	...
	if err != nil {
		...
		blog.Errorf("Get Cloud %s in pre-delete checking failed, err %s", da.req.CloudID, err.Error())
		return
	}
