...
type GetAction struct {
	...
	req   *cmproto.GetProjectRequest
	resp  *cmproto.GetProjectResponse
}
...
func (ga *GetAction) Handle(
	ctx context.Context, req *cmproto.GetProjectRequest, resp *cmproto.GetProjectResponse) {
	if req == nil || resp == nil {
		blog.Errorf("get project failed, req or resp is empty")
		return
	}
	ga.ctx = ctx
	ga.req = req
	...
	pro, err := ga.model.GetProject(ctx, req.ProjectID)
	if err != nil {
