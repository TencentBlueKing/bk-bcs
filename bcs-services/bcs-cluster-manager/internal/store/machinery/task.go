...
// ensure table
func (m *ModelMachineryTask) ensureTable(ctx context.Context) error {
...
func (m *ModelMachineryTask) GetTasksFieldDistinct(ctx context.Context, fieldName string, filter interface{}) ([]string, error) {
