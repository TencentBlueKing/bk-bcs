...
func NewClusterManagerEndpoints() []*api.Endpoint {
	return []*api.Endpoint{
		...
		{
			Name:    "ClusterManager.GetClusterUpgradeInfo",
			Path:    []string{"/clustermanager/v1/providers/{providerID}/upgradeinfo"},
			Method:  []string{"GET"},
			Handler: "rpc",
		},
		{
...
type ClusterManagerService interface {
	...
	GetClusterUpgradeInfo(ctx context.Context, in *GetClusterUpgradeInfoReq, opts ...client.CallOption) (*GetClusterUpgradeInfoResp, error)
	//* node management
...
func (c *clusterManagerService) GetClusterUpgradeInfo(ctx context.Context, in *GetClusterUpgradeInfoReq, opts ...client.CallOption) (*GetClusterUpgradeInfoResp, error) {
	req := c.c.NewRequest(c.name, "ClusterManager.GetClusterUpgradeInfo", in)
	out := new(GetClusterUpgradeInfoResp)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type ClusterManagerHandler interface {
	...
	GetClusterUpgradeInfo(context.Context, *GetClusterUpgradeInfoReq, *GetClusterUpgradeInfoResp) error
	//* node management
...
func RegisterClusterManagerHandler(s server.Server, hdlr ClusterManagerHandler, opts ...server.HandlerOption) error {
	type clusterManager interface {
		...
		GetClusterUpgradeInfo(ctx context.Context, in *GetClusterUpgradeInfoReq, out *GetClusterUpgradeInfoResp) error
...
func (h *clusterManagerHandler) GetClusterUpgradeInfo(ctx context.Context, in *GetClusterUpgradeInfoReq, out *GetClusterUpgradeInfoResp) error {
	return h.ClusterManagerHandler.GetClusterUpgradeInfo(ctx, in, out)
}
