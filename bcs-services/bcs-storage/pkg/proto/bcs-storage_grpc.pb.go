...
type StorageClient interface {
	...
	CleanClusterData(ctx context.Context, in *CleanClusterDataRequest, opts ...grpc.CallOption) (*CleanClusterDataResponse, error)
}
...
func (c *storageClient) CleanClusterData(ctx context.Context, in *CleanClusterDataRequest, opts ...grpc.CallOption) (*CleanClusterDataResponse, error) {
	out := new(CleanClusterDataResponse)
	err := c.cc.Invoke(ctx, "/storage.Storage/CleanClusterData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedStorageServer) CleanClusterData(context.Context, *CleanClusterDataRequest) (*CleanClusterDataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CleanClusterData not implemented")
}
...
func _Storage_CleanClusterData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CleanClusterDataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StorageServer).CleanClusterData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/storage.Storage/CleanClusterData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageServer).CleanClusterData(ctx, req.(*CleanClusterDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Storage_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CleanClusterData",
			Handler:    _Storage_CleanClusterData_Handler,
		},
	},
