...
type Config struct {
	...
	EndpointWatchPath []string `json:"endpoint_watch_path" value:"" usage:"this tells endpoint watch path on bcs_zookeeper 
                                like: \"storage:/endpoints/storage\" or \"check:/endpoints/check/*\", * means all nodes."` //no lint
