...
type Config struct {
	...
	TempDir           string   `json:"temp_dir" value:"./templates" usage:"the collector application templates directory"`	// the collector application template directory // nolint
	EndpointWatchPath []string `json:"endpoint_watch_path" value:"" usage:"this tells endpoint watch path on bcs_zookeeper like: \"storage:/endpoints/storage\" or \"check:/endpoints/check/*\", * means all nodes."` // nolint
