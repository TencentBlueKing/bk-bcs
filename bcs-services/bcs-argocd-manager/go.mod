...
require (
	github.com/Tencent/bk-bcs/bcs-common v0.0.0-20220314110800-1835634fd580
	...
	github.com/asim/go-micro/plugins/server/grpc/v4 v4.0.0-20220314060314-356448017f02
