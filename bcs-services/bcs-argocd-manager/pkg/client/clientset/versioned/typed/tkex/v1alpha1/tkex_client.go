...
import (
	...
	"github.com/Tencent/bk-bcs/bcs-services/bcs-argocd-manager/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type TkexV1alpha1Interface interface {
	RESTClient() rest.Interface
	ArgocdInstancesGetter
	ArgocdPluginsGetter
	ArgocdProjectsGetter
}
...
func (c *TkexV1alpha1Client) ArgocdInstances(namespace string) ArgocdInstanceInterface {
	return newArgocdInstances(c, namespace)
}

func (c *TkexV1alpha1Client) ArgocdPlugins(namespace string) ArgocdPluginInterface {
	return newArgocdPlugins(c, namespace)
}

func (c *TkexV1alpha1Client) ArgocdProjects(namespace string) ArgocdProjectInterface {
	return newArgocdProjects(c, namespace)
}
