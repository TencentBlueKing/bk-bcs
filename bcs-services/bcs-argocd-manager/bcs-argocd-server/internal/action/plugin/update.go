...
type UpdateArgocdPluginAction struct {
	...
	req  *plugin.UpdateArgocdPluginRequest  // nolint
	resp *plugin.UpdateArgocdPluginResponse // nolint
}

// Handle the update process
func (action *UpdateArgocdPluginAction) Handle(ctx context.Context,
	req *plugin.UpdateArgocdPluginRequest, resp *plugin.UpdateArgocdPluginResponse) error {
	return nil
}
