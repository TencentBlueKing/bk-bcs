...
var (
	...
	// BKIAM_ENABLE_V4 enable v4
	BKIAM_ENABLE_V4 = os.Getenv("BKIAM_ENABLE_V4") == "true"
	// BKIAM_V4_GATEWAY_HOST v4 gateway host
	BKIAM_V4_GATEWAY_HOST = os.Getenv("BKIAM_V4_GATEWAY_HOST")
