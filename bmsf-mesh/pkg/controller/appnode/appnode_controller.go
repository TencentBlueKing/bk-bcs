...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileAppNode{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by AppNode - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &meshv1.AppNode{},
	})
	if err != nil {
		return err
	}
