...
// return etcd taskgroup namespace
func GetEtcdNamespaceByTaskgroupId(taskGroupId string) string {
	runAs, appID := GetRunAsAndAppIDbyTaskGroupID(taskGroupId)
	return fmt.Sprintf("%s-%s", runAs, appID)
}

// return etcd taskgroup namespace
func GetEtcdNamespaceByRunAsappID(runAs, appID string) string {
	return fmt.Sprintf("%s-%s", runAs, appID)
}
