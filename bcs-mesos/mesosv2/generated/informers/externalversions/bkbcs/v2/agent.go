...
import (
	...
	bkbcsv2 "github.com/Tencent/bk-bcs/bcs-mesos/mesosv2/apis/bkbcs/v2"
	versioned "github.com/Tencent/bk-bcs/bcs-mesos/mesosv2/generated/clientset/versioned"
	internalinterfaces "github.com/Tencent/bk-bcs/bcs-mesos/mesosv2/generated/informers/externalversions/internalinterfaces"
	v2 "github.com/Tencent/bk-bcs/bcs-mesos/mesosv2/generated/listers/bkbcs/v2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BkbcsV2().Agents(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BkbcsV2().Agents(namespace).Watch(context.TODO(), options)
			},
		},
		&bkbcsv2.Agent{},
		resyncPeriod,
