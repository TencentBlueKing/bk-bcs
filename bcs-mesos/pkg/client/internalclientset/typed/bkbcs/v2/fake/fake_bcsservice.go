...
var bcsservicesResource = schema.GroupVersionResource{Group: "bkbcs.bkbcs.tencent.com", Version: "v2", Resource: "bcsservices"}

var bcsservicesKind = schema.GroupVersionKind{Group: "bkbcs.bkbcs.tencent.com", Version: "v2", Kind: "BcsService"}
...
func (c *FakeBcsServices) Get(name string, options v1.GetOptions) (result *v2.BcsService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(bcsservicesResource, c.ns, name), &v2.BcsService{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v2.BcsService), err
}
...
func (c *FakeBcsServices) List(opts v1.ListOptions) (result *v2.BcsServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(bcsservicesResource, bcsservicesKind, c.ns, opts), &v2.BcsServiceList{})
	...
	list := &v2.BcsServiceList{ListMeta: obj.(*v2.BcsServiceList).ListMeta}
	for _, item := range obj.(*v2.BcsServiceList).Items {
...
func (c *FakeBcsServices) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(bcsservicesResource, c.ns, opts))
...
func (c *FakeBcsServices) Create(bcsService *v2.BcsService) (result *v2.BcsService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(bcsservicesResource, c.ns, bcsService), &v2.BcsService{})
...
func (c *FakeBcsServices) Update(bcsService *v2.BcsService) (result *v2.BcsService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(bcsservicesResource, c.ns, bcsService), &v2.BcsService{})
...
func (c *FakeBcsServices) UpdateStatus(bcsService *v2.BcsService) (*v2.BcsService, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(bcsservicesResource, "status", c.ns, bcsService), &v2.BcsService{})
...
func (c *FakeBcsServices) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(bcsservicesResource, c.ns, name), &v2.BcsService{})
...
func (c *FakeBcsServices) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(bcsservicesResource, c.ns, listOptions)

	_, err := c.Fake.Invokes(action, &v2.BcsServiceList{})
	return err
}
...
func (c *FakeBcsServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2.BcsService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(bcsservicesResource, c.ns, name, data, subresources...), &v2.BcsService{})
