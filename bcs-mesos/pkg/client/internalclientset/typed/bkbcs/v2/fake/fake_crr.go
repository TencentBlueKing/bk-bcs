...
var crrsResource = schema.GroupVersionResource{Group: "bkbcs.bkbcs.tencent.com", Version: "v2", Resource: "crrs"}

var crrsKind = schema.GroupVersionKind{Group: "bkbcs.bkbcs.tencent.com", Version: "v2", Kind: "Crr"}
...
func (c *FakeCrrs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(crrsResource, c.ns, listOptions)
...
func (c *FakeCrrs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2.Crr, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(crrsResource, c.ns, name, data, subresources...), &v2.Crr{})
