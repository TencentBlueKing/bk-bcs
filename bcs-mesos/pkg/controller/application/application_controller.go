...
// +kubebuilder:rbac:groups=bkbcs.tencent.com,resources=applications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bkbcs.tencent.com,resources=applications/status,verbs=get;update;patch
