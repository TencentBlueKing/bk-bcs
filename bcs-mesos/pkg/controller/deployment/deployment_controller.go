...
// +kubebuilder:rbac:groups=bkbcs.tencent.com,resources=deployments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bkbcs.tencent.com,resources=deployments/status,verbs=get;update;patch
