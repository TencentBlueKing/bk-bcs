...
// +kubebuilder:rbac:groups=bkbcs.bkbcs.tencent.com,resources=bcsconfigmaps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bkbcs.bkbcs.tencent.com,resources=bcsconfigmaps/status,verbs=get;update;patch
