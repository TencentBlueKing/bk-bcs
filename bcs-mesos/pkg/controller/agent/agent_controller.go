...
// +kubebuilder:rbac:groups=bkbcs.tencent.com,resources=agents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bkbcs.tencent.com,resources=agents/status,verbs=get;update;patch
