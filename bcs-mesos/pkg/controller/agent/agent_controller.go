...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileAgent{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &bkbcsv2.Agent{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by Agent - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &bkbcsv2.Agent{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=bkbcs.bkbcs.tencent.com,resources=agents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bkbcs.bkbcs.tencent.com,resources=agents/status,verbs=get;update;patch
func (r *ReconcileAgent) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Agent instance
	instance := &bkbcsv2.Agent{}
