...
// +kubebuilder:rbac:groups=bkbcs.tencent.com,resources=frameworks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bkbcs.tencent.com,resources=frameworks/status,verbs=get;update;patch
