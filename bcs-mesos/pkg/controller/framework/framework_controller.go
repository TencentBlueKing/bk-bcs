...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileFramework{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &bkbcsv2.Framework{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by Framework - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &bkbcsv2.Framework{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=bkbcs.bkbcs.tencent.com,resources=frameworks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bkbcs.bkbcs.tencent.com,resources=frameworks/status,verbs=get;update;patch
func (r *ReconcileFramework) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Framework instance
	instance := &bkbcsv2.Framework{}
