...
// +kubebuilder:rbac:groups=bkbcs.tencent.com,resources=tasks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bkbcs.tencent.com,resources=tasks/status,verbs=get;update;patch
