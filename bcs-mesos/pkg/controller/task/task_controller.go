...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &bkbcsv2.Task{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=bkbcs.bkbcs.tencent.com,resources=tasks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bkbcs.bkbcs.tencent.com,resources=tasks/status,verbs=get;update;patch
func (r *ReconcileTask) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Task instance
	instance := &bkbcsv2.Task{}
