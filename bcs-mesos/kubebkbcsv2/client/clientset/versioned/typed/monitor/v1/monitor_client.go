...
// MonitorV1Client is used to interact with features provided by the monitor group.
type MonitorV1Client struct {
	restClient rest.Interface
}

func (c *MonitorV1Client) ServiceMonitors(namespace string) ServiceMonitorInterface {
