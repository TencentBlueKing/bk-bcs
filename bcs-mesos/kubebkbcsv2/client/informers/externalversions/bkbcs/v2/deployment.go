	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BkbcsV2().Deployments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BkbcsV2().Deployments(namespace).Watch(context.TODO(), options)
			},
		},
		&bkbcsv2.Deployment{},
		resyncPeriod,
...
func (f *deploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bkbcsv2.Deployment{}, f.defaultInformer)
}

func (f *deploymentInformer) Lister() v2.DeploymentLister {
	return v2.NewDeploymentLister(f.Informer().GetIndexer())
}
