...
// creating a new AdmissionWebhookConfigurationSpec.
...
func (version *Version) CheckAndDefaultResource() error { // nolint
	switch version.Kind {
...
func (version *Version) CheckConstraints() bool { // nolint
...
func (version *Version) AllCpus() float64 { // nolint
	var allCpus float64
	allCpus = 0
...
func (version *Version) AllMems() float64 { // nolint
	var allMem float64
	allMem = 0
...
func (version *Version) AllDisk() float64 { // nolint
	var allDisk float64
	allDisk = 0
...
func (version *Version) AllResource() *Resource { // nolint
	return &Resource{
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Task) DeepCopyInto(out *Task) { // nolint
	*out = *in
	if in.Arguments != nil {
...
// GetExtendedResources xxx
func (in *TaskGroup) GetExtendedResources() map[string]*commtypes.ExtendedResource { // nolint
	ers := make(map[string]*commtypes.ExtendedResource)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TaskGroup) DeepCopyInto(out *TaskGroup) { // nolint
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TaskGroupSpec.
func (in *TaskGroup) DeepCopy() *TaskGroup { // nolint
	if in == nil {
		return nil
	}
	out := new(TaskGroup)
...
// GetAgentInfo xxx
func (om *Agent) GetAgentInfo() *commtypes.BcsClusterAgentInfo { // nolint
...
// GetAgentIP xxx
func (om *Agent) GetAgentIP() string { // nolint
			...
			case mesos.Value_RANGES:
				...
				if oldAttribute.Ranges != nil {
					...
					for _, oldRange := range oldAttribute.Ranges.Range {
						...
						rangeList = append(rangeList, newRange) // nolint
					}
				}
