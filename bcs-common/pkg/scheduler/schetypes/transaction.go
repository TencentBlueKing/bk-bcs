...
type TransactaionOperartion struct {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TransactaionOperartion) DeepCopyInto(out *TransactaionOperartion) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver.
func (in *TransactaionOperartion) DeepCopy() *TransactaionOperartion {
	if in == nil {
		return nil
	}
	out := new(TransactaionOperartion)
	in.DeepCopyInto(out)
	return out
}
...
type Transaction struct {
	...
	PreOp *TransactaionOperartion `json:"preOp,omitempty"`
	// CurOp current transaction operator
	CurOp *TransactaionOperartion `json:"curOp,omitempty"`
