...
func NewClusterManagerEndpoints() []*api.Endpoint {
	return []*api.Endpoint{
		...
		{
			Name:    "ClusterManager.AddClusterCidr",
			Path:    []string{"/clustermanager/v1/clusters/{clusterID}/cidrs"},
			Method:  []string{"POST"},
			Handler: "rpc",
		},
		{
		...
		{
			Name:    "ClusterManager.ListRecommendCloudVpcCidr",
			Path:    []string{"/clustermanager/v1/clouds/{cloudID}/vpcs/recommendcidr"},
			Method:  []string{"GET"},
			Handler: "rpc",
		},
		{
...
type ClusterManagerService interface {
	...
	AddClusterCidr(ctx context.Context, in *AddClusterCidrReq, opts ...client.CallOption) (*AddClusterCidrResp, error)
...
func (c *clusterManagerService) AddClusterCidr(ctx context.Context, in *AddClusterCidrReq, opts ...client.CallOption) (*AddClusterCidrResp, error) {
	req := c.c.NewRequest(c.name, "ClusterManager.AddClusterCidr", in)
	out := new(AddClusterCidrResp)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *clusterManagerService) ListRecommendCloudVpcCidr(ctx context.Context, in *ListRecommendCloudVpcCidrRequest, opts ...client.CallOption) (*ListRecommendCloudVpcCidrResponse, error) {
	req := c.c.NewRequest(c.name, "ClusterManager.ListRecommendCloudVpcCidr", in)
	out := new(ListRecommendCloudVpcCidrResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type ClusterManagerHandler interface {
	...
	AddClusterCidr(context.Context, *AddClusterCidrReq, *AddClusterCidrResp) error
	...
	ListRecommendCloudVpcCidr(context.Context, *ListRecommendCloudVpcCidrRequest, *ListRecommendCloudVpcCidrResponse) error
...
func RegisterClusterManagerHandler(s server.Server, hdlr ClusterManagerHandler, opts ...server.HandlerOption) error {
	type clusterManager interface {
		...
		AddClusterCidr(ctx context.Context, in *AddClusterCidrReq, out *AddClusterCidrResp) error
		...
		ListRecommendCloudVpcCidr(ctx context.Context, in *ListRecommendCloudVpcCidrRequest, out *ListRecommendCloudVpcCidrResponse) error
...
func (h *clusterManagerHandler) AddClusterCidr(ctx context.Context, in *AddClusterCidrReq, out *AddClusterCidrResp) error {
	return h.ClusterManagerHandler.AddClusterCidr(ctx, in, out)
}
...
func (h *clusterManagerHandler) ListRecommendCloudVpcCidr(ctx context.Context, in *ListRecommendCloudVpcCidrRequest, out *ListRecommendCloudVpcCidrResponse) error {
	return h.ClusterManagerHandler.ListRecommendCloudVpcCidr(ctx, in, out)
}
