...
type AgentEndpoint struct {
	Host         string                       `json:"host,omitempty" usage:"host to be used in the agent client endpoint"`
	Port         string                       `json:"port,omitempty" usage:"port to be used in the agent client endpoint"`
