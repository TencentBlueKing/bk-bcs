...
const (
	fullDocumentKey      = "fullDocument"      // nolint
	nsKey                = "ns"                // nolint
	dbKey                = "db"                // nolint
	collectionKey        = "coll"              // nolint
	operationTypeKey     = "operationType"     // nolint
	updateDescriptionKey = "updateDescription" // nolint
	updatedFieldsKey     = "updatedFields"     // nolint
	removedFieldsKey     = "removedFields"     // nolint
