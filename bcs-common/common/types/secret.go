...
const (
	...
	BcsSecretTypeDockercfg BcsSecretType = "kubernetes.io/dockercfg" // nolint
	// BcsSecretTypeDockerConfigJson xx
	BcsSecretTypeDockerConfigJson BcsSecretType = "kubernetes.io/dockerconfigjson" // nolint
	// BcsSecretTypeBasicAuth xx
	BcsSecretTypeBasicAuth BcsSecretType = "kubernetes.io/basic-auth" // nolint
	// BcsSecretTypeSSHAuth xx
	BcsSecretTypeSSHAuth BcsSecretType = "kubernetes.io/ssh-auth" // nolint
	// BcsSecretTypeTLS xx
	BcsSecretTypeTLS BcsSecretType = "kubernetes.io/tls" // nolint
)
