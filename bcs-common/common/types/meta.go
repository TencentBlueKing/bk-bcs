...
func (in *ObjectMeta) DeepCopyInto(out *ObjectMeta) { // nolint
	*out = *in
...
func (in *ObjectMeta) DeepCopy() *ObjectMeta { // nolint
	if in == nil {
		return nil
	}
	out := new(ObjectMeta)
...
func (om *ObjectMeta) GetName() string { // nolint
	return om.Name
}

// SetName set object name
func (om *ObjectMeta) SetName(name string) { // nolint
	om.Name = name
}

// GetNamespace for ObjectMeta
func (om *ObjectMeta) GetNamespace() string { // nolint
	return om.NameSpace
}

// SetNamespace set object namespace
func (om *ObjectMeta) SetNamespace(ns string) { // nolint
	om.NameSpace = ns
}

// GetCreationTimestamp get create timestamp
func (om *ObjectMeta) GetCreationTimestamp() time.Time { // nolint
	return om.CreationTimestamp
}

// SetCreationTimestamp set creat timestamp
func (om *ObjectMeta) SetCreationTimestamp(timestamp time.Time) { // nolint
	om.CreationTimestamp = timestamp
}

// GetLabels for ObjectMeta
func (om *ObjectMeta) GetLabels() map[string]string { // nolint
	return om.Labels
}

// SetLabels set objec labels
func (om *ObjectMeta) SetLabels(labels map[string]string) { // nolint
	om.Labels = labels
}

// GetAnnotations for ObjectMeta
func (om *ObjectMeta) GetAnnotations() map[string]string { // nolint
	return om.Annotations
}

// SetAnnotations get annotation name
func (om *ObjectMeta) SetAnnotations(annotation map[string]string) { // nolint
	om.Annotations = annotation
}

// GetClusterName get cluster name
func (om *ObjectMeta) GetClusterName() string { // nolint
	return om.ClusterName
}

// SetClusterName set cluster name
func (om *ObjectMeta) SetClusterName(clusterName string) { // nolint
